...
class UpdateNetworkStateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.setCurrentStates = channel.stream_stream(
                '/zepben.protobuf.nm.UpdateNetworkStateService/setCurrentStates',
...
def add_UpdateNetworkStateServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'zepben.protobuf.nm.UpdateNetworkStateService', rpc_method_handlers)
...
class UpdateNetworkStateService(object):
    ...
    def setCurrentStates(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/zepben.protobuf.nm.UpdateNetworkStateService/setCurrentStates',
...
class QueryNetworkStateServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getCurrentStates = channel.unary_stream(
                '/zepben.protobuf.nm.QueryNetworkStateService/getCurrentStates',
...
def add_QueryNetworkStateServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'zepben.protobuf.nm.QueryNetworkStateService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class QueryNetworkStateService(object):
    ...
    def getCurrentStates(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/zepben.protobuf.nm.QueryNetworkStateService/getCurrentStates',
