...
const PipelineWrapper = ({ context, browserFactory, shell, commands, addFileToPipelineSignal, refreshPaletteSignal, settings, widgetId }) => {
    ...
    const { data: palette, error: paletteError, mutate: mutatePalette } = (0, pipeline_hooks_1.usePalette)(type);
    (0, react_1.useEffect)(() => {
...
const usePalette = (type = 'local') => {
    const { data: runtimeImages, error: runtimeError } = (0, exports.useRuntimeImages)();
...
//# sourceMappingURL=lib_index_js.b984254a94e9fd4f7830.js.map