        ...
        <div class="container">
            ...
            <div class="column feature-section" data-status="{{ interpretation.get('range_status', 'unknown') }}">
                ...
                <div class="content-block">
                    <p class="highlight">Summary of Values:</p>

                    <p>
                        Median Value: {{ interpretation.get('median', 'N/A') }}
                        <br>
                        Standard Deviation: {{ interpretation.get('stddev', 'N/A') }}
                    </p>

                    <p class="highlight">
                        Normal Range:
                        {{ interpretation.get('normal_range', ['N/A', 'N/A'])[0] }}
                        to
                        {{ interpretation.get('normal_range', ['N/A', 'N/A'])[1] }}
                    </p>
                </div>
