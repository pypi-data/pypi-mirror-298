...
def parse_string_tags(input):
    '''
    Input can be like a tag or a string. Input expects no explicit single quote or double quotes from user.
    Example 1 : key:value  , In this case dictionary will be {"key":"value"}
    Example 2 : the_tag  , In this case dictionary will be {"the_tag":"the_tag"}
    Example 3 : first:true, second:false  , In this case dictionary will be {"first":"true", "second":"false"}
    Example 4 : first:true; second:false  , In this case dictionary will be {"first":"true", "second":"false"}
    Example 5 : key:value, key:value2  , In this case dictionary will be {"key":"value2"}
    '''
    if input == "None":
        return {}
    result = {}
