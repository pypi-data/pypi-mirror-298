...
def get_db_connection():
    return connection_vars().get_db_connection()
def put_db_connection(conn):
    connection_vars().put_db_connection(conn)
def connect_db():
    return connection_vars().connect_db()
def get_insert(tableName):
    return connection_vars().table_mgr.get_insert(tableName)
def fetchFromDb(tableName,searchValue):
    return connection_vars().table_mgr.fetchFromDb(tableName,searchValue)
def insertIntoDb(tableName,searchValue,insertValue):
    return connection_vars().table_mgr.insertIntoDb(tableName,searchValue,insertValue)
