...
from .dbSearchFunctions import flatten_json
class DatabaseManager:
    def __init__(self,env_path=None,dbName=None,dbType=None,conn_mgr=None):
        ...
        self.table_config_path = get_env_value(key=f"{self.connectionManager.dbName}_{self.connectionManager.dbType}_CONFIGPATH", path=self.connectionManager.env_path)
