...
def get_insert(tableName):
    return connectionManager().table_mgr.get_insert(tableName)
def fetchFromDb(tableName,searchValue):
    return connectionManager().table_mgr.fetchFromDb(tableName,searchValue)
def insertIntoDb(tableName,searchValue,insertValue):
    return connectionManager().table_mgr.insertIntoDb(tableName,searchValue,insertValue)
