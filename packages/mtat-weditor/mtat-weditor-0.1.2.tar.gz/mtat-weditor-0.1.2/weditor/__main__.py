...
from .web.handlers.page import (
    ...
    DeviceWidgetListHandler, MainHandler, VersionHandler, WidgetPreviewHandler, DevicesListHandler, DeviceIndexHandler)
...
def make_app(settings={}):
    application = tornado.web.Application(
        [
            ...
            (r"/api/v1/index", DeviceIndexHandler),
            (r"/api/v1/crop", CropHandler),
            (r"/api/v1/devices/([^/]+)", DevicesListHandler),
