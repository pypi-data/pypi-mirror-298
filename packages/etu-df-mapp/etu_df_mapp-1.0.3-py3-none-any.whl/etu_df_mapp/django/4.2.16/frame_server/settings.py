...
PROJECT_NAME = 'frame_server mapp'
PROJECT_VERSION = '1.0.0'
FRONTEND_NAME = 'XXX管理系统'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    'EXCEPTION_HANDLER': 'utils.frame.exception_handler.custom_base_exception_handler',
