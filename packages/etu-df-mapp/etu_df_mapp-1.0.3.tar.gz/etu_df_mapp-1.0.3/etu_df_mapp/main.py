...
class ManagementUtility:
    """
    Encapsulate the logic of the edfm-admin utilities.
    """
    VERSION_LIST = ['4.2.16']
    ...
    def change_4216(self, project_name, tmp_data):
        """修改Django 4.2.16 版本脚手架文件"""
        change_file_list = [
    ...
    def change_frame_file(self, label, project_name, tmp_data):
        """修改不同Django版本脚手架文件"""
        if label in ['4.2.16']:
            self.change_4216(project_name, tmp_data)
