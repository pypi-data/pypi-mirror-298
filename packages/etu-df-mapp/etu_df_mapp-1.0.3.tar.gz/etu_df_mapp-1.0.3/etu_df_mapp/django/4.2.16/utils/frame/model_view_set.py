...
class WebBaseModelViewSet(viewsets.ModelViewSet):
    """Web ModelViewSet认证基类"""
    # 接口认证类注册
    authentication_classes = (WebTokenAuthentication,)
    permission_classes = (IsAuthenticated,)


class WebBaseReadOnlyModelViewSet(viewsets.ReadOnlyModelViewSet):
    """Web ModelViewSet只读认证基类"""
    # 接口认证类注册
    authentication_classes = (WebTokenAuthentication,)
    permission_classes = (IsAuthenticated,)
