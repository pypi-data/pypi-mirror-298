...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', 'c', 'time', 'gfu_old', '_lin_solver_args', '_lin_solver_cls', 'dt')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfv_old', 'gfa_old', 'bfmstar', 'c', 'time', 'gfu_old', '_lin_solver_args', '_lin_solver_cls', 'dt')
