...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('tol', 'pre', 'its', 'display', 'plotrates', 'ax', 'plt', 'mat', 'sol', 'callback_sol', 'maxiter', 'atol', 'iterations', 'ress', 'residuals', 'fig', 'clear_output', 'callback', '_final_residual', 'printrates')
