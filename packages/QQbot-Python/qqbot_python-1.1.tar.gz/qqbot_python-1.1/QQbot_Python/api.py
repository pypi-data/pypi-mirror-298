...
from .http import BotHttp, Route,Route_3rd,BotHttp_3rd
from .types import (
    guild,
    user,
    channel,
...
class BotAPI:
    ...
    async def send_text_message(self, group_id, user_id, data):
        payload = {
            "group_id": group_id,
            "message": [
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    
    async def send_image_message(self, group_id,summary, file_image):
        # 获取当前工作目录
        current_dir = os.getcwd()
        
        # 将相对路径转换为绝对路径
        new_file = os.path.abspath(os.path.join(current_dir, file_image))
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def send_msg_message(self, group_id,message_id,msg):
        payload = {
            "group_id": group_id,
            "message": [
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def send_image_message_text(self, group_id,msg,summary, file_image):
        # 获取当前工作目录
        current_dir = os.getcwd()
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def send_file_message(self, group_id, file_path, file_name):
        # 获取当前工作目录
        current_dir = os.getcwd()
        
        # 将相对路径转换为绝对路径
        new_file = os.path.abspath(os.path.join(current_dir, file_path))
        new_file = new_file.replace('\\', '\\\\')
        payload = {
                    "group_id": group_id,
                    "message": [
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def send_voice_message(self, group_id, file_path, file_name):
        # 获取当前工作目录
        current_dir = os.getcwd()
        ...
        route = Route_3rd("POST", "/send_group_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def send_record_message(self, group_id, file_path):
        # 获取当前工作目录
        current_dir = os.getcwd()
    ...
    async def send_private_message(self, user_id,msg):
        payload = {
            "user_id": user_id,
            "message": [{"type":"text","data":{"text":msg }}]
        }
        
        route = Route_3rd("POST", "/send_private_msg")
        return await BotHttp_3rd.request(route, json=payload)
    async def get_group_msg_history(self, group_id, limit):
        ...
        route = Route_3rd("POST", "/get_group_msg_history")
        return await BotHttp_3rd.request(route, json=payload)
    
    async def get_robot_uin_range(self):
        route = Route_3rd("POST", "/get_robot_uin_range")
        return await BotHttp_3rd.request(route)
    
    async def get_friends_with_category(self):
        payload = {"no_cache": True}
        route = Route_3rd("POST", "/get_friends_with_category")
        return await BotHttp_3rd.request(route,json=payload)
    async def get_user_info(self,group_id:str,user_id:str,phone_number:str):
        payload = {
            "user_id": f"{user_id}",
            "group_id": f"{group_id}",
            "phoneNumber": f"{phone_number}"
        }
        route = Route_3rd("POST", "/ArkSharePeer")
        return await BotHttp_3rd.request(route,json=payload)
    async def translate_en2zh(self,text:str):
        payload = {
            "words": [f"{text}"]
        }
        route = Route_3rd("POST", "/translate_en2zh")
        return await BotHttp_3rd.request(route,json=payload)
    async def get_friend_list(self):
        route = Route_3rd("POST", "/get_friend_list")
        return await BotHttp_3rd.request(route)
    async def get_stranger_info(self,user_id:str):
        payload = {
            "user_id": f"{user_id}"
        }
        route = Route_3rd("POST", "/get_stranger_info")
        return await BotHttp_3rd.request(route,json=payload)
    async def get_group_member_info(self,group_id:str,user_id:str):
        ...
        route = Route_3rd("POST", "/get_group_member_info")
        return await BotHttp_3rd.request(route,json=payload)
    async def get_group_member_list(self,group_id:str):
        ...
        route = Route_3rd("POST", "/get_group_member_list")
        return await BotHttp_3rd.request(route,json=payload)
