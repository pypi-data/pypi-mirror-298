...
class AbstractRunner(ABC):
    ...
    @staticmethod
    def init_job(bizon_config: BizonConfig, config: dict) -> StreamJob:
        """Initialize a job for the current stream"""

        backend = AbstractRunner.get_backend(bizon_config=bizon_config)
