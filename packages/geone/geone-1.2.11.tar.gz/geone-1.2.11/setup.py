...
lib_deesse_files_list = [glob.glob(f'src/geone/lib_deesse_core/{d}/*', root_dir=None) for d in lib_subdir_list]

lib_geosclassic_target_dir_list = [f'src.geone.lib_geosclassic_core.{d}' for d in lib_subdir_list]
lib_geosclassic_files_list = [glob.glob(f'src/geone/lib_geosclassic_core/{d}/*', root_dir=None) for d in lib_subdir_list]
