...
import requests
from tonic_textual.classes.tonic_exception import BadArgumentsException, DatasetFileMatchesExistingFile, DatasetFileNotFound, DatasetNameAlreadyExists
...
class Dataset:
    ...
    def add_file(self, file_path: Optional[str] = None, file_name: Optional[str] = None, file: Optional[io.IOBase] = None, ):
        """
