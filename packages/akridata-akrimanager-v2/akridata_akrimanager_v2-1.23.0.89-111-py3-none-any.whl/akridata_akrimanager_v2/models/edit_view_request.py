...
class EditViewRequest(object):
    ...
    def __init__(self, view_name=None, description=None, table_info=None, udfs_info=None, projections_info=None, task_type=None, is_default=False, local_vars_configuration=None):  # noqa: E501
