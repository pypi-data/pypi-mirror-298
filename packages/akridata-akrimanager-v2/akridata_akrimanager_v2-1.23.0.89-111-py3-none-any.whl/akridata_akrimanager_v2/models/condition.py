...
class Condition(object):
    ...
    def __init__(self, column=None, column_type=None, operation=None, first_value=None, second_value=None, logical_operator=None, local_vars_configuration=None):  # noqa: E501
    ...
    def first_value(self, first_value):
        ...
        """
        if self.local_vars_configuration.client_side_validation and first_value is None:  # noqa: E501
            raise ValueError("Invalid value for `first_value`, must not be `None`")  # noqa: E501
