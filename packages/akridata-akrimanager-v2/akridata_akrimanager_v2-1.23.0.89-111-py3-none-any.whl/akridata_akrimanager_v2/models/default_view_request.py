...
class DefaultViewRequest(object):
    ...
    def __init__(self, dataset_id=None, create_update_view_details=None, task_type=None, abs_table_name=None, file_type=None, data_format=None, udts_info=None, local_vars_configuration=None):  # noqa: E501
