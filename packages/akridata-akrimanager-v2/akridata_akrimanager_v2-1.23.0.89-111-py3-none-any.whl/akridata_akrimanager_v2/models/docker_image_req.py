...
class DockerImageReq(object):
    ...
    def __init__(self, name=None, namespace=None, repository_id=None, image_name=None, image_tag=None, filter_type=None, gpu_filter=None, gpu_mem_fraction=1, allow_no_gpu=True, output_fields=None, properties=None, command=None, description=None, python_exec_info=None, local_vars_configuration=None):  # noqa: E501
    ...
    def gpu_mem_fraction(self, gpu_mem_fraction):
        ...
        if (self.local_vars_configuration.client_side_validation and
                gpu_mem_fraction is not None and gpu_mem_fraction > 1):  # noqa: E501
            raise ValueError("Invalid value for `gpu_mem_fraction`, must be a value less than or equal to `1`")  # noqa: E501
