...
class DatasetQMSMetadata(object):
    ...
    def __init__(self, default_pipeline_id=None, default_table_name=None, default_view_id=None, default_pe_query_id=None, tables_pe_categorical_results=None, views_pe_categorical_results=None, local_vars_configuration=None):  # noqa: E501
