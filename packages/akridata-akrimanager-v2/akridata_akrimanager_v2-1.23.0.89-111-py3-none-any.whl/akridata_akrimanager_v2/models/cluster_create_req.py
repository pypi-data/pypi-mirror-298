...
class ClusterCreateReq(object):
    ...
    def __init__(self, name=None, endpoint=None, description=None, secret_key=None, num_gpu=0, cloud_provider=None, region=None, tier=None, max_nodes=None, set_default=False, worker_handle='akridata-cluster-internal-handle', local_vars_configuration=None):  # noqa: E501
