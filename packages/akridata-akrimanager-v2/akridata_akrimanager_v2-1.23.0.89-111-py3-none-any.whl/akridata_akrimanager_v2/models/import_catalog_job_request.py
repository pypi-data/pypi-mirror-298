...
class ImportCatalogJobRequest(object):
    ...
    def __init__(self, table_name=None, dataset_id=None, file_list=None, create_table=False, notify=False, data_format=None, udts_info=None, file_type=None, task_type=None, import_identifier=None, create_update_view_details=None, local_vars_configuration=None):  # noqa: E501
