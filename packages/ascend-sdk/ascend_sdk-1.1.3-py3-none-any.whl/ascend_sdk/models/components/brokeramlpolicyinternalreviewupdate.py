...
class BrokerAmlPolicyInternalReviewUpdateTypedDict(TypedDict):
    r"""Broker's anti-money laundering policy internal review detail."""

    internal_aml_policy_principal_review_date: NotRequired[DateUpdateTypedDict]
...
class BrokerAmlPolicyInternalReviewUpdate(BaseModel):
    r"""Broker's anti-money laundering policy internal review detail."""

    internal_aml_policy_principal_review_date: Optional[DateUpdate] = None
    r"""Represents a whole or partial calendar date, such as a birthday. The time of day and time zone are either specified elsewhere or are insignificant. The date is relative to the Gregorian Calendar. This can represent one of the following:
