...
class PartyInternalAmlPolicyPrincipalReviewDateTypedDict(TypedDict):
...
class PartyInternalAmlPolicyPrincipalReviewDate(BaseModel):
    r"""The date when the principal reviewed the internal anti-money laundering policy"""
...
class PartyBrokerAmlPolicyInternalReviewTypedDict(TypedDict):
    ...
    internal_aml_policy_principal_review_date: NotRequired[
        Nullable[PartyInternalAmlPolicyPrincipalReviewDateTypedDict]
    ]
    r"""The date when the principal reviewed the internal anti-money laundering policy"""
...
class PartyBrokerAmlPolicyInternalReview(BaseModel):
    r"""The broker's internal review of their anti-money laundering policy"""
...
class PartyBrokerResponsesTypedDict(TypedDict):
    ...
    broker_aml_policy_internal_review: NotRequired[
        Nullable[PartyBrokerAmlPolicyInternalReviewTypedDict]
    ]
    r"""The broker's internal review of their anti-money laundering policy"""
...
class PartyBrokerResponses(BaseModel):
    r"""Responses generated by the representing broker regarding a foreign financial institution customer"""
...
class PartyAddressTypedDict(TypedDict):
...
class PartyLegalEntityShortCodeTypedDict(TypedDict):
    r"""A short code.
...
class PartyLegalEntityShortCode(BaseModel):
    r"""A short code.
...
class PartyLegalEntityPhoneNumberTypedDict(TypedDict):
    ...
    """
    short_code: NotRequired[Nullable[PartyLegalEntityShortCodeTypedDict]]
    r"""A short code.
...
class PartyLegalEntityPhoneNumber(BaseModel):
    r"""The phone number of the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""
    ...
    Note that no regions currently use extensions with short codes, so this field is normally only set in conjunction with an E.164 number. It is held separately from the E.164 number to allow for short code extensions in the future.
    """
    short_code: OptionalNullable[PartyLegalEntityShortCode] = UNSET
    r"""A short code.
...
class PartyFfiAmlcoContactInformationTypedDict(TypedDict):
    ...
    phone_number: NotRequired[Nullable[PartyLegalEntityPhoneNumberTypedDict]]
    r"""The phone number of the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""


class PartyFfiAmlcoContactInformation(BaseModel):
    r"""Contact information for the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""

    address: OptionalNullable[PartyAddress] = UNSET
    r"""The address of the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""
    aml_compliance_officer_name: Optional[str] = None
    r"""The name of the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""
    phone_number: OptionalNullable[PartyLegalEntityPhoneNumber] = UNSET
    r"""The phone number of the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""
...
class PartyFfiAmlProgramTypedDict(TypedDict):
    ...
    ffi_amlco_contact_information: NotRequired[
        Nullable[PartyFfiAmlcoContactInformationTypedDict]
    ]
    r"""Contact information for the foreign financial institution's Anti-Money Laundering Compliance Officer (AMLCO)"""
...
class PartyFfiAmlProgram(BaseModel):
    r"""The Anti-Money Laundering (AML) program of the foreign financial institution"""
    ...
    r"""A description of the FFI's anti-money laundering program in lieu of related questions"""
    ffi_amlco_contact_information: OptionalNullable[
...
class PartyFfiServicingOfFisTypedDict(TypedDict):
...
class PartyFfiServicingOfFis(BaseModel):
    r"""Information about the servicing of financial institutions by the foreign financial institution"""
...
class PartyFfiEddTypedDict(TypedDict):
    r"""Enhanced Due Diligence (EDD) information for the foreign financial institution"""

    broker_responses: NotRequired[Nullable[PartyBrokerResponsesTypedDict]]
    r"""Responses generated by the representing broker regarding a foreign financial institution customer"""
    ...
    ffi_aml_program: NotRequired[Nullable[PartyFfiAmlProgramTypedDict]]
    r"""The Anti-Money Laundering (AML) program of the foreign financial institution"""
    ffi_servicing_of_fis: NotRequired[Nullable[PartyFfiServicingOfFisTypedDict]]
    r"""Information about the servicing of financial institutions by the foreign financial institution"""
...
class PartyFfiEdd(BaseModel):
    r"""Enhanced Due Diligence (EDD) information for the foreign financial institution"""

    broker_responses: OptionalNullable[PartyBrokerResponses] = UNSET
    r"""Responses generated by the representing broker regarding a foreign financial institution customer"""
    ...
    r"""Description of the terrorist financing matter that the customer or their affiliates have been subject to"""
    ffi_aml_program: OptionalNullable[PartyFfiAmlProgram] = UNSET
    r"""The Anti-Money Laundering (AML) program of the foreign financial institution"""
    ffi_servicing_of_fis: OptionalNullable[PartyFfiServicingOfFis] = UNSET
    r"""Information about the servicing of financial institutions by the foreign financial institution"""
...
class PartyEntityEddTypedDict(TypedDict):
    ...
    ffi_edd: NotRequired[Nullable[PartyFfiEddTypedDict]]
    r"""Enhanced Due Diligence (EDD) information for the foreign financial institution"""
...
class PartyEntityEdd(BaseModel):
    r"""Enhanced Due Diligence (EDD) information for the legal entity"""
    ...
    r"""Indicates whether the entity issues bearer shares"""
    ffi_edd: OptionalNullable[PartyFfiEdd] = UNSET
    r"""Enhanced Due Diligence (EDD) information for the foreign financial institution"""
...
class PartyLegalEntityTypedDict(TypedDict):
    ...
    entity_edd: NotRequired[Nullable[PartyEntityEddTypedDict]]
    r"""Enhanced Due Diligence (EDD) information for the legal entity"""
...
class PartyLegalEntity(BaseModel):
    ...
    r"""The correspondent id associated with the legal entity."""
    entity_edd: OptionalNullable[PartyEntityEdd] = UNSET
    r"""Enhanced Due Diligence (EDD) information for the legal entity"""
...
class PartyOtherSourcesOfWealthTypedDict(TypedDict):
    ...
    other_source_of_wealth_verification: NotRequired[str]
...
class PartyOtherSourcesOfWealth(BaseModel):
    ...
    r"""Indicates whether the applicant has other sources of wealth."""
    other_source_of_wealth_verification: Optional[str] = None
    r"""The applicant's other source of wealth verification. If the applicant has no other sources of wealth, they must specify \"N/A.\" """
