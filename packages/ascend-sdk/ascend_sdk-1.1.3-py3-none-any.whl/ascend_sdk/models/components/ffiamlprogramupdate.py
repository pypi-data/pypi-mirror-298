...
class FfiAmlProgramUpdateTypedDict(TypedDict):
...
class FfiAmlProgramUpdate(BaseModel):
    r"""Foreign Financial Institution Anti-Money Laundering Program detail."""
    ...
    r"""A description of the FFI's anti-money laundering program in lieu of related questions"""
    ffi_amlco_contact_information: Optional[FfiAmlcoContactInformationUpdate] = None
    r"""Foreign Financial Institution Anti-Money Laundering compliance contact information."""
