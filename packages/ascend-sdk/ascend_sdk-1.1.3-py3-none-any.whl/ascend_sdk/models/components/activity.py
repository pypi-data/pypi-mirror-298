...
class ActivityCashRateTypedDict(TypedDict):
    r"""The rate at which cash will be disbursed to the shareholder"""
...
class ActivityMergerStockRateTypedDict(TypedDict):
    r"""The rate at which stock will be disbursed to the shareholder"""
...
class ActivityUnitSplitStockRateTypedDict(TypedDict):
    r"""Corresponds to corporateactions.announcement.stock_rate"""
