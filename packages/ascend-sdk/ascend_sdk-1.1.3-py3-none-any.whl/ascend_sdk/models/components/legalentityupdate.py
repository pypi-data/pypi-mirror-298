...
from .entityeddupdate import EntityEddUpdate, EntityEddUpdateTypedDict
...
class LegalEntityUpdateTypedDict(TypedDict):
    ...
    entity_edd: NotRequired[EntityEddUpdateTypedDict]
...
class LegalEntityUpdate(BaseModel):
    ...
    r"""The correspondent id associated with the legal entity."""
    entity_edd: Optional[EntityEddUpdate] = None
    r"""Enhanced Due Diligence for Legal Entities required when a Legal Entity is the Primary Owner on an Account."""
