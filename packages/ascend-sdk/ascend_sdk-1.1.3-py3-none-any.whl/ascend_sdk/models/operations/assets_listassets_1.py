...
class AssetsListAssets1RequestTypedDict(TypedDict):
    parent: NotRequired[str]
    r"""The parent resource name, which is the correspondent ID."""
...
class AssetsListAssets1Request(BaseModel):
    parent: Annotated[
        Optional[str],
...
class AssetsListAssets1ResponseTypedDict(TypedDict):
...
class AssetsListAssets1Response(BaseModel):
    http_meta: Annotated[
