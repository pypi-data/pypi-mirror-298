...
class AssetsGetAssetCorrespondentRequestTypedDict(TypedDict):
...
class AssetsGetAssetCorrespondentRequest(BaseModel):
...
class AssetsGetAssetCorrespondentResponseTypedDict(TypedDict):
...
class AssetsGetAssetCorrespondentResponse(BaseModel):
    http_meta: Annotated[
