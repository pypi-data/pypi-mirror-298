...
class IctWithdrawalsGetIctWithdrawalRequestTypedDict(TypedDict):
    account_id: str
    r"""The account id."""
...
class IctWithdrawalsGetIctWithdrawalRequest(BaseModel):
...
class IctWithdrawalsGetIctWithdrawalResponseTypedDict(TypedDict):
...
class IctWithdrawalsGetIctWithdrawalResponse(BaseModel):
    http_meta: Annotated[
