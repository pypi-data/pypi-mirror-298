...
from ascend_sdk.models.components import httpmetadata as components_httpmetadata
...
class AccountsDeleteTrustedContactRequestTypedDict(TypedDict):
    account_id: str
    r"""The account id."""
...
class AccountsDeleteTrustedContactRequest(BaseModel):
...
class AccountsDeleteTrustedContactResponseTypedDict(TypedDict):
...
class AccountsDeleteTrustedContactResponse(BaseModel):
    http_meta: Annotated[
