<template>
  <div class="order-header flex flex-col pt-4">
    ...
    <SubmitDeliveryTicketDetailsModal :isOpen="isSubmitDeliveryTicketDetailsModalOpened" :organisation-id="order?.client?.id"
      ref="markInput" @modal-close="isSubmitDeliveryTicketDetailsModalOpened = false" @modal-submit="" name="confirm-modal" />
