              ...
              <div class="modal-body-content w-full flex flex-col p-3 gap-2">
                ...
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex px-3 py-4">
                    ...
                    <div class="modal-body-content-block-body-value w-2/12">{{ formatNumber(supplyFuelDetails?.fuel_price?.amount) }}
                  ...
                  <div class="modal-body-content-block-body flex flex-col">
                    ...
                    <div class="flex w-full">
                      <div class="el-border w-6/12 flex px-3 py-4 items-center">
                        ...
                        <div class="modal-body-content-block-body-value w-4/12">{{
                          formatNumber(supplyFuelDetails?.fuel_price?.amount) }} {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                    ...
                    <div class="flex w-full">
                      ...
                      <div class="w-6/12 flex px-3 py-4 items-center">
                        <div class="modal-body-content-block-body-name w-8/12">Fees</div>
                        <div class="modal-body-content-block-body-value w-4/12">{{
                          formatNumber(supplyFuelDetails?.fees?.client_total) }} {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                    </div>
                    <div class="flex w-full">
                      <div class="el-border w-6/12 flex px-3 py-4 items-center">
                        ...
                        <div class="modal-body-content-block-body-value w-4/12">{{
                          formatNumber(supplyFuelDetails?.taxes?.official_total) }} {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                      <div class="w-6/12 flex px-3 py-4 items-center">
                        <div class="modal-body-content-block-body-name w-8/12">Taxes</div>
                        <div class="modal-body-content-block-body-value w-4/12">{{
                          formatNumber(supplyFuelDetails?.taxes?.supplier_total) }} {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                    </div>
                    <div class="flex w-full">
                      <div class="el-border results w-6/12 flex px-3 py-4 items-center">
                        ...
                        <div class="modal-body-content-block-body-value w-4/12">{{
                          formatNumber(supplyFuelDetails?.total_official_taxes) }} {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
