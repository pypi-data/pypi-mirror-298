...
def collect_jar_args(context: CertoraContext) -> List[str]:
    ...
    type_checker_values = getattr(context, Attrs.EvmProverAttributes.TYPECHECKER_ARGS.get_conf_key(), None)
...
def get_typechecker_arguments(context: CertoraContext) -> List[str]:
    ...
    relevant_attrs = filter(lambda arg: get_attr_value(context, arg),
                            [Attrs.EvmProverAttributes.RULE, Attrs.EvmProverAttributes.EXCLUDE_RULE,
                             Attrs.EvmProverAttributes.FOUNDRY_TESTS_MODE])
