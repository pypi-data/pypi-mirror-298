...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, no_content_change_since=None, base_url=None, name=None, pulp_created=None, base_path=None, pulp_last_updated=None, pulp_href=None, content_guard=None, hidden=False, local_vars_configuration=None):  # noqa: E501
