...
class UpstreamPulpResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp_last_updated=None, name=None, base_url=None, api_root=None, domain=None, ca_cert=None, client_cert=None, tls_validation=None, hidden_fields=None, q_select=None, last_replication=None, local_vars_configuration=None):  # noqa: E501
