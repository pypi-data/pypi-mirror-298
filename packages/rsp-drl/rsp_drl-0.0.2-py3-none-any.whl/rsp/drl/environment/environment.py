...
class Pendulum(Environment):
    def __init__(self, l = 1, m = 50., dt = 0.05, damping = 1e-3, device = 'cpu'):
...
class Actor2D(Environment):
    def __init__(self, max_steps:int,
        ...
        self.alpha1_min = __grad2bog__(-10.)
        self.alpha1_max = __grad2bog__(150.)
        self.alpha2_min = __grad2bog__(-150.)
    ...
    def render(self, display = True, show_debug_info = False):
        ...
        ox = 8
        oy = -46
        base = cv.imread('image/robot-kuka-base.png', cv.IMREAD_UNCHANGED)
        ...
        link2 = cv.imread('image/robot-kuka-link2.png', cv.IMREAD_UNCHANGED)
        ...
        link1 = cv.imread('image/robot-kuka-link1.png', cv.IMREAD_UNCHANGED)
