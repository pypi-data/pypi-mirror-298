...
def _search_users_by_letter(
    ...
    if search_users_by_letter_email_domain and not using_connect_as_primary_auth:
        # NOTE: search_users_by_letter_email_domain doing searches by email domain
        # only works for Jira Servers (which should always have using_connect_as_primary_auth set to False)
