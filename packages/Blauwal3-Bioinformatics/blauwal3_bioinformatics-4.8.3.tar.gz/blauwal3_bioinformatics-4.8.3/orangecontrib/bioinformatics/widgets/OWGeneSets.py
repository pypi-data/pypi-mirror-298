...
def __(key):
    return i18n.t('bioinformatics.owgeneSets.' + key)
...
class OWGeneSets(OWWidget, ConcurrentWidgetMixin):
    ...
    class Outputs:
        ...
        reduced_data = Output('Reduced Data', Table, label=i18n.t("bioinformatics.common.match_gene"))
