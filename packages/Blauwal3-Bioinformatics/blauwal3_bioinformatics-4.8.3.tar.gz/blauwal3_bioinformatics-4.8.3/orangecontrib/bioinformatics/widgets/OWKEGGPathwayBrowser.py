...
from Orange.widgets.utils import concurrents
...
class OWKEGGPathwayBrowser(widget.OWWidget):
    ...
    inputs = [
        (i18n.t("bioinformatics.common.data"), Orange.data.Table, "SetData", widget.Default),
              (i18n.t("bioinformatics.common.reference"), Orange.data.Table, "SetRefData"),
    ]
    outputs = [
        (i18n.t("bioinformatics.common.select_data"), Orange.data.Table, widget.Default),
    ...
    def _onEnrichTaskFinished(self):
        ...
        self.infoLabel.setText(
            __("text.input_unique_gene").format(len(set(self.input_genes)))
        )
