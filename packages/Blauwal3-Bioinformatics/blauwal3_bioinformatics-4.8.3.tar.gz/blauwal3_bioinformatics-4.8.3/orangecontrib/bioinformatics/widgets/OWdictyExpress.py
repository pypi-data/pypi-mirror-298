...
#             box, self, __("btn.sign_in"), callback=self.sign_in, autoDefault=False
#         )
...
#             self,
#             "gene_as_attr_name",
#             [__("gbox_gene_row"), __("gbox_gen_column")],
...
#             self.controlArea, self, "auto_commit", __("btn_commit"), box=False
#         )
#
#         # Experiment Section
#
