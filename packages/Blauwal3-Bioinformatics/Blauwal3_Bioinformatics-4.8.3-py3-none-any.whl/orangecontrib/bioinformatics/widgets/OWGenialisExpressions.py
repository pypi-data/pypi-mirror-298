...
#     expression_types = (Expression('rc', __("row.read_count")),) + tuple(
...
#             __("msg.unexpected_feature_type")
#         )
#         multiple_feature_type = Msg(
#             __("msg.multiple_feature_type")
#         )
#
#     def __init__(self):
#         super().__init__()
...
#             box, self, __('box.sign_in'), callback=self.sign_in, autoDefault=False
#         )
#         self.sign_out_btn = gui.button(
#             box, self, __('btn.sign_out'), callback=self.sign_out, autoDefault=False
#         )
#
#         self.commit_button = gui.auto_commit(
#             self.controlArea, self, 'auto_commit', __("btn.commit"), box=False
#         )
