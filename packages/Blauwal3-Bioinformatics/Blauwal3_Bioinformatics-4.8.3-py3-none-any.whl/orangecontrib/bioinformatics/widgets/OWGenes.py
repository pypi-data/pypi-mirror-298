...
class OWGenes(OWWidget, ConcurrentWidgetMixin):
    ...
    def __init__(self):
        ...
        self.info_box = widgetLabel(
            widgetBox(self.controlArea, __("box_info"), addSpace=True), __("row_no_data_input")
        )
        ...
        self.exclude_radio = checkBox(
            ...
            self,
            'exclude_unmatched',
            __("checkbox_exclude_unmatch_gene"),
        ...
        self.replace_radio = checkBox(
            ...
            __("checkbox_gene_name_replace_feature_id"),
            callback=self.commit,
        )
        ...
        self.filter = lineEdit(
            ...
            self,
            'search_pattern',
            __("label_filter"), callbackOnType=True,
