...
class EIPBaseClient:
    def __init__(self, originator_udp_port=0x08AE):
    ...
    def list_identity(self, ip="195.168.1.255", timeout=1):
        """
        ...
        try:
            ...
            client.sendto(send_data, (ip, 44818))
    ...
    def _handle_udp_message(self):
        ...
        if (
            ...
            self.connnection_config.lock_receive_data.release()
            self.last_received_implicit_message = datetime.datetime.utcnow()
