...
setup(
    ...
    packages=find_packages(where='src', include=['yeastModel/*']),     # Automatically find and include packages (including submodule)
    include_package_data=True, 
    package_dir={"": "src"},   # Include additional files from the submodule
    package_data={
        'yEscher': ['etfl/*', 'yeastModel/*', 'model/*'],
    },
