...
class mechanism30(bmutils):
    ...
    def setup_plot(self):
        self.ax.set_title(f'Mechanism 30')
    ...
    def info():
        description = (
            ...
            "-----------------------\n"
            "Fixed-stride Leg mechanism with uz = 0 and ux = k (Constant horizontal velocity and zero vertical displacement).\n"
            "**Applications**:\n"
            "Walking Robots.\n"
        )
        return description