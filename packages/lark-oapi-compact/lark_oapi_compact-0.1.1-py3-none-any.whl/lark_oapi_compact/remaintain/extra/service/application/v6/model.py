...
class Application:
    __int_to_string_fields__ = attr.ib(
        type=List[str],
        default=["creator_id", "online_version_id", "unaudit_version_id"],
    )
    app_id = attr.ib(type=str, default=None, metadata={"json": "app_id"})
...
@to_json_decorator
@attr.s
class ApplicationAppUsageOverviewReqBody:
...
@attr.s
class ApplicationAppUsageOverviewResult:
    items = attr.ib(type=List[ApplicationAppUsage], default=None, metadata={"json": "items"})


@attr.s
class ApplicationVisibilityAddedEventData:
