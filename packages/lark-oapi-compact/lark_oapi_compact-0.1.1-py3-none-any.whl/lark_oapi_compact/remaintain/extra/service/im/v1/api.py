...
class ChatMemberUserService:
    def __init__(self, service):
        # type: (Service) -> None
        self.service = service


class ChatMemberBotService:
    def __init__(self, service):
        # type: (Service) -> None
        self.service = service


class ChatAnnouncementService:
    def __init__(self, service):
        # type: (Service) -> None
        self.service = service
...
class ChatAnnouncementGetReqCall:
    def __init__(self, service, request_opts=None):
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=ChatAnnouncementGetResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class ChatAnnouncementPatchReqCall:
    def __init__(self, service, body, request_opts=None):
...
class ChatMembersCreateReqCall:
    def __init__(self, service, body, request_opts=None):
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=ChatMembersCreateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class ChatMembersDeleteReqCall:
    def __init__(self, service, body, request_opts=None):
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=ChatMembersDeleteResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class ChatMembersGetReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=ChatMembersGetResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class ChatMembersIsInChatReqCall:
    def __init__(self, service, request_opts=None):
        # type: (ChatMembersService, List[Any]) -> None
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=ChatMembersIsInChatResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class ChatMembersMeJoinReqCall:
    def __init__(self, service, request_opts=None):
        # type: (ChatMembersService, List[Any]) -> None
...
class ImageCreateReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=ImageCreateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MessageListReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=MessageListResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MessageReadUsersReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=MessageReadUsersResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MessageResourceGetReqCall:
    def __init__(self, service, request_opts=None):
