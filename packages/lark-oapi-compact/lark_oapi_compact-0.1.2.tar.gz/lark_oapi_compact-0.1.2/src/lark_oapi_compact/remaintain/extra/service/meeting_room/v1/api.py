...
class BuildingBatchGetReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=BuildingBatchGetResult,
...
class BuildingBatchGetIdReqCall:
    def __init__(self, service, request_opts=None):
        # type: (BuildingService, List[Any]) -> None
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=BuildingBatchGetIdResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class BuildingCreateReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/building/create",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=BuildingCreateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class BuildingDeleteReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/building/delete",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            request_opts=self.request_opts,
...
class BuildingListReqCall:
    ...
    def do(self):
        ...
        self.request_opts += [set_query_params(self.query_params)]
        req = APIRequest(
            "/open-apis/meeting_room/building/list",
            "GET",
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=BuildingListResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class BuildingUpdateReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/building/update",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            request_opts=self.request_opts,
...
class CountryListReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/country/list",
            "GET",
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=CountryListResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class DistrictListReqCall:
    ...
    def do(self):
        ...
        self.request_opts += [set_query_params(self.query_params)]
        req = APIRequest(
            "/open-apis/meeting_room/district/list",
            "GET",
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=DistrictListResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class FreebusyBatchGetReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=FreebusyBatchGetResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class RoomBatchGetReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=RoomBatchGetResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class RoomBatchGetIdReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=RoomBatchGetIdResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class RoomCreateReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/room/create",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=RoomCreateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class RoomDeleteReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/room/delete",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            request_opts=self.request_opts,
...
class RoomListReqCall:
    ...
    def do(self):
        ...
        self.request_opts += [set_query_params(self.query_params)]
        req = APIRequest(
            "/open-apis/meeting_room/room/list",
            "GET",
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=RoomListResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class SummaryBatchGetReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/meeting_room/summary/batch_get",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=SummaryBatchGetResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
