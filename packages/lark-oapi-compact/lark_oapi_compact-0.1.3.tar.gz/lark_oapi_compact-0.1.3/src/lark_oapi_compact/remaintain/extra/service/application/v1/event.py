...
class AppStatusChangeEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "app_status_change", handler.handle, clazz=AppStatusChangeEvent)


class AppUninstalledEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "app_uninstalled", handler.handle, clazz=AppUninstalledEvent)
...
class OrderPaidEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "order_paid", handler.handle, clazz=OrderPaidEvent)
