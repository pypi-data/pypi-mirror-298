...
class AuditObjectDetail:
    ...
    permission_external_access__type = attr.ib(
        type=bool, default=None, metadata={"json": "permission_external_access_Type"}
    )
...
class AuditEventExtend:
    ...
    external_people_num_in_doc_share = attr.ib(
        type=int, default=None, metadata={"json": "external_people_num_in_doc_share"}
    )
