...
class RoomDigitalSignage:
    ...
    materials = attr.ib(
        type=List[RoomDigitalSignageMaterial],
        default=None,
        metadata={"json": "materials"},
    )
...
class RoomConfig:
    ...
    room_box_digital_signage = attr.ib(
        type=RoomDigitalSignage,
        default=None,
        metadata={"json": "room_box_digital_signage"},
    )
...
class MeetingParticipant:
    __int_to_string_fields__ = attr.ib(
        type=List[str],
        default=["first_join_time", "final_leave_time", "in_meeting_duration"],
    )
    id = attr.ib(type=str, default=None, metadata={"json": "id"})
...
class ReserveActionPermission:
    ...
    permission_checkers = attr.ib(
        type=List[ReservePermissionChecker],
        default=None,
        metadata={"json": "permission_checkers"},
    )
...
class ReportMeetingDaily:
    __int_to_string_fields__ = attr.ib(
        type=List[str],
        default=["date", "meeting_count", "meeting_duration", "participant_count"],
    )
...
class ReserveMeetingSetting:
    ...
    action_permissions = attr.ib(
        type=List[ReserveActionPermission],
        default=None,
        metadata={"json": "action_permissions"},
    )
...
@to_json_decorator
@attr.s
class MeetingInviteReqBody:
    invitees = attr.ib(type=List[MeetingUser], default=None, metadata={"json": "invitees"})


@attr.s
class MeetingInviteResult:
    invite_results = attr.ib(
        type=List[MeetingInviteStatus],
        default=None,
        metadata={"json": "invite_results"},
    )


@to_json_decorator
@attr.s
class MeetingSetHostReqBody:
    host_user = attr.ib(type=MeetingUser, default=None, metadata={"json": "host_user"})
    old_host_user = attr.ib(type=MeetingUser, default=None, metadata={"json": "old_host_user"})


@attr.s
class MeetingSetHostResult:
    host_user = attr.ib(type=MeetingUser, default=None, metadata={"json": "host_user"})


@attr.s
class MeetingGetResult:
    meeting = attr.ib(type=Meeting, default=None, metadata={"json": "meeting"})


@to_json_decorator
@attr.s
class MeetingKickoutReqBody:
    kickout_users = attr.ib(type=List[MeetingUser], default=None, metadata={"json": "kickout_users"})


@attr.s
class MeetingKickoutResult:
    kickout_results = attr.ib(
        type=List[MeetingParticipantResult],
        default=None,
        metadata={"json": "kickout_results"},
    )


@attr.s
class MeetingListByNoResult:
...
@attr.s
class ReserveApplyResult:
    reserve = attr.ib(type=Reserve, default=None, metadata={"json": "reserve"})


@attr.s
class ReserveGetResult:
    reserve = attr.ib(type=Reserve, default=None, metadata={"json": "reserve"})


@attr.s
class ReserveGetActiveMeetingResult:
    meeting = attr.ib(type=Meeting, default=None, metadata={"json": "meeting"})


@to_json_decorator
@attr.s
class RoomConfigSetReqBody:
...
@attr.s
class MeetingLeaveMeetingEventData:
...
@attr.s
class MeetingMeetingEndedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingMeetingStartedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingRecordingEndedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingShareEndedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingJoinMeetingEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingRecordingStartedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingShareStartedEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    operator = attr.ib(type=MeetingEventUser, default=None, metadata={"json": "operator"})
...
@attr.s
class MeetingRecordingReadyEventData:
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={"json": "meeting"})
    url = attr.ib(type=str, default=None, metadata={"json": "url"})
    duration = attr.ib(type=int, default=None, metadata={"json": "duration"})
