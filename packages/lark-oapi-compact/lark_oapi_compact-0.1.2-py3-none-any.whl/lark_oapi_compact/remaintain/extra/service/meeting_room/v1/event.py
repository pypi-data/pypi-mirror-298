...
class MeetingRoomStatusChangedEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRoomStatusChangedEvent,
        )


class MeetingRoomCreatedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRoomCreatedEvent,
        )


class MeetingRoomDeletedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRoomDeletedEvent,
        )


class MeetingRoomUpdatedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRoomUpdatedEvent,
        )


class RoomCreatedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "meeting_room.room.created_v1", handler.handle, clazz=RoomCreatedEvent)
...
class RoomDeletedEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "meeting_room.room.deleted_v1", handler.handle, clazz=RoomDeletedEvent)


class RoomStatusChangedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf,
            "meeting_room.room.status_changed_v1",
            handler.handle,
            clazz=RoomStatusChangedEvent,
        )


class RoomUpdatedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "meeting_room.room.updated_v1", handler.handle, clazz=RoomUpdatedEvent)
