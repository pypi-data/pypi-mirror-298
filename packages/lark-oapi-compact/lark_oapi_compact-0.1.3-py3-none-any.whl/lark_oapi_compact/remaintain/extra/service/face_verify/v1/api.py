...
class FaceVerifyCropFaceImageReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            "/open-apis/face_verify/v1/crop_face_image",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=FaceVerifyCropFaceImageResult,
...
class FaceVerifyQueryAuthResultReqCall:
    def __init__(self, service, request_opts=None):
        # type: (FaceVerifyService, List[Any]) -> None
    ...
    def do(self):
        ...
        req = APIRequest(
            "/open-apis/face_verify/v1/query_auth_result",
            "GET",
            [ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=FaceVerifyQueryAuthResultResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class FaceVerifyUploadFaceImageReqCall:
    def __init__(self, service, request_opts=None):
        # type: (FaceVerifyService, List[Any]) -> None
    ...
    def do(self):
        ...
        self.request_opts += [set_query_params(self.query_params)]
        req = APIRequest(
            "/open-apis/face_verify/v1/upload_face_image",
            "POST",
            [ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=FaceVerifyUploadFaceImageResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
