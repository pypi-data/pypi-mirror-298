...
class MemberCreateReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            self.body,
            output_class=MemberCreateResult,
...
class MemberDeleteReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=MemberDeleteResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MemberPermittedReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=MemberPermittedResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MemberTransferReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=MemberTransferResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class MemberUpdateReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=MemberUpdateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class PublicUpdateReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            ...
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=PublicUpdateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
