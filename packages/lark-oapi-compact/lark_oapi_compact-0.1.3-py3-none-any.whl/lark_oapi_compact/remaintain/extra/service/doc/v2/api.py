...
class DocBatchUpdateReqCall:
    ...
    def do(self):
        ...
        req = APIRequest(
            "/open-apis/doc/v2/:docToken/batch_update",
            "POST",
...
class DocCreateReqCall:
    ...
    def do(self):
        ...
        conf = root_service.conf
        req = APIRequest(
            "/open-apis/doc/v2/create",
            "POST",
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            self.body,
            output_class=DocCreateResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class DocMetaReqCall:
    ...
    def do(self):
        ...
        self.request_opts += [set_path_params(self.path_params)]
        req = APIRequest(
            "/open-apis/doc/v2/meta/:docToken",
            "GET",
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=DocMetaResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
...
class DocRawContentReqCall:
    ...
    def do(self):
        ...
        self.request_opts += [set_path_params(self.path_params)]
        req = APIRequest(
            "/open-apis/doc/v2/:docToken/raw_content",
            "GET",
            [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
            None,
            output_class=DocRawContentResult,
            request_opts=self.request_opts,
        )
        resp = req.do(conf)
        return resp
