...
class FileDeletedEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "drive.file.deleted_v1", handler.handle, clazz=FileDeletedEvent)


class FilePermissionMemberAddedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=FilePermissionMemberAddedEvent,
        )


class FilePermissionMemberRemovedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=FilePermissionMemberRemovedEvent,
        )


class FileReadEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "drive.file.read_v1", handler.handle, clazz=FileReadEvent)


class FileTitleUpdatedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=FileTitleUpdatedEvent,
        )


class FileTrashedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "drive.file.trashed_v1", handler.handle, clazz=FileTrashedEvent)


class FileEditEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(conf, "drive.file.edit_v1", handler.handle, clazz=FileEditEvent)
