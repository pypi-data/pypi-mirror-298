...
class MeetingLeaveMeetingEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingLeaveMeetingEvent,
        )


class MeetingMeetingEndedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingMeetingEndedEvent,
        )


class MeetingMeetingStartedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingMeetingStartedEvent,
        )


class MeetingRecordingEndedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRecordingEndedEvent,
        )


class MeetingShareEndedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingShareEndedEvent,
        )


class MeetingJoinMeetingEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingJoinMeetingEvent,
        )


class MeetingRecordingStartedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRecordingStartedEvent,
        )


class MeetingShareStartedEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingShareStartedEvent,
        )


class MeetingRecordingReadyEventHandler:
    def __init__(self, callback):
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            ...
            handler.handle,
            clazz=MeetingRecordingReadyEvent,
        )
