...
class CalendarEventAttendee:
    ...
    resource_customization = attr.ib(
        type=List[CalendarAttendeeResourceCustomization],
        default=None,
        metadata={"json": "resource_customization"},
    )
...
@attr.s
class CalendarSubscribeResult:
    calendar = attr.ib(type=Calendar, default=None, metadata={"json": "calendar"})


@attr.s
class CalendarAclListResult:
...
@attr.s
class CalendarEventPatchResult:
    event = attr.ib(type=CalendarEvent, default=None, metadata={"json": "event"})


@to_json_decorator
@attr.s
class CalendarEventSearchReqBody:
    query = attr.ib(type=str, default=None, metadata={"json": "query"})
...
@attr.s
class CalendarEventAttendeeListResult:
...
@to_json_decorator
@attr.s
class CalendarEventAttendeeBatchDeleteReqBody:
...
@to_json_decorator
@attr.s
class CalendarEventAttendeeCreateReqBody:
    attendees = attr.ib(type=List[CalendarEventAttendee], default=None, metadata={"json": "attendees"})
    need_notification = attr.ib(type=bool, default=None, metadata={"json": "need_notification"})


@attr.s
class CalendarEventAttendeeCreateResult:
    attendees = attr.ib(type=List[CalendarEventAttendee], default=None, metadata={"json": "attendees"})


@attr.s
class CalendarEventAttendeeChatMemberListResult:
    items = attr.ib(
        type=List[CalendarEventAttendeeChatMember],
        default=None,
        metadata={"json": "items"},
    )
    has_more = attr.ib(type=bool, default=None, metadata={"json": "has_more"})
...
@attr.s
class CalendarChangedEventData:
    user_id_list = attr.ib(type=List[UserId], default=None, metadata={"json": "user_id_list"})
...
@attr.s
class CalendarAclCreatedEventData:
    acl_id = attr.ib(type=str, default=None, metadata={"json": "acl_id"})
    role = attr.ib(type=str, default=None, metadata={"json": "role"})
    scope = attr.ib(type=AclScopeEvent, default=None, metadata={"json": "scope"})
    user_id_list = attr.ib(type=List[UserId], default=None, metadata={"json": "user_id_list"})
...
@attr.s
class CalendarAclDeletedEventData:
    acl_id = attr.ib(type=str, default=None, metadata={"json": "acl_id"})
    role = attr.ib(type=str, default=None, metadata={"json": "role"})
    scope = attr.ib(type=AclScopeEvent, default=None, metadata={"json": "scope"})
    user_id_list = attr.ib(type=List[UserId], default=None, metadata={"json": "user_id_list"})
...
@attr.s
class CalendarEventChangedEventData:
    calendar_id = attr.ib(type=str, default=None, metadata={"json": "calendar_id"})
    user_id_list = attr.ib(type=List[UserId], default=None, metadata={"json": "user_id_list"})
