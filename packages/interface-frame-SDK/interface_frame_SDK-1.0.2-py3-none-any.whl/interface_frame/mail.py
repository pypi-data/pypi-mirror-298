...
if __name__ == "__main__":
    sent_mail("chengwenping2@newhope.cn", "chengwenping2", ["chengwenping2@newhope.cn","18108278175@163.com"], [], "自动化巡检报告",
              "just a test",{"test1":r"D:\autotest\smartinterface_api\test_report\01-测试物料\APP端登录并获取cookie值.html",
                             "test2":r"D:\autotest\smartinterface_api\test_report\慧养猪功能巡检.html"})
