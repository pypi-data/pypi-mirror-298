...
class ModelScraper_l(Scraper):
    ...
    def _get_model_info(self, url: str='https://www.lg.com/us/tvs/lg-oled83c4pua-oled-4k-tv') -> dict:
        """
        ...
        try:
            ...
            if len(matches) == 3:
                dict_info["price"] = float(matches[0].replace(',', ''))
                dict_info["price_gap"] = float(matches[1].replace(',', ''))
                dict_info["price_original"] = dict_info["price"] + dict_info["price_gap"] 
            else:
    ...
    def _get_global_spec(self, url: str='https://www.lg.com/us/tvs/lg-oled83c4pua-oled-4k-tv') -> dict:
        """
        ...
        for cnt_try in range(try_total):
            try:
                ...
                # element_click_expand_all = driver.find_element(By.XPATH,
                #                                                '//*[@id="simple-tabpanel-3"]/div[1]/a')
