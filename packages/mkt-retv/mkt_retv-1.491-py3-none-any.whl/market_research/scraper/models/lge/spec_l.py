...
class ModelScraper_l(Scraper, DataVisualizer):
    def __init__(self, enable_headless=True,
        ...
        Scraper.__init__(enable_headless=enable_headless, export_prefix=export_prefix,
        ...
        self.data = self._get_models_info(demo_mode=demo_mode)    
        DataVisualizer.__init__(self, df = self.data, plot_name='lge')
