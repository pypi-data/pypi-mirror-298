...
def __(key):
    return i18n.t("widget.overlay." + key)
    ...
    def addButton(self, button, *rolearg):
        ...
        if isinstance(button, QAbstractButton):
            ...
            if button == MessageWidget.Ok:
                ...
                button = QPushButton(__("btn_ok"), default=False, autoDefault=False)
...
#                                QStyle.SP_TitleBarCloseButton)))
                ...
                button = QPushButton(__("btn_help"), default=False, autoDefault=False)
