...
def main(data: MorphGlobalContext) -> str:
    # The `generate_report` function generates a report for the specified cells.
    return generate_report(
        [ref("${MORPH_PARENT_NAME}")],
        "",  # prompt for the report
        "English",  # launguage you want the report to be in
    )
