                ...
                for ret_data in ret_list:
                    ...
                    if "cat" in command and "grep" in command:
                        ...
                        if '/home/qingjiao' in command:
                            ret_data['exec'] = "echo {},{} >> {}".format(keyword, value, path_name)
                        else:
                    ...
                    if command.strip().startswith("grep") and '/home/qingjiao' in command:
                        ...
                        ret_data['exec'] = "echo {},{} >> {}".format(keyword, value, file_name)
            if inplace:
                for ret_data in ret_list[-3:]:
                    if 'exec' in ret_data:
