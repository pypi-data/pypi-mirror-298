...
class Diffusivity(jneqsim.neqsim.physicalProperties.physicalPropertyMethods.solidPhysicalProperties.SolidPhysicalPropertyMethod, jneqsim.neqsim.physicalProperties.physicalPropertyMethods.methodInterface.DiffusivityInterface):
    @typing.overload
    def __init__(self): ...
    @typing.overload
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.neqsim.physicalProperties.physicalPropertyMethods.solidPhysicalProperties.diffusivity")``.
