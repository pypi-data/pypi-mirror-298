...
class WettedWallColumnData(jneqsim.neqsim.statistics.experimentalEquipmentData.ExperimentalEquipmentData):
    @typing.overload
    def __init__(self): ...
    @typing.overload
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.neqsim.statistics.experimentalEquipmentData.wettedWallColumnData")``.
