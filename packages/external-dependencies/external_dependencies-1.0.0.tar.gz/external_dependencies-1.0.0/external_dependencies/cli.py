...
from .utils import _list_external_dependencies, _filter_external_dependencies, _install_s3, _install_apt
...
def install_using_apt(
    ...
    """Instal the required external dependencies using apt."""
