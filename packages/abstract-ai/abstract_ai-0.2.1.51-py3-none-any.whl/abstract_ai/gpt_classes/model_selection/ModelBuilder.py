class ModelManager:
    ...
    def __init__(self, input_model_name:str=None, input_endpoint:str=None, default_selection:bool=True)->None:
        ...
        self.all_models = [{'model': 'o1', 'endpoint': 'https://api.openai.com/v1/chat/completions', 'tokens': 32768},
                        {'model': 'whisper-1', 'endpoint': 'https://api.openai.com/v1/audio/transcriptions', 'tokens': None},
