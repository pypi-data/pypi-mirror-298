...
class GetActiveOrders_Res(_message.Message):
    __slots__ = ("order_id", "active_orders")
    ...
    def __init__(self, order_id: _Optional[str] = ..., active_orders: _Optional[_Iterable[_Union[_order_pb2.Order, _Mapping]]] = ...) -> None: ...
...
class GetHoldings_Res(_message.Message):
    __slots__ = ("code", "holdings")
    CODE_FIELD_NUMBER: _ClassVar[int]
    HOLDINGS_FIELD_NUMBER: _ClassVar[int]
    code: str
    holdings: _containers.RepeatedCompositeFieldContainer[_position_pb2.Position]
    def __init__(self, code: _Optional[str] = ..., holdings: _Optional[_Iterable[_Union[_position_pb2.Position, _Mapping]]] = ...) -> None: ...
