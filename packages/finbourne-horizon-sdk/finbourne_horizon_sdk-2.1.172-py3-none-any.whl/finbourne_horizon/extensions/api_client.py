...
import finbourne_horizon.models
from finbourne_horizon.extensions import rest
from finbourne_horizon.exceptions import ApiValueError, ApiException
...
class SyncApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.default_headers = {
            ...
            "X-LUSID-SDK-Version":  version("finbourne_horizon-sdk")
        }
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(finbourne_horizon.models, klass)
