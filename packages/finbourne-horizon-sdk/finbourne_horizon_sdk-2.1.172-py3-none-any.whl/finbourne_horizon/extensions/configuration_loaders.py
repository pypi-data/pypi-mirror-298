...
from finbourne_horizon.extensions.file_access_token import FileAccessToken

logger = logging.getLogger(__name__)

ENVIRONMENT_CONFIG_KEYS = {
    "token_url": "FBN_TOKEN_URL",
    "api_url": "FBN_HORIZON_URL",
    "previous_api_url": "FBN_FINBOURNE_HORIZON_API_URL",
...
SECRETS_FILE_CONFIG_KEYS = {
    "token_url": "tokenUrl",
    "api_url": "horizonUrl",
    "previous_api_url": "finbourne_horizonUrl",
    "username": "username",
    "password": "password",
    "client_id": "clientId",
