...
class SecsIProtocol(secsgem_cyg.common.Protocol[SecsIMessage, SecsIBlock]):
    ...
    def __init__(self, settings: SecsISettings):
        ...
        Example:
            ...
            settings = secsgem_cyg.secsi.SecsISettings(
                port="COM1",
            )
            ...
            client = secsgem_cyg.secsi.SecsIProtocol(settings)
    ...
    def _create_message_for_function(
        ...
        return SecsIMessage(
            SecsIHeader(
                ...
                from_equipment=(self._settings.device_type == secsgem_cyg.common.DeviceType.EQUIPMENT),
            ),
            function.encode(),
        )
    ...
    def _process_send_queue(self):
        ...
        while not self._send_queue.empty():
            ...
            if enq_resonse == self.ENQ and self._settings.device_type == secsgem_cyg.common.DeviceType.HOST:
