...
class Dynamic(Base):
    ...
    def __init__(self, types, value=None, count=-1):
        ...
        :type types: list of :class:`secsgem_cyg.secs.variables.Base` classes
    ...
    def set(self, value):
        ...
        Example:
            ...
            >>>
            >>> var = secsgem_cyg.secs.variables.Dynamic([secsgem_cyg.secs.variables.String,
            ...                                       secsgem_cyg.secs.variables.U1])
            >>> var.set(secsgem_cyg.secs.variables.U1(10))
            >>> var
            <U1 10 >
