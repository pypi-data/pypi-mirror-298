...
from secsgem_cyg.secs.data_items import ALCD, ALID, ALTX
...
class SecsS05F06(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS05F06
        [
            {
                ALCD: B[1]
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS05F06([
        ...     {"ALCD": secsgem_cyg.secs.data_items.ALCD.PERSONAL_SAFETY |
        ...              secsgem_cyg.secs.data_items.ALCD.ALARM_SET,
        ...      "ALID": 100,
        ...      "ALTX": "text"}])
        S5F6
          <L [1]
