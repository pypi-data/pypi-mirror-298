...
from secsgem_cyg.secs.data_items import BCEQU, FFROT, FNLOC, IDTYP, MAPFT, MID, NULBC, ORLOC, PRAXI
...
class SecsS12F03(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS12F03
        {
            MID: A/B[80]
            IDTYP: B[1]
            MAPFT: B[1]
        ...
        >>> secsgem_cyg.secs.functions.SecsS12F03({
        ...     "MID": "materialID",
        ...     "IDTYP": secsgem_cyg.secs.data_items.IDTYP.WAFER_CASSETTE,
        ...     "MAPFT": secsgem_cyg.secs.data_items.MAPFT.ROW,
        ...     "FNLOC": 0,
        ...     "FFROT": 0,
        ...     "ORLOC": secsgem_cyg.secs.data_items.ORLOC.LOWER_LEFT,
        ...     "PRAXI": secsgem_cyg.secs.data_items.PRAXI.COLS_LEFT_INCR,
        ...     "BCEQU": [1, 3, 5, 7],
        ...     "NULBC": "{x}"})
        S12F3 W
          <L [9]
