...
from secsgem_cyg.secs.data_items import CPACK, CPNAME, HCACK
...
class SecsS02F42(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F42
        {
            HCACK: B[1]
            PARAMS: [
                {
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F42({
        ...     "HCACK": secsgem_cyg.secs.data_items.HCACK.INVALID_COMMAND,
        ...     "PARAMS": [
        ...         {"CPNAME": "PARAM1", "CPACK": secsgem_cyg.secs.data_items.CPACK.CPVAL_ILLEGAL_VALUE},
        ...         {"CPNAME": "PARAM2", "CPACK": secsgem_cyg.secs.data_items.CPACK.CPVAL_ILLEGAL_FORMAT}]})
        S2F42
          <L [2]
            <B 0x1>
            <L [2]
