...
from secsgem_cyg.secs.data_items import RSDA
...
class SecsS06F24(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS06F24
        RSDA: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS06F24(secsgem_cyg.secs.data_items.RSDA.ACK)
        S6F24
          <B 0x0> .
