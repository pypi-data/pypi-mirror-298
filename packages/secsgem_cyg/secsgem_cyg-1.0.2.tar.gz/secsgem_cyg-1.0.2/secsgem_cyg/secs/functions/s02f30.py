...
from secsgem_cyg.secs.data_items import ECDEF, ECID, ECMAX, ECMIN, ECNAME, UNITS
...
class SecsS02F30(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F30
        [
            {
        ...
        ...     {"ECID": 1,
        ...       "ECNAME": "EC1",
        ...       "ECMIN": secsgem_cyg.secs.variables.U1(0),
        ...       "ECMAX": secsgem_cyg.secs.variables.U1(100),
        ...       "ECDEF": secsgem_cyg.secs.variables.U1(50),
        ...       "UNITS": "mm"},
        ...     {"ECID": 1337,
        ...       "ECNAME": "EC2",
        ...       "ECMIN": "",
