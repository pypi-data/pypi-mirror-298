...
from secsgem_cyg.secs.data_items import CPNAME, CPVAL, RCMD
...
class SecsS02F41(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F41
        {
            RCMD: U1/I1/A
            PARAMS: [
                {
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F41({"RCMD": "COMMAND", "PARAMS": [{"CPNAME": "PARAM1", "CPVAL": "VAL1"},
