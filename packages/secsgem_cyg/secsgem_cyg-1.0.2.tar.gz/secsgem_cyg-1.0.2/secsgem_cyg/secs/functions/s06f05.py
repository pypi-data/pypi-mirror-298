...
from secsgem_cyg.secs.data_items import DATAID, DATALENGTH
...
class SecsS06F05(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS06F05
        {
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS06F05({"DATAID": 1, "DATALENGTH": 1337})
        S6F5 W
          <L [2]
            <U1 1 >
            <U2 1337 >
