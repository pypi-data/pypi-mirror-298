...
from secsgem_cyg.secs.data_items import CMDA
...
class SecsS02F22(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F22
        CMDA: U1/I1

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F22(secsgem_cyg.secs.data_items.CMDA.DONE)
        S2F22
          <U1 0 > .
