...
from secsgem_cyg.secs.data_items import SV
...
class SecsS01F04(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS01F04
        [
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS01F04([secsgem_cyg.secs.variables.U1(1), "text", secsgem_cyg.secs.variables.U4(1337)])
        S1F4
          <L [3]
            <U1 1 >
            <A "text">
