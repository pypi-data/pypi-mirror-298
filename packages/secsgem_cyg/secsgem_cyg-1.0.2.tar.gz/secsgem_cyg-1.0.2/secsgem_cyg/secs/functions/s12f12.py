...
from secsgem_cyg.secs.data_items import MDACK
...
class SecsS12F12(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS12F12
        MDACK: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS12F12(secsgem_cyg.secs.data_items.MDACK.FORMAT_ERROR)
        S12F12
          <B 0x1> .
