...
from secsgem_cyg.secs.data_items import ERACK
...
class SecsS02F38(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F38
        ERACK: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F38(secsgem_cyg.secs.data_items.ERACK.CEID_UNKNOWN)
        S2F38
          <B 0x1> .
