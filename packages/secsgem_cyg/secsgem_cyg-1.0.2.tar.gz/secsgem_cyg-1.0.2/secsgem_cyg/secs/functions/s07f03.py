...
from secsgem_cyg.secs.data_items import PPBODY, PPID
...
class SecsS07F03(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS07F03
        {
            PPID: A/B[120]
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS07F03({"PPID": "program", "PPBODY": secsgem_cyg.secs.variables.Binary("data")})
        S7F3 W
          <L [2]
            <A "program">
