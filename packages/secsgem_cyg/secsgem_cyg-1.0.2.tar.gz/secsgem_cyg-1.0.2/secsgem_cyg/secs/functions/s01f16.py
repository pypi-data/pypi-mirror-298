...
from secsgem_cyg.secs.data_items import OFLACK
...
class SecsS01F16(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS01F16
        OFLACK: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS01F16(secsgem_cyg.secs.data_items.OFLACK.ACK)
        S1F16
          <B 0x0> .
