...
class DataValueCapability(GemHandler, Capability):
    ...
    def on_dv_value_request(self,
                            data_value_id: secsgem_cyg.secs.variables.Base,
                            data_value: DataValue) -> secsgem_cyg.secs.variables.Base:
    ...
    def _get_dv_value(self, data_value: DataValue) -> secsgem_cyg.secs.variables.Base:
        """Get the data value depending on its configuation.
