...
class EquipmentConstant:  # pylint: disable=too-many-instance-attributes,too-few-public-methods
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        **kwargs,
        ...
        :func:`secsgem_cyg.gem.equipmenthandler.GemEquipmentHandler.on_ec_value_request`
        and :func:`secsgem_cyg.gem.equipmenthandler.GemEquipmentHandler.on_ec_value_update` .
