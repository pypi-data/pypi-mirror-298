...
class GemHostHandler(GemHandler):
    ...
    def __init__(self, settings: secsgem_cyg.common.Settings):
    ...
    def get_process_program_list(self) -> secsgem_cyg.secs.SecsStreamFunction:
    ...
    def enable_alarm(self, alid: int | str):
        ...
        :type alid: :class:`secsgem_cyg.secs.dataitems.ALID`
        """
        ...
        return self.settings.streams_functions.decode(self.send_and_waitfor_response(self.stream_function(5, 3)(
            {"ALED": secsgem_cyg.secs.data_items.ALED.ENABLE, "ALID": alid}))).get()
    ...
    def disable_alarm(self, alid: int | str):
        ...
        return self.settings.streams_functions.decode(self.send_and_waitfor_response(self.stream_function(5, 3)(
            {"ALED": secsgem_cyg.secs.data_items.ALED.DISABLE, "ALID": alid}))).get()
    ...
    def _on_alarm_received(self, handler, alarm_id, alarm_code, alarm_text):
        ...
        return secsgem_cyg.secs.data_items.ACKC5.ACCEPTED
    ...
    def _on_terminal_received(self, handler, terminal_id, text):
        ...
        return secsgem_cyg.secs.data_items.ACKC10.ACCEPTED
