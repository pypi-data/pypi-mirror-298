...
class SecsITcpSettings(secsgem_cyg.secsi.SecsISettings):
    """Settings for Secs I over TCP connection.

    These attributes can be initialized in the constructor and accessed as property.

    Example:
        >>> import secsgem_cyg.secsitcp
        >>>
        >>> settings = secsgem_cyg.secsitcp.SecsITcpSettings(device_type=secsgem_cyg.common.DeviceType.EQUIPMENT)
