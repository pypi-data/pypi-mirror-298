...
class DataValue:
    ...
    def __init__(self,
                 dvid: int | str,
                 name: str,
                 value_type: type[secsgem_cyg.secs.variables.Base],
        ...
        :func:`secsgem_cyg.gem.equipmenthandler.GemEquipmentHandler.on_dv_value_request`.
        ...
        self._id_type: type[secsgem_cyg.secs.variables.Base]

        if isinstance(self._dvid, int):
            self._id_type = secsgem_cyg.secs.variables.U4
        else:
            self._id_type = secsgem_cyg.secs.variables.String
    ...
    @property
    def value_type(self) -> type[secsgem_cyg.secs.variables.Base]:
    ...
    @property
    def id_type(self) -> type[secsgem_cyg.secs.variables.Base]:
