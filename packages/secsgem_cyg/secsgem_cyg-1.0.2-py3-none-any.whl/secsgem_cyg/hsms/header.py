...
class HsmsHeader(secsgem_cyg.common.Header):
    """Generic HSMS header.
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        Example:
            ...
            >>>
            >>> secsgem_cyg.hsms.HsmsHeader(3, 100)
...
require_response:False})
    ...
    def encode(self) -> bytes:
        ...
        Example:
            ...
            >>> import secsgem_cyg.common
            >>>
            >>> header = secsgem_cyg.hsms.HsmsLinktestReqHeader(2)
            >>> secsgem_cyg.common.format_hex(header.encode())
