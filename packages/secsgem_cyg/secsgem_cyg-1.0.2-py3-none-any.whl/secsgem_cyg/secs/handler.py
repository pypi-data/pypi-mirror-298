...
class SecsHandler:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def __init__(self, settings: secsgem_cyg.common.Settings):
        ...
        self._callback_handler = secsgem_cyg.common.CallbackHandler()
        self._callback_handler.target = self

    @property
    def settings(self) -> secsgem_cyg.common.Settings:
    ...
    @property
    def protocol(self) -> secsgem_cyg.common.Protocol:
    ...
    def stream_function(self, stream: int, function: int) -> type[secsgem_cyg.secs.SecsStreamFunction]:
