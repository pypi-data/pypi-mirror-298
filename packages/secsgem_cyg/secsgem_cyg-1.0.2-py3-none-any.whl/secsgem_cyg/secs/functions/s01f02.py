...
from secsgem_cyg.secs.data_items import MDLN
...
class SecsS01F02(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS01F02
        [
            MDLN: A[20]
            ...
        ]
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS01F02(["secsgem_cyg", "0.0.6"]) # E->H
        S1F2
          <L [2]
            <A "secsgem">
            <A "0.0.6">
          > .
        >>> secsgem_cyg.secs.functions.SecsS01F02() # H->E
        S1F2
          <L> .
