...
from secsgem_cyg.secs.data_items import ALED, ALID
...
class SecsS05F03(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS05F03
        {
            ALED: B[1]
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS05F03({"ALED": secsgem_cyg.secs.data_items.ALED.ENABLE, "ALID": 100})
        S5F3
          <L [2]
            <B 0x80>
            <U1 100 >
