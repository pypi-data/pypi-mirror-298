...
from secsgem_cyg.secs.data_items import GRANT6
...
class SecsS06F06(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS06F06
        GRANT6: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS06F06(secsgem_cyg.secs.data_items.GRANT6.BUSY)
        S6F6
          <B 0x1> .
