...
from secsgem_cyg.secs.data_items import TIAACK
...
class SecsS02F24(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F24
        TIAACK: B[1]

        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F24(secsgem_cyg.secs.data_items.TIAACK.SVID_EXCEEDED)
        S2F24
          <B 0x1> .
