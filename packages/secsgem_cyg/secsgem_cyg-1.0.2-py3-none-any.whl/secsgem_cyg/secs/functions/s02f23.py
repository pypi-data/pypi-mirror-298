...
from secsgem_cyg.secs.data_items import DSPER, REPGSZ, SVID, TOTSMP, TRID
...
class SecsS02F23(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F23
        {
        ...
        ...     "TRID":1,
        ...     "DSPER":'000010',
        ...     "TOTSMP":secsgem_cyg.secs.variables.U4(10),
        ...     "REPGSZ":secsgem_cyg.secs.variables.U4(1),
        ...     "SVID":[1002004,400210]})
        S2F23 W
          <L [5]
            <I1 1 >
