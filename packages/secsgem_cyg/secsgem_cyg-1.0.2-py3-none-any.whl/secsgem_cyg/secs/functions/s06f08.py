...
from secsgem_cyg.secs.data_items import CEID, DATAID, DSID, DVNAME, DVVAL
...
class SecsS06F08(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS06F08
        {
        ...
        ...             {"DVNAME": "VAR2", "DVVAL": secsgem_cyg.secs.variables.U4(100)}]}]})
        S6F8
          <L [3]
            <U1 1 >
            <U2 1337 >
