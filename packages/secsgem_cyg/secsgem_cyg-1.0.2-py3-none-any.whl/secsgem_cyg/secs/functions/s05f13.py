...
from secsgem_cyg.secs.data_items import EXID, EXRECVRA
...
class SecsS05F13(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS05F13
        {
            EXID: A[20]
            EXRECVRA: A[40]
        }
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS05F13({"EXID": "EX123", "EXRECVRA": "EXRECVRA2"})
        S5F13 W
          <L [2]
            <A "EX123">
            <A "EXRECVRA2">
