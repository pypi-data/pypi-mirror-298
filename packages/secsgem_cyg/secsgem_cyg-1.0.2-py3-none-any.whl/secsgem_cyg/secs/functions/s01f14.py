...
from secsgem_cyg.secs.data_items import COMMACK, MDLN
...
class SecsS01F14(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS01F14
        {
            COMMACK: B[1]
            MDLN: [
                DATA: A[20]
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS01F14({"COMMACK": secsgem_cyg.secs.data_items.COMMACK.ACCEPTED,
        ...     "MDLN": ["secsgem_cyg", "0.0.6"]})
        S1F14
          <L [2]
            <B 0x0>
            <L [2]
