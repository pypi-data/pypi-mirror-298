...
from secsgem_cyg.secs.data_items import FCNID, STRID
...
class SecsS02F43(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F43
        [
            {
                STRID: U1[1]
                FCNID: [
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F43([{"STRID": 1, "FCNID": [10, 20]}, {"STRID": 2, "FCNID": [30, 40]}])
        S2F43 W
          <L [2]
            <L [2]
              <U1 1 >
