...
from secsgem_cyg.secs.data_items import LIMITACK, LIMITID, LVACK, VID, VLAACK
...
class SecsS02F46(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS02F46
        {
            VLAACK: B[1]
            DATA: [
                {
        ...
        >>> import secsgem_cyg.secs
        >>> secsgem_cyg.secs.functions.SecsS02F46({
        ...     "VLAACK": secsgem_cyg.secs.data_items.VLAACK.LIMIT_DEF_ERROR,
        ...     "DATA": [{
        ...         "VID": 2,
        ...         "LVACK": secsgem_cyg.secs.data_items.LVACK.VARIABLE_UNKNOWN,
        ...         "DATA": {
        ...             "LIMITID": 3,
        ...             "LIMITACK": secsgem_cyg.secs.data_items.LIMITACK.ASCII_ILLEGAL
        ...         }
        ...     }]})
        S2F46
          <L [2]
