...
from secsgem_cyg.secs.data_items import (
    COLCT,
    DUTMS,
    FFROT,
    FNLOC,
...
class SecsS12F01(SecsStreamFunction):
    ...
    Examples:
        ...
        >>> secsgem_cyg.secs.functions.SecsS12F01
        {
            MID: A/B[80]
            IDTYP: B[1]
            FNLOC: U2
        ...
        >>> secsgem_cyg.secs.functions.SecsS12F01({
        ...     "MID": "materialID",
        ...     "IDTYP": secsgem_cyg.secs.data_items.IDTYP.WAFER,
        ...     "FNLOC": 0,
        ...     "FFROT": 0,
        ...     "ORLOC": secsgem_cyg.secs.data_items.ORLOC.UPPER_LEFT,
        ...     "RPSEL": 0,
        ...     "REFP": [[1,2], [2,3]],
        ...     "DUTMS": "unit",
        ...     "XDIES": 100,
        ...
        ...     "NULBC": "{x}",
        ...     "PRDCT": 100,
        ...     "PRAXI": secsgem_cyg.secs.data_items.PRAXI.ROWS_TOP_INCR})
        S12F1 W
          <L [15]
            <A "materialID">
            <B 0x0>
