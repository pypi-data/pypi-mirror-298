...
enum [[deprecated]] : int {
    ...
    SBK_QFLAGS_QABSTRACTSOCKET_BINDFLAG_IDX                  = 46,
    SBK_QABSTRACTSOCKET_PAUSEMODE_IDX                        = 8,
    SBK_QFLAGS_QABSTRACTSOCKET_PAUSEMODE_IDX                 = 48,
    ...
    SBK_QDTLSCLIENTVERIFIER_GENERATORPARAMETERS_IDX          = 42,
    SBK_QHOSTADDRESS_SPECIALADDRESS_IDX                      = 70,
    SBK_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX                  = 68,
    SBK_QFLAGS_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX           = 50,
    SBK_QHOSTADDRESS_IDX                                     = 66,
    SBK_QHOSTINFO_HOSTINFOERROR_IDX                          = 74,
    SBK_QHOSTINFO_IDX                                        = 72,
    SBK_QHSTSPOLICY_POLICYFLAG_IDX                           = 78,
    SBK_QFLAGS_QHSTSPOLICY_POLICYFLAG_IDX                    = 52,
    SBK_QHSTSPOLICY_IDX                                      = 76,
    SBK_QHTTP1CONFIGURATION_IDX                              = 80,
    SBK_QHTTP2CONFIGURATION_IDX                              = 82,
    SBK_QHTTPHEADERS_WELLKNOWNHEADER_IDX                     = 86,
    SBK_QHTTPHEADERS_IDX                                     = 84,
    SBK_QHTTPMULTIPART_CONTENTTYPE_IDX                       = 90,
    SBK_QHTTPMULTIPART_IDX                                   = 88,
    SBK_QHTTPPART_IDX                                        = 92,
    SBK_QIPV6ADDRESS_IDX                                     = 94,
    SBK_QLOCALSERVER_SOCKETOPTION_IDX                        = 98,
    SBK_QFLAGS_QLOCALSERVER_SOCKETOPTION_IDX                 = 54,
    SBK_QLOCALSERVER_IDX                                     = 96,
    SBK_QLOCALSOCKET_LOCALSOCKETERROR_IDX                    = 102,
    SBK_QLOCALSOCKET_LOCALSOCKETSTATE_IDX                    = 104,
    SBK_QLOCALSOCKET_SOCKETOPTION_IDX                        = 106,
    SBK_QFLAGS_QLOCALSOCKET_SOCKETOPTION_IDX                 = 56,
    SBK_QLOCALSOCKET_IDX                                     = 100,
    SBK_QNETWORKACCESSMANAGER_OPERATION_IDX                  = 110,
    SBK_QNETWORKACCESSMANAGER_IDX                            = 108,
    SBK_QNETWORKADDRESSENTRY_DNSELIGIBILITYSTATUS_IDX        = 114,
    SBK_QNETWORKADDRESSENTRY_IDX                             = 112,
    SBK_QNETWORKCACHEMETADATA_IDX                            = 116,
    SBK_QNETWORKCOOKIE_RAWFORM_IDX                           = 120,
    SBK_QNETWORKCOOKIE_SAMESITE_IDX                          = 122,
    SBK_QNETWORKCOOKIE_IDX                                   = 118,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 124,
    SBK_QNETWORKDATAGRAM_IDX                                 = 126,
    SBK_QNETWORKDISKCACHE_IDX                                = 128,
    SBK_QNETWORKINFORMATION_REACHABILITY_IDX                 = 134,
    SBK_QNETWORKINFORMATION_TRANSPORTMEDIUM_IDX              = 136,
    SBK_QNETWORKINFORMATION_FEATURE_IDX                      = 132,
    SBK_QFLAGS_QNETWORKINFORMATION_FEATURE_IDX               = 58,
    SBK_QNETWORKINFORMATION_IDX                              = 130,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 140,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 60,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 142,
    SBK_QNETWORKINTERFACE_IDX                                = 138,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 148,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 146,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 62,
    SBK_QNETWORKPROXY_IDX                                    = 144,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 150,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 154,
    SBK_QNETWORKPROXYQUERY_IDX                               = 152,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 158,
    SBK_QNETWORKREPLY_IDX                                    = 156,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 166,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 162,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 164,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 168,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 170,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 172,
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 174,
    SBK_QNETWORKREQUEST_IDX                                  = 160,
    SBK_QNETWORKREQUESTFACTORY_IDX                           = 176,
    SBK_QOCSPRESPONSE_IDX                                    = 180,
    SBK_QTNETWORKQPASSWORDDIGESTOR_IDX                       = 184,
    SBK_QRESTACCESSMANAGER_IDX                               = 186,
    SBK_QRESTREPLY_IDX                                       = 188,
    SBK_QSSL_KEYTYPE_IDX                                     = 204,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 198,
    SBK_QSSL_KEYALGORITHM_IDX                                = 202,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 196,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 208,
    SBK_QSSL_SSLOPTION_IDX                                   = 206,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 64,
    SBK_QSSL_ALERTLEVEL_IDX                                  = 192,
    SBK_QSSL_ALERTTYPE_IDX                                   = 194,
    SBK_QSSL_IMPLEMENTEDCLASS_IDX                            = 200,
    SBK_QSSL_SUPPORTEDFEATURE_IDX                            = 210,
    SBK_QTNETWORKQSSL_IDX                                    = 190,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 216,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 214,
    SBK_QSSLCERTIFICATE_IDX                                  = 212,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 218,
    SBK_QSSLCIPHER_IDX                                       = 220,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 224,
    SBK_QSSLCONFIGURATION_IDX                                = 222,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 228,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 226,
    SBK_QSSLELLIPTICCURVE_IDX                                = 230,
    SBK_QSSLERROR_SSLERROR_IDX                               = 234,
    SBK_QSSLERROR_IDX                                        = 232,
    SBK_QSSLKEY_IDX                                          = 236,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 238,
    SBK_QSSLSERVER_IDX                                       = 240,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 246,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 244,
    SBK_QSSLSOCKET_IDX                                       = 242,
    SBK_QTCPSERVER_IDX                                       = 248,
    SBK_QTCPSOCKET_IDX                                       = 250,
    SBK_QUDPSOCKET_IDX                                       = 252,
    SBK_QDTLSERROR_IDX                                       = 44,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 178,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 182,
    SBK_QTNETWORK_IDX_COUNT                                  = 254,
};
...
enum : int {
    ...
    SBK_QFlags_QAbstractSocket_BindFlag_IDX                  = 23,
    SBK_QAbstractSocket_PauseMode_IDX                        = 4,
    SBK_QFlags_QAbstractSocket_PauseMode_IDX                 = 24,
    ...
    SBK_QDtlsClientVerifier_GeneratorParameters_IDX          = 21,
    SBK_QHostAddress_SpecialAddress_IDX                      = 35,
    SBK_QHostAddress_ConversionModeFlag_IDX                  = 34,
    SBK_QFlags_QHostAddress_ConversionModeFlag_IDX           = 25,
    SBK_QHostAddress_IDX                                     = 33,
    SBK_QHostInfo_HostInfoError_IDX                          = 37,
    SBK_QHostInfo_IDX                                        = 36,
    SBK_QHstsPolicy_PolicyFlag_IDX                           = 39,
    SBK_QFlags_QHstsPolicy_PolicyFlag_IDX                    = 26,
    SBK_QHstsPolicy_IDX                                      = 38,
    SBK_QHttp1Configuration_IDX                              = 40,
    SBK_QHttp2Configuration_IDX                              = 41,
    SBK_QHttpHeaders_WellKnownHeader_IDX                     = 43,
    SBK_QHttpHeaders_IDX                                     = 42,
    SBK_QHttpMultiPart_ContentType_IDX                       = 45,
    SBK_QHttpMultiPart_IDX                                   = 44,
    SBK_QHttpPart_IDX                                        = 46,
    SBK_QIPv6Address_IDX                                     = 47,
    SBK_QLocalServer_SocketOption_IDX                        = 49,
    SBK_QFlags_QLocalServer_SocketOption_IDX                 = 27,
    SBK_QLocalServer_IDX                                     = 48,
    SBK_QLocalSocket_LocalSocketError_IDX                    = 51,
    SBK_QLocalSocket_LocalSocketState_IDX                    = 52,
    SBK_QLocalSocket_SocketOption_IDX                        = 53,
    SBK_QFlags_QLocalSocket_SocketOption_IDX                 = 28,
    SBK_QLocalSocket_IDX                                     = 50,
    SBK_QNetworkAccessManager_Operation_IDX                  = 55,
    SBK_QNetworkAccessManager_IDX                            = 54,
    SBK_QNetworkAddressEntry_DnsEligibilityStatus_IDX        = 57,
    SBK_QNetworkAddressEntry_IDX                             = 56,
    SBK_QNetworkCacheMetaData_IDX                            = 58,
    SBK_QNetworkCookie_RawForm_IDX                           = 60,
    SBK_QNetworkCookie_SameSite_IDX                          = 61,
    SBK_QNetworkCookie_IDX                                   = 59,
    SBK_QNetworkCookieJar_IDX                                = 62,
    SBK_QNetworkDatagram_IDX                                 = 63,
    SBK_QNetworkDiskCache_IDX                                = 64,
    SBK_QNetworkInformation_Reachability_IDX                 = 67,
    SBK_QNetworkInformation_TransportMedium_IDX              = 68,
    SBK_QNetworkInformation_Feature_IDX                      = 66,
    SBK_QFlags_QNetworkInformation_Feature_IDX               = 29,
    SBK_QNetworkInformation_IDX                              = 65,
    SBK_QNetworkInterface_InterfaceFlag_IDX                  = 70,
    SBK_QFlags_QNetworkInterface_InterfaceFlag_IDX           = 30,
    SBK_QNetworkInterface_InterfaceType_IDX                  = 71,
    SBK_QNetworkInterface_IDX                                = 69,
    SBK_QNetworkProxy_ProxyType_IDX                          = 74,
    SBK_QNetworkProxy_Capability_IDX                         = 73,
    SBK_QFlags_QNetworkProxy_Capability_IDX                  = 31,
    SBK_QNetworkProxy_IDX                                    = 72,
    SBK_QNetworkProxyFactory_IDX                             = 75,
    SBK_QNetworkProxyQuery_QueryType_IDX                     = 77,
    SBK_QNetworkProxyQuery_IDX                               = 76,
    SBK_QNetworkReply_NetworkError_IDX                       = 79,
    SBK_QNetworkReply_IDX                                    = 78,
    SBK_QNetworkRequest_KnownHeaders_IDX                     = 83,
    SBK_QNetworkRequest_Attribute_IDX                        = 81,
    SBK_QNetworkRequest_CacheLoadControl_IDX                 = 82,
    SBK_QNetworkRequest_LoadControl_IDX                      = 84,
    SBK_QNetworkRequest_Priority_IDX                         = 85,
    SBK_QNetworkRequest_RedirectPolicy_IDX                   = 86,
    SBK_QNetworkRequest_TransferTimeoutConstant_IDX          = 87,
    SBK_QNetworkRequest_IDX                                  = 80,
    SBK_QNetworkRequestFactory_IDX                           = 88,
    SBK_QOcspResponse_IDX                                    = 90,
    SBK_QtNetworkQPasswordDigestor_IDX                       = 92,
    SBK_QRestAccessManager_IDX                               = 93,
    SBK_QRestReply_IDX                                       = 94,
    SBK_QSsl_KeyType_IDX                                     = 102,
    SBK_QSsl_EncodingFormat_IDX                              = 99,
    SBK_QSsl_KeyAlgorithm_IDX                                = 101,
    SBK_QSsl_AlternativeNameEntryType_IDX                    = 98,
    SBK_QSsl_SslProtocol_IDX                                 = 104,
    SBK_QSsl_SslOption_IDX                                   = 103,
    SBK_QFlags_QSsl_SslOption_IDX                            = 32,
    SBK_QSsl_AlertLevel_IDX                                  = 96,
    SBK_QSsl_AlertType_IDX                                   = 97,
    SBK_QSsl_ImplementedClass_IDX                            = 100,
    SBK_QSsl_SupportedFeature_IDX                            = 105,
    SBK_QtNetworkQSsl_IDX                                    = 95,
    SBK_QSslCertificate_SubjectInfo_IDX                      = 108,
    SBK_QSslCertificate_PatternSyntax_IDX                    = 107,
    SBK_QSslCertificate_IDX                                  = 106,
    SBK_QSslCertificateExtension_IDX                         = 109,
    SBK_QSslCipher_IDX                                       = 110,
    SBK_QSslConfiguration_NextProtocolNegotiationStatus_IDX  = 112,
    SBK_QSslConfiguration_IDX                                = 111,
    SBK_QSslDiffieHellmanParameters_Error_IDX                = 114,
    SBK_QSslDiffieHellmanParameters_IDX                      = 113,
    SBK_QSslEllipticCurve_IDX                                = 115,
    SBK_QSslError_SslError_IDX                               = 117,
    SBK_QSslError_IDX                                        = 116,
    SBK_QSslKey_IDX                                          = 118,
    SBK_QSslPreSharedKeyAuthenticator_IDX                    = 119,
    SBK_QSslServer_IDX                                       = 120,
    SBK_QSslSocket_SslMode_IDX                               = 123,
    SBK_QSslSocket_PeerVerifyMode_IDX                        = 122,
    SBK_QSslSocket_IDX                                       = 121,
    SBK_QTcpServer_IDX                                       = 124,
    SBK_QTcpSocket_IDX                                       = 125,
    SBK_QUdpSocket_IDX                                       = 126,
    SBK_QDtlsError_IDX                                       = 22,
    SBK_QOcspCertificateStatus_IDX                           = 89,
    SBK_QOcspRevocationReason_IDX                            = 91,
    SBK_QtNetwork_IDX_COUNT                                  = 127,
};
