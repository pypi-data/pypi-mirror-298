...
enum [[deprecated]] : int {
    ...
    SBK_QHELPSEARCHQUERY_FIELDNAME_IDX                       = 30,
    SBK_QHELPSEARCHQUERY_IDX                                 = 28,
    SBK_QHELPSEARCHQUERYWIDGET_IDX                           = 32,
    SBK_QHELPSEARCHRESULT_IDX                                = 34,
    SBK_QHELPSEARCHRESULTWIDGET_IDX                          = 36,
    SBK_QTHELP_IDX_COUNT                                     = 38,
};
...
enum : int {
    ...
    SBK_QHelpSearchQuery_FieldName_IDX                       = 15,
    SBK_QHelpSearchQuery_IDX                                 = 14,
    SBK_QHelpSearchQueryWidget_IDX                           = 16,
    SBK_QHelpSearchResult_IDX                                = 17,
    SBK_QHelpSearchResultWidget_IDX                          = 18,
    SBK_QtHelp_IDX_COUNT                                     = 19,
};
