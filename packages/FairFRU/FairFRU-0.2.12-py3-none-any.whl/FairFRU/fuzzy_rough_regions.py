...
def compute_membership_values(df, case_name, path, columns, method, alpha = 0.5, complete = False, hide_progress = False):
  '''
  ...
  method : either 'HMOM' or 'HEOM' as distance function
  '''
