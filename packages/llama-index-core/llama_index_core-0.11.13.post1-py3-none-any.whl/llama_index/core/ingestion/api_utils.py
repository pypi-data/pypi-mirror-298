...
def get_client(
    ...
    return LlamaCloud(base_url=base_url, token=api_key, timeout=timeout, httpx_client=httpx_client)
...
def get_aclient(
    ...
    return AsyncLlamaCloud(base_url=base_url, token=api_key, timeout=timeout, httpx_client=httpx_client)
