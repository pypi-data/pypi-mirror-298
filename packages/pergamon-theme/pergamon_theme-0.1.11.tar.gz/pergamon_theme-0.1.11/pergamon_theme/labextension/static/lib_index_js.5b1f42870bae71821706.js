...
const plugin = {
    ...
    activate: (app, manager) => {
        ...
        const observer = new MutationObserver((mutationsList, observer) => {
            ...
            if (splashElement) {
                splashElement.remove(); // O cualquier acción que quieras realizar
                observer.disconnect(); // Deja de observar una vez que lo eliminas
            }
        });
        // Observar el cuerpo del documento o algún contenedor específico
...
//# sourceMappingURL=lib_index_js.5b1f42870bae71821706.js.map