...
################################################################################################################################################################################
################################################################################################################################################################################
def Get_MarketWatch(save_excel = True, save_path = 'D:/sadra-TSE Data/MarketWatch'):
    #--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
################################################################################################################################################################################
################################################################################################################################################################################
def __Save_List__(df_data, bourse, farabourse, payeh, detailed_list, save_excel, save_csv, save_path = 'D:/sadra-TSE Data/'):
...
def Build_Market_StockList(bourse = True, farabourse = True, payeh = True, detailed_list = True, show_progress = True, \
                           save_excel = True, save_csv = True, save_path = 'D:/sadra-TSE Data/'):
...
def __build_price_panel_seg__(df_response, param, save_excel = True, save_path = 'D:/sadra-TSE Data/Price Panel/'):
...
def Build_PricePanel(stock_list, param = 'Adj Final', jalali_date = True, save_excel = True, save_path = 'D:/sadra-TSE Data/Price Panel/'):
...
def Get_60D_PriceHistory(stock_list, adjust_price = True, show_progress = True, save_excel = False, save_path = 'D:/sadra-TSE Data/MarketWatch'):
    # read stocks IDs from TSE webpages:
    def get_data_optimaize(codes):
        tracemalloc.start()
        @unsync
