...
class MetricCalculator:
    ...
    def calculate_annual_percentage_yield(self, num_trading_periods: float, final_cumulative_wealth: float) -> float:
        """
    ...
    def calculate_sharpe_ratio(self, daily_returns: np.ndarray, annual_percentage_yield: float) -> float:
        """
    ...
    def calculate_volatility_risk(self, daily_returns) -> float:
        """
    ...
    def calculate_maximum_drawdown(self, daily_cumulative_wealth) -> Tuple[np.ndarray, np.ndarray, float]:
        """
    ...
    def calculate_average_turnover(self, daily_turnovers) -> None:
        """
    ...
    def calculate_transaction_costs_wealth(self, portfolios, labels) -> Tuple[np.ndarray, pd.Series]:
        """
    ...
    def calculate_final_cumulative_wealth(self, portfolios: np.ndarray, labels: np.ndarray) -> Tuple[np.ndarray, np.ndarray, float]:
        """
    ...
    def calculate_portfolios(self) -> Tuple[np.ndarray, np.ndarray, float]:
        """
    ...
    def calculate_runtime(self, runtime: float) -> float:
        """
    ...
    def calculate_metric(self, portfolios=None, labels=None, runtime=None) -> Dict:
        """
