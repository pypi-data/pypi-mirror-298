...
class GRU(nn.Module):
    ...
    Example:
        ...
        >>> config["MODEL_PARAMS"]["GRU"]["NUM_LAYERS"] = 1
        >>> config["MODEL_PARAMS"]["GRU"]["HIDDEN_SIZE"] = 64
        >>> config["MODEL_PARAMS"]["GRU"]["DROPOUT"] = 0.1
    ...
    def __init__(self, model_args, model_params):
        ...
        self.gru = nn.GRU(input_size=model_args["num_features_original"], hidden_size=model_params["HIDDEN_SIZE"],
