...
class EDF:
    ...
    def _read_edf_header(self, convert=True):
        with open(self.edf_file_path, "r+", encoding="iso-8859-1") as f:
            ...
            item_names = [
                ...
                'header_bytes', 'reserved', 'n_records', 'duration', 'n_signals'
            ]
            ...
            item_names = [
                'label', 'transducer_type', 'physical_dimension', 'physical_min',
                'physical_max', 'digital_min', 'digital_max', 'prefiltering',
                'samples_per_record', 'ns_reserved'
            ]
    ...
    def _check_edf_plus(self):
        ...
        if header['label'][-1] == 'EDF Annotations':
            ...
            subsecond = subsecond_byte.decode('ascii')[1:] # convert to string, and ommit the first character '+'
            # print(offset)
    ...
    def _label_and_srate(self, header):
        ...
        self.data_signal_idx = [
            i for i in range(len(header['label']))
