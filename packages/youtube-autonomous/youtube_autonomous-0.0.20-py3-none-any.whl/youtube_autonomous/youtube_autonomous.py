    ...
    def validate_data(self, json_data: dict):
        ...
        for segment in segments:
            ...
            if not type or not SegmentType.is_valid(type):
                raise Exception(f'The "type" provided {type} is not valid.')
            ...
            try:
                ...
                #print(e)
                print_error('The "text" field can not have shortcodes.')
                exit()
            ...
            try:
                ...
                #print(e)
                print_error('Unregistered shortcodes found in "narration_text" field.')
                exit()
