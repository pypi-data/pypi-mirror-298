...
class ICD10CodeOrchestratorFHIR:
    ...
    def orchestrate_icd10_fhir(self, disease: str, consultation_summary: str, patient_summary: dict, patient_id: str) -> dict:
        ...
        suggestion_result = self.suggest_icd10_code(disease, consultation_summary, patient_summary)
