...
def open_data(name, mode='r', subdir=''):
    from pathlib import Path
    return (Path(__file__).parent.parent.parent / 'data' / subdir / name).open(mode=mode)


def open_js(name, mode='r', subdir='js'):
    return open_data(name=name, mode=mode, subdir=subdir)
