...
class ModelRestApi(BaseApi):
    ...
    """
    list_fetch_columns: List[str] = None
    """
    ...
    """
    show_fetch_columns: List[str] = None
    """
    ...
    def _init_properties(self) -> None:
        ...
        self.list_fetch_columns = self.list_fetch_columns or []
        self.list_fetch_columns = [
            getattr(self.datamodel.obj, x) for x in self.list_fetch_columns
        ]

        self.show_fetch_columns = self.show_fetch_columns or []
        self.show_fetch_columns = [
            getattr(self.datamodel.obj, x) for x in self.show_fetch_columns
        ]
    ...
    async def get_list_headless(
        ...
        for col in self.list_fetch_columns:
    ...
    async def get_headless(
        ...
        ### Note:
            If you are overriding this method, make sure to copy all the decorators too.
        """
        for col in self.show_fetch_columns:
            query._select_cols.append(col)
