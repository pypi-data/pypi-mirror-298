...
from TikTokLiveWrapper.events.base_event import BaseEvent
from TikTokLiveWrapper.events.proto_events import SocialEvent, ControlEvent
from TikTokLiveWrapper.proto import WebcastResponseMessage
...
class UnknownEvent(WebsocketResponseEvent):
    """
    Triggered when a Webcast message is received that is NOT tracked by TikTokLiveWrapper yet.
