...
class UpdateSynthesisSpecRequest(object):
    ...
    def __init__(self, description=None, concept_of_interest=None, generation_canvas=None, session_feedback=None, spec_state=None, local_vars_configuration=None):  # noqa: E501
