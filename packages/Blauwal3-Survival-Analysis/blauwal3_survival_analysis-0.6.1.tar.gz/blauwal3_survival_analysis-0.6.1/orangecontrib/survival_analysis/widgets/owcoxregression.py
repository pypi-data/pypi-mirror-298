...
def __(key):
    return i18n.t('survival_analysis.owcoxregression.' + key)
...
class OWCoxRegression(OWBaseLearner):
    ...
    REGULARIZATION_TYPES = [
        __('no_regularization'),
        __('ridge_regression_l2'),
        __('lasso_regression_l1'),
        __('elastic_net_regression'),
    ]
    ...
    def add_main_layout(self):
        ...
        box = gui.hBox(self.controlArea, __('regularization'))
        gui.radioButtons(
            box,
            self,
            'reg_type',
        ...
        gui.widgetLabel(box2, __('regularization_strength'))
        gui.hSlider(
            box2,
            self,
            'alpha_index',
        ...
        gui.widgetLabel(box4, __('elastic_net_mixing'))
        box5 = gui.hBox(box4)
