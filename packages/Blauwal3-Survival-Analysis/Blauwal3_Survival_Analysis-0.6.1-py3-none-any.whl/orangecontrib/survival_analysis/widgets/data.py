...
def __(key):
    return i18n.t('survival_analysis.data.' + key)


TIME_VAR: str = __("time_var")
EVENT_VAR: str = __('event_var')
TIME_TO_EVENT_VAR: str = __('time_to_event_var')

# Error/Warning messages related to survival data tables.
MISSING_ROWS: str = __('missing_rows')
MISSING_SURVIVAL_DATA: str = __('missing_survival_data')
