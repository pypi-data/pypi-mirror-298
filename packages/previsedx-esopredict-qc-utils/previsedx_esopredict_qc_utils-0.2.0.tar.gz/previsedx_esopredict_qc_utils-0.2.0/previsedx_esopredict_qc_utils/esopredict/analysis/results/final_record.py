...
class FinalRecord(BaseModel):
    ...
    actin_hpp1: Optional[float] = Field(
        None, description="The quantity of the Actin corresponding with the HPP1 gene"
    )

    hpp1: Optional[float] = Field(None, description="The quantity of the HPP1 gene")

    actin_p16: Optional[float] = Field(
        None, description="The quantity of the Actin corresponding with the P16 gene"
    )

    p16: Optional[float] = Field(None, description="The quantity of the P16 gene")

    actin_runx3: Optional[float] = Field(
        None, description="The quantity of the Actin corresponding with the RUNX3 gene"
    )

    runx3: Optional[float] = Field(None, description="The quantity of the RUNX3 gene")

    actin_fbn1: Optional[float] = Field(
        None, description="The quantity of the Actin corresponding with the FBN1 gene"
    )

    fbn1: Optional[float] = Field(None, description="The quantity of the FBN1 gene")
    ...
    normalized_prognostic_score: Optional[float] = Field(
        None, description="The normalized prognostic score (column AB)"
    )

    predicted_risk_category: Optional[str] = Field(
        None, description="The predicted risk category (column AC)"
    )

    five_year_progression_risk: Optional[float] = Field(
        None, description="The five year progression risk (column AD)"
    )

    five_year_progression_risk_ci_low: Optional[float] = Field(
        None, description="The five year progression risk CI low (column AE)"
    )

    five_year_progression_risk_ci_high: Optional[float] = Field(
        None, description="The five year progression risk CI high (column AF)"
    )

    # Add support to convert percentage strings to floats
    @validator("five_year_progression_risk", pre=True, always=True)
    ...
    @validator("five_year_progression_risk_ci_low", pre=True, always=True)
    ...
    @validator("five_year_progression_risk_ci_high", pre=True, always=True)
