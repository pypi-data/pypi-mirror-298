            ...
            for row in reader:
                ...
                try:
                    record = FinalRecord(
                        ...
                        normalized_prognostic_score=float(
                            row[
                                constants.INTERMEDIATE_FILE_NORMALIZED_PROGNOSTIC_SCORE_INDEX
                            ]
                        ),
                        predicted_risk_category=str(
                            row[
                                constants.INTERMEDIATE_FILE_PREDICTED_RISK_CATEGORY_INDEX
                            ]
                        ),
                        five_year_progress_risk_index=float(
                            row[constants.INTERMEDIATE_FILE_5_YR_PROGRESSION_RISK_INDEX]
                        ),
                        five_year_progression_risk_ci_low=float(
                            row[
                                constants.INTERMEDIATE_FILE_5_YR_PROGRESSION_RISK_CI_LOW_INDEX
                            ]
                        ),
                        five_year_progression_risk_ci_high=float(
                            row[
                                constants.INTERMEDIATE_FILE_5_YR_PROGRESSION_RISK_CI_HIGH_INDEX
                            ]
                        ),
                        age_at_biopsy=float(
