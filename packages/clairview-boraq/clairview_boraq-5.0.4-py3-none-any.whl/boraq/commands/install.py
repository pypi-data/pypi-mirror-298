...
from boraq.utils import run_playbook
...
@click.group(help="Install system dependencies for setting up Clairview environment")
def install():
	pass
...
@click.command(
	"prerequisites",
	help="Installs pre-requisite libraries, essential tools like b2zip, htop, screen, vim, x11-fonts, python libs, cups and Redis", # noqa
)
...
@click.command(
	"fail2ban",
	help="Install fail2ban, an intrusion prevention software framework that protects computer servers from brute-force attacks",	# noqa
)
@click.option(
	"--maxretry",
	default=6,
