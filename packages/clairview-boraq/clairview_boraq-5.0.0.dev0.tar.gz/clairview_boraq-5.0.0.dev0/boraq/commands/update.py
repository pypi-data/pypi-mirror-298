...
@click.command(
	"update",
	help="Performs an update operation on current boraq. Without any flags will backup, pull, setup requirements, build, run patches and restart boraq. Using specific flags will only do certain tasks instead of all",
)
