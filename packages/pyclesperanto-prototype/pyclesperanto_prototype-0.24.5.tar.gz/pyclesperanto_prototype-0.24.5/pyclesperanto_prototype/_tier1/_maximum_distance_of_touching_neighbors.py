...
def maximum_distance_of_touching_neighbors(distance_matrix : Image, touch_matrix: Image, distancelist_destination: Image = None) -> Image:
    ...
    execute(__file__, 'maximum_distance_of_touching_neighbors_x.cl',
            'maximum_distance_of_touching_neighbors', distancelist_destination.shape,
            parameters)
