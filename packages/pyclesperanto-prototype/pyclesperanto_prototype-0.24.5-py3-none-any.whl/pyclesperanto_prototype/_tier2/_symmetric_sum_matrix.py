...
@plugin_function
def symmetric_sum_matrix(source_matrix :Image, destination_matrix :Image = None) -> Image:
    ...
    destination_matrix = add_images_weighted(source_matrix, temp, destination_matrix, 1.0, 1.0)
