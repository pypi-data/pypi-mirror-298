...
def x_position_of_maximum_x_projection(source : Image, destination : Image = None) -> Image:
    ...
    execute(__file__, 'x_position_of_maximum_x_projection_x.cl', 'x_position_of_maximum_x_projection', destination.shape, parameters)
