...
function renderNotes(note, level = 0) {
    ...
    if (note.stub !== 1) {
        noteHtml += `
      <div class="replies">
        <div class="metadata-reply"><span class="user">${note.NickName}</span><span class="date">(Added: ${ukDate})</span></div>
...
//# sourceMappingURL=lib_index_js.b2e5a6ee4440cfa5d9d6.js.map