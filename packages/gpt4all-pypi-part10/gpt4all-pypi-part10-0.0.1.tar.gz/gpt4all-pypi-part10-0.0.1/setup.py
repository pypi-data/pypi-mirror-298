...
binary_files = package_files('src/gpt4all-pypi-part10/gpt4all')


setup(
    name='gpt4all-pypi-part10',  # Nom du package
    version='0.0.1',
    description='Package with binary files and subfolders',
    packages=find_packages(where='src'),
    package_dir={'': 'src'},
    package_data={
        'gpt4all-pypi-part10': binary_files,  # Inclut les fichiers binaires
    },
    include_package_data=True,
    install_requires=['gpt4all-pypi-part9',],
)