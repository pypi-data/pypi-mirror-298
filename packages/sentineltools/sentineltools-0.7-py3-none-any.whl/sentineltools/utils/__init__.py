...
def negex(pattern: str, string: str) -> bool:
    """
...
def parse_pattern(pattern: str) -> List[Tuple[str, Optional[str]]]:
    """
...
def match_pattern(pattern: str, string: str) -> Optional[List[Tuple[str, str, int, int]]]:
    """
