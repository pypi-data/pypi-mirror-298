...
from glidergun._types import CellSize, Extent, GridCore, Point, Scaler, TEstimator
...
class Grid(GridCore, Focal, Zonal):
    ...
    def fit(self, model: Union[TEstimator, EstimatorType], *explanatory_grids: "Grid", **kwargs: Any):
        from glidergun._estimator import GridEstimator
        ...
        return GridEstimator(actual_model).fit(self, *explanatory_grids, **kwargs)
