...
wiz_update_support_contact_list_tests: list[RuleTest] = [
    RuleTest(
        ...
        log={
            ...
            "actionParameters": {
                ...
                "selection": ["__typename", {"supportContactList": ["__typename", {"contacts": ["__typename", "id"]}]}],
            },
...
class WizUpdateSupportContactList(Rule):
    ...
    tests = wiz_update_support_contact_list_tests
