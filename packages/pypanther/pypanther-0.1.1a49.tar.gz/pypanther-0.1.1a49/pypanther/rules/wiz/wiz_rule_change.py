...
wiz_rule_change_tests: list[RuleTest] = [
    RuleTest(
        name="DeleteCloudConfigurationRule",
        expected_result=True,
        log={
            "action": "DeleteCloudConfigurationRule",
            "actionparameters": {"input": {"id": "12345-3fd7-4063-8e06-12345"}, "selection": ["__typename", "_stub"]},
...
class WizRuleChange(Rule):
    ...
    tests = wiz_rule_change_tests  # we have no sample log for such event, but I suppose there should be one
    SUSPICIOUS_ACTIONS = [
