...
class Annotator:
    ...
    def email_annotation_set_user(self, a, counts):
        ...
        message = f'Hi {a.get("user", {}).get("first_name")}, <br><br>\n' \
                  ...
                  f'{counts["media"]} media items were analysed, including {counts["points"]} points and ' \
                  f'{counts["annotations"]} annotations. {counts["new_points"]} points and {counts["new_annotations"]}' \
                  f'annotations were created / updated.<br><br>\nAny Label suggestions will appear as "Magical Suggestions" ' \
