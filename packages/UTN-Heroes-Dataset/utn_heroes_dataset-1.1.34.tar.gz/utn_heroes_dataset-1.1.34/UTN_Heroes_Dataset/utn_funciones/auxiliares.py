...
def colour_text(text: str, message_type: str = '') -> str:
    """
    The function `colour_text` takes a text input and a message type, and returns the text formatted
    with color based on the message type.
    
    :param text: The `text` parameter in the `colour_text` function is the string that you want to
    ...
    :type text: str
    :param message_type: The `message_type` parameter in the `colour_text` function is used to specify
