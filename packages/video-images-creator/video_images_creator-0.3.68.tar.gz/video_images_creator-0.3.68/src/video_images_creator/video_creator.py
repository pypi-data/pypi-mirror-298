...
def add_feature_frames_v2(current_running_index, temp_text_file, directory, feature_images_urls, feature_desciption, feature_speech_objs): 
    ...
    for feature_images_url in feature_images_urls:  
        ...
        if show_first_feature_anim == True:
            ...
            current_step_duration = current_step_duration + 6.0
            residual_time = 0
            if is_last_audio_in_step and current_step_duration > total_audio_duration_in_step:
                ...
                print("found residual for build_first_feature_animation", residual_time)
            ...
            current_step_duration = current_step_duration + 5.0
            residual_time = 0
            if is_last_audio_in_step and current_step_duration > total_audio_duration_in_step:
                residual_time = current_step_duration - total_audio_duration_in_step
                print("found residual for build_feature_switch_anim", residual_time)
            ...
            current_step_duration = current_step_duration + 4.0
            if is_last_audio_in_step and current_step_duration > total_audio_duration_in_step:
                residual_time = current_step_duration - total_audio_duration_in_step
                print("found residual for build_third_animation", residual_time)
