...
def plot_combined_graph(folder_dir_input, summary_plot_info_input):
    ...
    gaze_csv_dir = str(folder_dir_input).replace("trials", "gaze.csv")
    print(gaze_csv_dir)
...
def main():
    ...
    # parser.add_argument('--version', action='version', version='2.0.4'),
    ...
    # directory_input = r"C:\Users\zawli\Documents\GitHub\okntool\development\sweep_example\trials\trial-2_disk" \
    #                   r"-condition-1-1"
    directory_input = r"C:\Users\zawli\Documents\GitHub\okntool\development\example\trials"
    type_input = "summary"
    config_file_location = "_io.TextIOWrapper"
    config_location = None
