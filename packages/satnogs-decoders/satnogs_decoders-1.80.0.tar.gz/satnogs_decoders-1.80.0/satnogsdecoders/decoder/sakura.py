...
class Sakura(KaitaiStruct):
    ...
    :field batt_v: sakura.type_check.batt_v
    :field batt_i: sakura.type_check.batt_i
    :field batt_t: sakura.type_check.batt_t
    :field bpb_t: sakura.type_check.bpb_t
    :field raw_i: sakura.type_check.raw_i
    :field power_5v0: sakura.type_check.power_5v0
    :field pwr_ant_dep: sakura.type_check.pwr_ant_dep
    :field power_com: sakura.type_check.power_com
    :field sap_minus_x: sakura.type_check.sap_minus_x
    :field sap_plus_y: sakura.type_check.sap_plus_y
    :field sap_minus_y: sakura.type_check.sap_minus_y
    :field sap_plus_z: sakura.type_check.sap_plus_z
    :field sap_minus_z: sakura.type_check.sap_minus_z
    :field reserve_cmd_counter: sakura.type_check.reserve_cmd_counter
    :field gmsk_cmd_counter: sakura.type_check.gmsk_cmd_counter
    :field kill_sw: sakura.type_check.kill_sw
    :field kill_counter: sakura.type_check.kill_counter
    :field mission_pic_on_off: sakura.type_check.mission_pic_on_off
    :field mis_error_flag: sakura.type_check.mis_error_flag
    :field mis_end_flag: sakura.type_check.mis_end_flag
    :field aprs_flag: sakura.type_check.aprs_flag
    :field current_mis: sakura.type_check.current_mis
    ...
    class AutoGmskOrHk(KaitaiStruct):
        ...
        def check_2(self):
            if hasattr(self, '_m_check_2'):
                return self._m_check_2 if hasattr(self, '_m_check_2') else None
    ...
    class Cam(KaitaiStruct):
        ...
        def cam_packet_number(self):
            if hasattr(self, '_m_cam_packet_number'):
                return self._m_cam_packet_number if hasattr(self, '_m_cam_packet_number') else None
    ...
    class Cw(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.mission_pic_on_off = self._io.read_bits_int_be(1) != 0
            self.mis_error_flag = self._io.read_bits_int_be(1) != 0
            self.mis_end_flag = self._io.read_bits_int_be(1) != 0
            self.aprs_flag = self._io.read_bits_int_be(1) != 0
            self.current_mis = self._io.read_bits_int_be(2)

        @property
        def data_1_dec_value_5(self):
            if hasattr(self, '_m_data_1_dec_value_5'):
                return self._m_data_1_dec_value_5 if hasattr(self, '_m_data_1_dec_value_5') else None

            self._m_data_1_dec_value_5 = (8 if int(self.sap_plus_y) == 1 else 0)
            return self._m_data_1_dec_value_5 if hasattr(self, '_m_data_1_dec_value_5') else None

        @property
        def raw_i_hex_left_digit(self):
            if hasattr(self, '_m_raw_i_hex_left_digit'):
                return self._m_raw_i_hex_left_digit if hasattr(self, '_m_raw_i_hex_left_digit') else None
        ...
        def data_1_dec(self):
            if hasattr(self, '_m_data_1_dec'):
                return self._m_data_1_dec if hasattr(self, '_m_data_1_dec') else None
        ...
        def data_1_dec_value_4(self):
            if hasattr(self, '_m_data_1_dec_value_4'):
                return self._m_data_1_dec_value_4 if hasattr(self, '_m_data_1_dec_value_4') else None

            self._m_data_1_dec_value_4 = (16 if int(self.sap_minus_x) == 1 else 0)
            return self._m_data_1_dec_value_4 if hasattr(self, '_m_data_1_dec_value_4') else None

        @property
        def batt_t_hex(self):
            if hasattr(self, '_m_batt_t_hex'):
                return self._m_batt_t_hex if hasattr(self, '_m_batt_t_hex') else None
        ...
        def data_2_hex_left(self):
            if hasattr(self, '_m_data_2_hex_left'):
                return self._m_data_2_hex_left if hasattr(self, '_m_data_2_hex_left') else None
        ...
        def data_3_hex_right_digit(self):
            if hasattr(self, '_m_data_3_hex_right_digit'):
                return self._m_data_3_hex_right_digit if hasattr(self, '_m_data_3_hex_right_digit') else None
        ...
        def data_1_dec_value_6(self):
            if hasattr(self, '_m_data_1_dec_value_6'):
                return self._m_data_1_dec_value_6 if hasattr(self, '_m_data_1_dec_value_6') else None

            self._m_data_1_dec_value_6 = (4 if int(self.sap_minus_y) == 1 else 0)
            return self._m_data_1_dec_value_6 if hasattr(self, '_m_data_1_dec_value_6') else None

        @property
        def raw_i_hex(self):
            if hasattr(self, '_m_raw_i_hex'):
                return self._m_raw_i_hex if hasattr(self, '_m_raw_i_hex') else None
        ...
        def batt_i_hex(self):
            if hasattr(self, '_m_batt_i_hex'):
                return self._m_batt_i_hex if hasattr(self, '_m_batt_i_hex') else None
        ...
        def data_1_hex_left(self):
            if hasattr(self, '_m_data_1_hex_left'):
                return self._m_data_1_hex_left if hasattr(self, '_m_data_1_hex_left') else None
        ...
        def data_1_dec_value_7(self):
            if hasattr(self, '_m_data_1_dec_value_7'):
                return self._m_data_1_dec_value_7 if hasattr(self, '_m_data_1_dec_value_7') else None

            self._m_data_1_dec_value_7 = (2 if int(self.sap_plus_z) == 1 else 0)
            return self._m_data_1_dec_value_7 if hasattr(self, '_m_data_1_dec_value_7') else None

        @property
        def data_3_hex(self):
            if hasattr(self, '_m_data_3_hex'):
                return self._m_data_3_hex if hasattr(self, '_m_data_3_hex') else None
        ...
        def data_2_dec(self):
            if hasattr(self, '_m_data_2_dec'):
                return self._m_data_2_dec if hasattr(self, '_m_data_2_dec') else None
        ...
        def data_1_hex_left_digit(self):
            if hasattr(self, '_m_data_1_hex_left_digit'):
                return self._m_data_1_hex_left_digit if hasattr(self, '_m_data_1_hex_left_digit') else None
        ...
        def data_2_dec_value_2(self):
            if hasattr(self, '_m_data_2_dec_value_2'):
                return self._m_data_2_dec_value_2 if hasattr(self, '_m_data_2_dec_value_2') else None

            self._m_data_2_dec_value_2 = (self.gmsk_cmd_counter * 2)
            return self._m_data_2_dec_value_2 if hasattr(self, '_m_data_2_dec_value_2') else None

        @property
        def data_3_hex_right(self):
            if hasattr(self, '_m_data_3_hex_right'):
                return self._m_data_3_hex_right if hasattr(self, '_m_data_3_hex_right') else None
        ...
        def bpb_t_hex_right_digit(self):
            if hasattr(self, '_m_bpb_t_hex_right_digit'):
                return self._m_bpb_t_hex_right_digit if hasattr(self, '_m_bpb_t_hex_right_digit') else None
        ...
        def batt_t_hex_left_digit(self):
            if hasattr(self, '_m_batt_t_hex_left_digit'):
                return self._m_batt_t_hex_left_digit if hasattr(self, '_m_batt_t_hex_left_digit') else None
        ...
        def data_2_dec_value_1(self):
            if hasattr(self, '_m_data_2_dec_value_1'):
                return self._m_data_2_dec_value_1 if hasattr(self, '_m_data_2_dec_value_1') else None

            self._m_data_2_dec_value_1 = (self.reserve_cmd_counter * 16)
            return self._m_data_2_dec_value_1 if hasattr(self, '_m_data_2_dec_value_1') else None

        @property
        def data_3_dec_value_3(self):
            if hasattr(self, '_m_data_3_dec_value_3'):
                return self._m_data_3_dec_value_3 if hasattr(self, '_m_data_3_dec_value_3') else None

            self._m_data_3_dec_value_3 = (16 if int(self.mis_error_flag) == 1 else 0)
            return self._m_data_3_dec_value_3 if hasattr(self, '_m_data_3_dec_value_3') else None

        @property
        def data_1_dec_value_1(self):
            if hasattr(self, '_m_data_1_dec_value_1'):
                return self._m_data_1_dec_value_1 if hasattr(self, '_m_data_1_dec_value_1') else None

            self._m_data_1_dec_value_1 = (128 if int(self.power_5v0) == 1 else 0)
            return self._m_data_1_dec_value_1 if hasattr(self, '_m_data_1_dec_value_1') else None

        @property
        def data_3_dec_value_6(self):
            if hasattr(self, '_m_data_3_dec_value_6'):
                return self._m_data_3_dec_value_6 if hasattr(self, '_m_data_3_dec_value_6') else None

            self._m_data_3_dec_value_6 = self.current_mis
            return self._m_data_3_dec_value_6 if hasattr(self, '_m_data_3_dec_value_6') else None

        @property
        def batt_i_hex_right_digit(self):
            if hasattr(self, '_m_batt_i_hex_right_digit'):
                return self._m_batt_i_hex_right_digit if hasattr(self, '_m_batt_i_hex_right_digit') else None
        ...
        def data_3_dec_value_4(self):
            if hasattr(self, '_m_data_3_dec_value_4'):
                return self._m_data_3_dec_value_4 if hasattr(self, '_m_data_3_dec_value_4') else None

            self._m_data_3_dec_value_4 = (8 if int(self.mis_end_flag) == 1 else 0)
            return self._m_data_3_dec_value_4 if hasattr(self, '_m_data_3_dec_value_4') else None

        @property
        def batt_v_hex_left_digit(self):
            if hasattr(self, '_m_batt_v_hex_left_digit'):
                return self._m_batt_v_hex_left_digit if hasattr(self, '_m_batt_v_hex_left_digit') else None
        ...
        def data_2_hex_right(self):
            if hasattr(self, '_m_data_2_hex_right'):
                return self._m_data_2_hex_right if hasattr(self, '_m_data_2_hex_right') else None
        ...
        def data_3_dec_value_1(self):
            if hasattr(self, '_m_data_3_dec_value_1'):
                return self._m_data_3_dec_value_1 if hasattr(self, '_m_data_3_dec_value_1') else None

            self._m_data_3_dec_value_1 = (self.kill_counter * 64)
            return self._m_data_3_dec_value_1 if hasattr(self, '_m_data_3_dec_value_1') else None

        @property
        def batt_t_hex_right(self):
            if hasattr(self, '_m_batt_t_hex_right'):
                return self._m_batt_t_hex_right if hasattr(self, '_m_batt_t_hex_right') else None

            self._m_batt_t_hex_right = (self.batt_t % 16)
            return self._m_batt_t_hex_right if hasattr(self, '_m_batt_t_hex_right') else None

        @property
        def data_1_dec_value_2(self):
            if hasattr(self, '_m_data_1_dec_value_2'):
                return self._m_data_1_dec_value_2 if hasattr(self, '_m_data_1_dec_value_2') else None

            self._m_data_1_dec_value_2 = (64 if int(self.pwr_ant_dep) == 1 else 0)
            return self._m_data_1_dec_value_2 if hasattr(self, '_m_data_1_dec_value_2') else None

        @property
        def data_3_dec_value_2(self):
            if hasattr(self, '_m_data_3_dec_value_2'):
                return self._m_data_3_dec_value_2 if hasattr(self, '_m_data_3_dec_value_2') else None

            self._m_data_3_dec_value_2 = (32 if int(self.mission_pic_on_off) == 1 else 0)
            return self._m_data_3_dec_value_2 if hasattr(self, '_m_data_3_dec_value_2') else None

        @property
        def data_2_hex_left_digit(self):
            if hasattr(self, '_m_data_2_hex_left_digit'):
                return self._m_data_2_hex_left_digit if hasattr(self, '_m_data_2_hex_left_digit') else None
        ...
        def batt_i_hex_left_digit(self):
            if hasattr(self, '_m_batt_i_hex_left_digit'):
                return self._m_batt_i_hex_left_digit if hasattr(self, '_m_batt_i_hex_left_digit') else None
        ...
        def data_2_hex_right_digit(self):
            if hasattr(self, '_m_data_2_hex_right_digit'):
                return self._m_data_2_hex_right_digit if hasattr(self, '_m_data_2_hex_right_digit') else None
        ...
        def batt_v_hex_right_digit(self):
            if hasattr(self, '_m_batt_v_hex_right_digit'):
                return self._m_batt_v_hex_right_digit if hasattr(self, '_m_batt_v_hex_right_digit') else None
        ...
        def batt_t_hex_left(self):
            if hasattr(self, '_m_batt_t_hex_left'):
                return self._m_batt_t_hex_left if hasattr(self, '_m_batt_t_hex_left') else None

            self._m_batt_t_hex_left = self.batt_t // 16
            return self._m_batt_t_hex_left if hasattr(self, '_m_batt_t_hex_left') else None

        @property
        def raw_i_hex_left(self):
            if hasattr(self, '_m_raw_i_hex_left'):
                return self._m_raw_i_hex_left if hasattr(self, '_m_raw_i_hex_left') else None

            self._m_raw_i_hex_left = self.raw_i // 16
            return self._m_raw_i_hex_left if hasattr(self, '_m_raw_i_hex_left') else None

        @property
        def bpb_t_hex_right(self):
            if hasattr(self, '_m_bpb_t_hex_right'):
                return self._m_bpb_t_hex_right if hasattr(self, '_m_bpb_t_hex_right') else None

            self._m_bpb_t_hex_right = (self.bpb_t % 16)
            return self._m_bpb_t_hex_right if hasattr(self, '_m_bpb_t_hex_right') else None

        @property
        def data_3_hex_left(self):
            if hasattr(self, '_m_data_3_hex_left'):
                return self._m_data_3_hex_left if hasattr(self, '_m_data_3_hex_left') else None
        ...
        def bpb_t_hex_left_digit(self):
            if hasattr(self, '_m_bpb_t_hex_left_digit'):
                return self._m_bpb_t_hex_left_digit if hasattr(self, '_m_bpb_t_hex_left_digit') else None
        ...
        def bpb_t_hex_left(self):
            if hasattr(self, '_m_bpb_t_hex_left'):
                return self._m_bpb_t_hex_left if hasattr(self, '_m_bpb_t_hex_left') else None

            self._m_bpb_t_hex_left = self.bpb_t // 16
            return self._m_bpb_t_hex_left if hasattr(self, '_m_bpb_t_hex_left') else None
        ...
        def data_3_hex_left_digit(self):
            if hasattr(self, '_m_data_3_hex_left_digit'):
                return self._m_data_3_hex_left_digit if hasattr(self, '_m_data_3_hex_left_digit') else None
        ...
        def data_3_dec(self):
            if hasattr(self, '_m_data_3_dec'):
                return self._m_data_3_dec if hasattr(self, '_m_data_3_dec') else None
        ...
        def batt_t_hex_right_digit(self):
            if hasattr(self, '_m_batt_t_hex_right_digit'):
                return self._m_batt_t_hex_right_digit if hasattr(self, '_m_batt_t_hex_right_digit') else None
        ...
        def data_1_dec_value_3(self):
            if hasattr(self, '_m_data_1_dec_value_3'):
                return self._m_data_1_dec_value_3 if hasattr(self, '_m_data_1_dec_value_3') else None

            self._m_data_1_dec_value_3 = (32 if int(self.power_com) == 1 else 0)
            return self._m_data_1_dec_value_3 if hasattr(self, '_m_data_1_dec_value_3') else None

        @property
        def data_2_hex(self):
            if hasattr(self, '_m_data_2_hex'):
                return self._m_data_2_hex if hasattr(self, '_m_data_2_hex') else None
        ...
        def batt_i_hex_right(self):
            if hasattr(self, '_m_batt_i_hex_right'):
                return self._m_batt_i_hex_right if hasattr(self, '_m_batt_i_hex_right') else None

            self._m_batt_i_hex_right = (self.batt_i % 16)
            return self._m_batt_i_hex_right if hasattr(self, '_m_batt_i_hex_right') else None

        @property
        def raw_i_hex_right(self):
            if hasattr(self, '_m_raw_i_hex_right'):
                return self._m_raw_i_hex_right if hasattr(self, '_m_raw_i_hex_right') else None

            self._m_raw_i_hex_right = (self.raw_i % 16)
            return self._m_raw_i_hex_right if hasattr(self, '_m_raw_i_hex_right') else None

        @property
        def data_1_dec_value_8(self):
            if hasattr(self, '_m_data_1_dec_value_8'):
                return self._m_data_1_dec_value_8 if hasattr(self, '_m_data_1_dec_value_8') else None

            self._m_data_1_dec_value_8 = (1 if int(self.sap_minus_z) == 1 else 0)
            return self._m_data_1_dec_value_8 if hasattr(self, '_m_data_1_dec_value_8') else None

        @property
        def raw_i_hex_right_digit(self):
            if hasattr(self, '_m_raw_i_hex_right_digit'):
                return self._m_raw_i_hex_right_digit if hasattr(self, '_m_raw_i_hex_right_digit') else None
        ...
        def data_1_hex(self):
            if hasattr(self, '_m_data_1_hex'):
                return self._m_data_1_hex if hasattr(self, '_m_data_1_hex') else None
        ...
        def batt_v_hex_left(self):
            if hasattr(self, '_m_batt_v_hex_left'):
                return self._m_batt_v_hex_left if hasattr(self, '_m_batt_v_hex_left') else None

            self._m_batt_v_hex_left = self.batt_v // 16
            return self._m_batt_v_hex_left if hasattr(self, '_m_batt_v_hex_left') else None

        @property
        def bpb_t_hex(self):
            if hasattr(self, '_m_bpb_t_hex'):
                return self._m_bpb_t_hex if hasattr(self, '_m_bpb_t_hex') else None
        ...
        def batt_v_hex_right(self):
            if hasattr(self, '_m_batt_v_hex_right'):
                return self._m_batt_v_hex_right if hasattr(self, '_m_batt_v_hex_right') else None

            self._m_batt_v_hex_right = (self.batt_v % 16)
            return self._m_batt_v_hex_right if hasattr(self, '_m_batt_v_hex_right') else None

        @property
        def data_2_dec_value_3(self):
            if hasattr(self, '_m_data_2_dec_value_3'):
                return self._m_data_2_dec_value_3 if hasattr(self, '_m_data_2_dec_value_3') else None

            self._m_data_2_dec_value_3 = (1 if int(self.kill_sw) == 1 else 0)
            return self._m_data_2_dec_value_3 if hasattr(self, '_m_data_2_dec_value_3') else None

        @property
        def batt_v_hex(self):
            if hasattr(self, '_m_batt_v_hex'):
                return self._m_batt_v_hex if hasattr(self, '_m_batt_v_hex') else None
        ...
        def batt_i_hex_left(self):
            if hasattr(self, '_m_batt_i_hex_left'):
                return self._m_batt_i_hex_left if hasattr(self, '_m_batt_i_hex_left') else None

            self._m_batt_i_hex_left = self.batt_i // 16
            return self._m_batt_i_hex_left if hasattr(self, '_m_batt_i_hex_left') else None

        @property
        def data_1_hex_right_digit(self):
            if hasattr(self, '_m_data_1_hex_right_digit'):
                return self._m_data_1_hex_right_digit if hasattr(self, '_m_data_1_hex_right_digit') else None
        ...
        def data_1_hex_right(self):
            if hasattr(self, '_m_data_1_hex_right'):
                return self._m_data_1_hex_right if hasattr(self, '_m_data_1_hex_right') else None
        ...
        def data_3_dec_value_5(self):
            if hasattr(self, '_m_data_3_dec_value_5'):
                return self._m_data_3_dec_value_5 if hasattr(self, '_m_data_3_dec_value_5') else None

            self._m_data_3_dec_value_5 = (4 if int(self.aprs_flag) == 1 else 0)
            return self._m_data_3_dec_value_5 if hasattr(self, '_m_data_3_dec_value_5') else None
    ...
    class DigitalBeacon(KaitaiStruct):
        ...
        def check_1(self):
            if hasattr(self, '_m_check_1'):
                return self._m_check_1 if hasattr(self, '_m_check_1') else None
