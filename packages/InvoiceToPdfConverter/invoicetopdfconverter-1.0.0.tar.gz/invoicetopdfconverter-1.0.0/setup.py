...
setup(
  name = 'InvoiceToPdfConverter',         #* Your package will have this name
  packages = ['invoicingMain'],   #* Name the package again
  ...
  author = 'Luchintha Anjana Morawakage',                   # Your name
  author_email = 'luchinthaa@gmail.com',  # Your email
