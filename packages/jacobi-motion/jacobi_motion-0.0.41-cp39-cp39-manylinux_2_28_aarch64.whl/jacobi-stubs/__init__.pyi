...
from . import robots
__all__ = ['ArbitraryPath', 'BimanualMotion', 'BlendedPath', 'Box', 'Camera', 'CameraStream', 'Capsule', 'CartesianRegion', 'CartesianRegionBound', 'CartesianWaypoint', 'CircularPath', 'Color', 'Convex', 'Cylinder', 'Depth', 'DepthMap', 'Element', 'Environment', 'FileReference', 'Frame', 'Intrinsics', 'JacobiError', 'LinearMotion', 'LinearPath', 'LinearSection', 'LowLevelMotion', 'Motion', 'MultiRobotLinearSection', 'MultiRobotPoint', 'Obstacle', 'PathCommand', 'PathFollowingMotion', 'PathType', 'Planner', 'PlanningError', 'Region', 'ReturnCode', 'Robot', 'RobotArm', 'Sampler', 'Sphere', 'State', 'Studio', 'Trainer', 'Trajectory', 'Twist', 'Waypoint', 'activate_license', 'drivers', 'exceptions', 'robots', 'start_studio_daemon', 'start_telemetry_daemon']
...
class BimanualMotion:
    ...
    def soft_collision_goal(self) -> bool:
        ...
        item obstacle of both arms is allowed to be in collision at the goal
    ...
    def soft_collision_start(self) -> bool:
        ...
        item obstacle of both arms is allowed to be in collision at the start
...
class PathCommand:
    class SegmentCommand:
        ...
        goal: list[float]
        max_velocity: float
    segments: list[PathCommand.SegmentCommand]
    start: list[float]
    @staticmethod
...
class Planner:
    ...
    def plan(self, motion: PathFollowingMotion) -> Trajectory | None:
        ...
        """
    @typing.overload
    def plan(self, motion: BimanualMotion) -> Trajectory | None:
        """
        ...
        """
    @typing.overload
    def plan(self, motions: list[BimanualMotion | LinearMotion | LowLevelMotion | Motion | PathFollowingMotion]) -> list[Trajectory] | None:
        """
...
class PlanningError(ReturnCode):
    ...
    """
    PathNotFound: typing.ClassVar[PlanningError]  # value = [-100] No path could be found - is a collision-free path between start and goal possible?
    Success: typing.ClassVar[PlanningError]  # value = [1] Success
    Unknown: typing.ClassVar[PlanningError]  # value = [-1] Unknown error
