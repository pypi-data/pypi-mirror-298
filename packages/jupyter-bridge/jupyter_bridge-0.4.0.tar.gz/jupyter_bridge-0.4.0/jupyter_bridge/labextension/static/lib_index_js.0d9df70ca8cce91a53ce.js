            ...
            execute: () => {
                ...
                if (activeCellIndex > 0) {
                    ...
                    if (precedingCell.model.type === 'markdown') {
                        ...
                        if (isExplanatory) {
                            if (cellNode.classList.contains('hidden')) {
                                // If explanatory cell is hidden, show it and reduce the code cell width
                                cellNode.classList.remove('hidden');
                                codeCell.node.classList.remove('full-width');
                                codeCell.node.classList.add('ct-code-cell'); // Make sure it has the 50% width class
                            }
                            else {
                                // If explanatory cell is visible, hide it and make the code cell full-width
                                cellNode.classList.add('hidden');
                                codeCell.node.classList.add('full-width');
                                codeCell.node.classList.remove('ct-code-cell'); // Remove the 50% width class
                            }
                        }
                    }
                }
...
//# sourceMappingURL=lib_index_js.0d9df70ca8cce91a53ce.js.map