                    ...
                    if (precedingCell.model.type === 'markdown') {
                        ...
                        if (isExplanatory) {
                            ...
                            if (cellNode.classList.contains(CSS_CLASSES.HIDDEN_CELL)) {
                                // If it already has the hidden class, remove it to show the cell
                                cellNode.classList.remove(CSS_CLASSES.HIDDEN_CELL);
                            }
                            else {
                                // If it doesn't have the hidden class, add it to hide the cell
...
//# sourceMappingURL=lib_index_js.7fef3dbace5e8b21be47.js.map