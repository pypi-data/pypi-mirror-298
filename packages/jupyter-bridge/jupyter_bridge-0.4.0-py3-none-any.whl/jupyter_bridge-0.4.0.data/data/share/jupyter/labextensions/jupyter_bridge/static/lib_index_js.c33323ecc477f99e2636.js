...
const CSS_CLASSES = {
    ...
    EXPLANATORY_CELL: 'ct-explanatory-cell',
    HIDDEN_CELL: 'ct-hidden-cell', // Add class for hidden state
};
        ...
        commands.addCommand(COMMANDS.TOGGLE_EXPL_CELL, {
            ...
            execute: () => {
                ...
                if (activeCellIndex > 0) { // Ensure there is a preceding cell
                    ...
                    const activeCell = cells[activeCellIndex]; // Get the current active cell
                    if (precedingCell.model.type === 'markdown') {
                        const isExplanatory = precedingCell.model.getMetadata('explanatory') === true;
                        const explNode = precedingCell.node; // Get DOM node for explanatory cell
                        const codeNode = activeCell.node; // Get DOM node for the active code cell
                        // Ensure parent container to avoid overflow
                        let container = explNode.closest('.cell-container');
                        if (!container) {
                            container = document.createElement('div');
                            container.classList.add('cell-container');
                            (_a = explNode.parentElement) === null || _a === void 0 ? void 0 : _a.insertBefore(container, explNode);
                            container.appendChild(explNode);
                            container.appendChild(codeNode);
                        }
                        // If explanatory, toggle visibility and update classes
                        if (isExplanatory) {
                            if (explNode.classList.contains('hidden') || explNode.classList.contains(CSS_CLASSES.HIDDEN_CELL)) {
                                explNode.classList.remove('hidden', CSS_CLASSES.HIDDEN_CELL);
                                explNode.classList.add('ct-explanatory-cell');
                                codeNode.classList.add('ct-code-cell'); // Add class to code cell
                                codeNode.classList.remove('full-width-cell');
                                // Add pair wrapper for alignment, with a null check for parentElement
                                if (explNode.parentElement) {
                                    explNode.parentElement.classList.add('expl-code-pair');
                                }
                            }
                            else {
                                explNode.classList.add(CSS_CLASSES.HIDDEN_CELL); // Hide explanatory
                                codeNode.classList.remove('ct-code-cell'); // Make code cell full width
                                codeNode.classList.add('full-width-cell');
                                // Remove pair wrapper, with a null check for parentElement
                                if (explNode.parentElement) {
                                    explNode.parentElement.classList.remove('expl-code-pair');
                                }
                            }
                        }
                    }
...
/* Flex container for code and explanatory cell pairing */
.expl-code-pair {
    display: flex;
...
.ct-explanatory-cell {
    ...
    background-color: #fdf2e9; /* Soft peach color for background */
    border: 2px solid #e67e22; /* Orange border for distinction */
    border-radius: 10px;
    padding: 20px;
    margin: 20px;
...
/* Code cells paired with explanatory cells */
.ct-code-cell {
    width: 48%;
}

/* Full-width code cells when no explanatory counterpart is present */
.full-width-cell {
    width: 100%;
}

/* Ensure that markdown and regular cells take up the full width */
.jp-Cell:not(.ct-code-cell):not(.ct-explanatory-cell) {
    width: 100%;
}

/* Cell container to prevent overflow */
.cell-container {
    width: 100%;
    display: block;
    overflow: hidden; /* Prevent cells from overflowing the screen */
}

/* Typography and styling for explanatory content */
.ct-explanatory-cell h2 {
    color: #d35400;
    text-align: center;
    font-size: 26px;
    margin-bottom: 20px;
...
.ct-explanatory-cell p {
    font-size: 18px;
    line-height: 1.8;
    color: #2c3e50;
}

.ct-explanatory-cell ul {
    list-style-type: none;
    padding: 0;
}

.ct-explanatory-cell li {
...
/* Hidden class for explanatory cells when toggled */
.ct-hidden-cell {
    display: none;
}

/* Hide default Jupyter input/output collapsers */
.lm-Widget.jp-Collapser.jp-InputCollapser.jp-Cell-inputCollapser,
.lm-Widget.jp-Collapser.jp-OutputCollapser.jp-Cell-outputCollapser {
    display: none !important;
}

/* Input prompt styling (optional, empty in this case) */
.lm-Widget.jp-InputPrompt.jp-InputArea-prompt {
    /* Optional customizations */
}
`, "",{"version":3,"sources":["webpack://./style/index.css"],"names":[],"mappings":"AAEA;IACI,aAAa;IACb,mBAAmB,EAAE,gCAAgC;IACrD,2BAA2B,EAAE,4BAA4B;IACzD,mBAAmB,EAAE,iCAAiC;AAC1D;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,gBAAgB;IAChB,yBAAyB;IACzB,YAAY;IACZ,gBAAgB;IAChB,gBAAgB;IAChB,4CAA4C;IAC5C,aAAa;IACb,eAAe;IACf,iBAAiB;IACjB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;;IAEI,aAAa;AACjB;;AAEA,6CAA6C;AAC7C;;;IAGI,uBAAuB;IACvB,+BAA+B;AACnC;;AAEA,iCAAiC;AACjC;IACI,mBAAmB;AACvB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,oCAAoC;IACpC,2CAA2C;AAC/C;;AAEA;IACI,oCAAoC;IACpC,UAAU;IACV,2CAA2C;IAC3C,kCAAkC;AACtC;;AAEA;IACI,8BAA8B;AAClC;;AAEA,yDAAyD;AACzD;IACI,aAAa;IACb,iBAAiB,EAAE,8BAA8B;IACjD,WAAW;IACX,8BAA8B;AAClC;;AAEA,sBAAsB;AACtB;IACI,UAAU;IACV,WAAW,EAAE,uBAAuB;IACpC,yBAAyB,EAAE,oCAAoC;IAC/D,yBAAyB,EAAE,kCAAkC;IAC7D,mBAAmB;IACnB,aAAa;IACb,YAAY;IACZ,wCAAwC;IACxC,mDAAmD;AACvD;;AAEA,6CAA6C;AAC7C;IACI,UAAU;AACd;;AAEA,qEAAqE;AACrE;IACI,WAAW;AACf;;AAEA,kEAAkE;AAClE;IACI,WAAW;AACf;;AAEA,uCAAuC;AACvC;IACI,WAAW;IACX,cAAc;IACd,gBAAgB,EAAE,8CAA8C;AACpE;;AAEA,mDAAmD;AACnD;IACI,cAAc;IACd,kBAAkB;IAClB,eAAe;IACf,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,gBAAgB;IAChB,cAAc;AAClB;;AAEA;IACI,qBAAqB;IACrB,UAAU;AACd;;AAEA;IACI,yBAAyB;IACzB,cAAc;IACd,aAAa;IACb,kBAAkB;IAClB,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,yBAAyB;IACzB,YAAY;IACZ,kBAAkB;IAClB,cAAc;IACd,iBAAiB;AACrB;;AAEA,oDAAoD;AACpD;IACI,aAAa;AACjB;;AAEA,iDAAiD;AACjD;;IAEI,wBAAwB;AAC5B;;AAEA,wDAAwD;AACxD;IACI,4BAA4B;AAChC","sourcesContent":["@import url('base.css');\n\n.jp-Cell .ct-cellFooterContainer {\n    display: flex;\n    flex-direction: row; /* Ensure horizontal alignment */\n    justify-content: flex-start; /* Move button to the left */\n    align-items: center; /* Vertically center the button */\n}\n\n.jp-Cell .ct-cellFooterBtn {\n    color: #fff;\n    opacity: 0.7;\n    font-size: 0.65rem;\n    font-weight: 500;\n    text-transform: uppercase;\n    border: none;\n    padding: 4px 8px;\n    margin: 0.2rem 0;\n    text-shadow: 0px 0px 5px rgba(0, 0, 0, 0.15);\n    outline: none;\n    cursor: pointer;\n    user-select: none;  \n    margin-left: 0px;\n    margin-right: 4px;\n}\n\n.jp-Placeholder-content .jp-PlaceholderText,\n.jp-Placeholder-content .jp-MoreHorizIcon {\n    display: none;\n}\n\n/* Disable default cell collapsing behavior */\n.jp-InputCollapser,\n.jp-OutputCollapser,\n.jp-Placeholder {\n    cursor: auto !important;\n    pointer-events: none !important;\n}\n\n/* Add styles for toggle button */\n.jp-Cell .ct-toggleBtn{\n    background: #f0f0f0;\n}\n\n.jp-Cell .ct-toggleBtn:hover{\n    background-color: #ccc;\n}\n\n.jp-Cell .ct-toggleBtn:active{\n    background-color: #999;\n}\n\n.ct-cellFooterBtn:active {\n    background-color: var(--md-blue-600);\n    text-shadow: 0px 0px 4px rgba(0, 0, 0, 0.4);\n}\n\n.jp-Cell .ct-cellFooterBtn:hover {\n    background-color: var(--md-blue-500);\n    opacity: 1;\n    text-shadow: 0px 0px 7px rgba(0, 0, 0, 0.3);\n    box-shadow: var(--jp-elevation-z2);\n}\n\n.jp-Cell .ct-cellFooterBtn {\n    background: var(--md-blue-400);\n}\n\n/* Flex container for code and explanatory cell pairing */\n.expl-code-pair {\n    display: flex;\n    flex-wrap: nowrap; /* Ensure no wrapping occurs */\n    width: 100%;\n    justify-content: space-between;\n}\n\n/* Explanatory cells */\n.ct-explanatory-cell {\n    width: 48%;\n    float: none; /* Ensure no floating */\n    background-color: #fdf2e9; /* Soft peach color for background */\n    border: 2px solid #e67e22; /* Orange border for distinction */\n    border-radius: 10px;\n    padding: 20px;\n    margin: 20px;\n    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n    font-family: 'Segoe UI', Tahoma, Geneva, sans-serif;\n}\n\n/* Code cells paired with explanatory cells */\n.ct-code-cell {\n    width: 48%;\n}\n\n/* Full-width code cells when no explanatory counterpart is present */\n.full-width-cell {\n    width: 100%;\n}\n\n/* Ensure that markdown and regular cells take up the full width */\n.jp-Cell:not(.ct-code-cell):not(.ct-explanatory-cell) {\n    width: 100%;\n}\n\n/* Cell container to prevent overflow */\n.cell-container {\n    width: 100%;\n    display: block;\n    overflow: hidden; /* Prevent cells from overflowing the screen */\n}\n\n/* Typography and styling for explanatory content */\n.ct-explanatory-cell h2 {\n    color: #d35400;\n    text-align: center;\n    font-size: 26px;\n    margin-bottom: 20px;\n}\n\n.ct-explanatory-cell p {\n    font-size: 18px;\n    line-height: 1.8;\n    color: #2c3e50;\n}\n\n.ct-explanatory-cell ul {\n    list-style-type: none;\n    padding: 0;\n}\n\n.ct-explanatory-cell li {\n    background-color: #f39c12;\n    margin: 10px 0;\n    padding: 10px;\n    border-radius: 8px;\n    font-size: 17px;\n    color: white;\n}\n\n.ct-explanatory-cell code {\n    background-color: #ffe6cc;\n    padding: 5px;\n    border-radius: 5px;\n    color: #d35400;\n    font-weight: bold;\n}\n\n/* Hidden class for explanatory cells when toggled */\n.ct-hidden-cell {\n    display: none;\n}\n\n/* Hide default Jupyter input/output collapsers */\n.lm-Widget.jp-Collapser.jp-InputCollapser.jp-Cell-inputCollapser,\n.lm-Widget.jp-Collapser.jp-OutputCollapser.jp-Cell-outputCollapser {\n    display: none !important;\n}\n\n/* Input prompt styling (optional, empty in this case) */\n.lm-Widget.jp-InputPrompt.jp-InputArea-prompt {\n    /* Optional customizations */\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
//# sourceMappingURL=lib_index_js.c33323ecc477f99e2636.js.map