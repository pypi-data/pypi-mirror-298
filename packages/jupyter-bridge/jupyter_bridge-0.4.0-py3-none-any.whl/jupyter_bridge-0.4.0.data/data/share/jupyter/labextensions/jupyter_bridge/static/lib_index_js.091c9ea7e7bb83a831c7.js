            ...
            execute: () => {
                ...
                if (activeCellIndex > 0) { // Ensure there is a preceding cell
                    ...
                    if (precedingCell.model.type === 'markdown') {
                        ...
                        if (isExplanatory) {
                            // Toggle the ct-hidden-cell class to hide or show the cell
                            if (!precedingCell.hasClass(CSS_CLASSES.HIDDEN_CELL)) {
                                precedingCell.addClass(CSS_CLASSES.HIDDEN_CELL);
                            }
                            else {
                                precedingCell.removeClass(CSS_CLASSES.HIDDEN_CELL);
                            }
                        }
                    }
                }
...
//# sourceMappingURL=lib_index_js.091c9ea7e7bb83a831c7.js.map