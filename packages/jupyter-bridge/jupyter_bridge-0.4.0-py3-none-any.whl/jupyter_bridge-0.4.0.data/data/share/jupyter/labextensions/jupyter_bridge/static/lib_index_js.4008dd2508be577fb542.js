        ...
        commands.addCommand(COMMANDS.TOGGLE_EXPL_CELL, {
            ...
            execute: () => {
                ...
                if (activeCellIndex > 0) { // Ensure there is a preceding cell
                    ...
                    console.log("Preceding Cell:", precedingCell); // Log preceding cell
                    if (precedingCell.model.type === 'markdown') {
                        const isExplanatory = precedingCell.model.getMetadata('explanatory') === true;
                        if (isExplanatory) {
                            const cellNode = precedingCell.node; // Get the DOM node for the cell
                            console.log("Cell DOM Node:", cellNode); // Log the actual DOM node
                            // Explicitly check for 'hidden' class and 'ct-hidden-cell' to toggle
                            if (cellNode.classList.contains('hidden') || cellNode.classList.contains(CSS_CLASSES.HIDDEN_CELL)) {
                                console.log("Cell is currently hidden, removing hidden class");
                                cellNode.classList.remove('hidden'); // Remove both potential hidden classes
                                cellNode.classList.remove(CSS_CLASSES.HIDDEN_CELL);
                            }
                            else {
                                console.log("Cell is visible, adding hidden class");
                                cellNode.classList.add(CSS_CLASSES.HIDDEN_CELL); // Add the class to hide the cell
                            }
                        }
                    }
                }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Cell footer container styles */
...
/* Hidden class for explanatory cells */
.ct-hidden-cell {
  display: none;
}

/* Flex container for side-by-side layout of explanatory and code cells */
.jp-CodeCell.with-explanation {
  display: flex;
  flex-direction: row;
...
/* Code cell with explanatory cell next to it */
.jp-CodeCell.with-explanation .ct-code-cell {
  width: 50%;
  padding: 10px;
}

/* Explanatory cell with code cell next to it */
.ct-explanatory-cell.visible {
  display: block;
  width: 50%;
  padding: 10px;
}

/* Code cell takes full width if no explanatory cell is shown */
.jp-CodeCell.full-width {
  width: 100%;
}

/* Other cells (markdown, etc.) are always full width */
.jp-Cell {
  width: 100%;
  margin-bottom: 20px;
}
`, "",{"version":3,"sources":["webpack://./style/index.css"],"names":[],"mappings":"AAEA,iCAAiC;AACjC;EACE,aAAa;EACb,mBAAmB;EACnB,2BAA2B;EAC3B,mBAAmB;AACrB;;AAEA,yBAAyB;AACzB;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,gBAAgB;EAChB,yBAAyB;EACzB,YAAY;EACZ,gBAAgB;EAChB,gBAAgB;EAChB,4CAA4C;EAC5C,eAAe;EACf,iBAAiB;EACjB,gBAAgB;EAChB,iBAAiB;EACjB,8BAA8B;AAChC;;AAEA;EACE,oCAAoC;EACpC,UAAU;EACV,2CAA2C;EAC3C,kCAAkC;AACpC;;AAEA;EACE,oCAAoC;EACpC,2CAA2C;AAC7C;;AAEA,uBAAuB;AACvB;;EAEE,aAAa;AACf;;AAEA,6CAA6C;AAC7C;;;EAGE,uBAAuB;EACvB,+BAA+B;AACjC;;AAEA,yBAAyB;AACzB;EACE,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,sBAAsB;AACxB;;AAEA,qBAAqB;AACrB;EACE,wBAAwB;EACxB,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,QAAQ;AACV;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,QAAQ;AACV;;AAEA,kCAAkC;AAClC;EACE,mDAAmD;EACnD,yBAAyB;EACzB,yBAAyB;EACzB,mBAAmB;EACnB,aAAa;EACb,cAAc;EACd,wCAAwC;EACxC,aAAa,EAAE,yBAAyB;AAC1C;;AAEA;EACE,cAAc;EACd,kBAAkB;EAClB,eAAe;EACf,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,qBAAqB;EACrB,UAAU;AACZ;;AAEA;EACE,yBAAyB;EACzB,cAAc;EACd,aAAa;EACb,kBAAkB;EAClB,eAAe;EACf,YAAY;AACd;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,kBAAkB;EAClB,cAAc;EACd,iBAAiB;AACnB;;AAEA,uCAAuC;AACvC;EACE,aAAa;AACf;;AAEA,yEAAyE;AACzE;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,WAAW;AACb;;AAEA,+CAA+C;AAC/C;EACE,UAAU;EACV,aAAa;AACf;;AAEA,+CAA+C;AAC/C;EACE,cAAc;EACd,UAAU;EACV,aAAa;AACf;;AAEA,+DAA+D;AAC/D;EACE,WAAW;AACb;;AAEA,uDAAuD;AACvD;EACE,WAAW;EACX,mBAAmB;AACrB","sourcesContent":["@import url('base.css');\n\n/* Cell footer container styles */\n.jp-Cell .ct-cellFooterContainer {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: center;\n}\n\n/* Footer button styles */\n.jp-Cell .ct-cellFooterBtn {\n  color: #fff;\n  opacity: 0.7;\n  font-size: 0.65rem;\n  font-weight: 500;\n  text-transform: uppercase;\n  border: none;\n  padding: 4px 8px;\n  margin: 0.2rem 0;\n  text-shadow: 0px 0px 5px rgba(0, 0, 0, 0.15);\n  cursor: pointer;\n  user-select: none;\n  margin-left: 0px;\n  margin-right: 4px;\n  background: var(--md-blue-400);\n}\n\n.jp-Cell .ct-cellFooterBtn:hover {\n  background-color: var(--md-blue-500);\n  opacity: 1;\n  text-shadow: 0px 0px 7px rgba(0, 0, 0, 0.3);\n  box-shadow: var(--jp-elevation-z2);\n}\n\n.ct-cellFooterBtn:active {\n  background-color: var(--md-blue-600);\n  text-shadow: 0px 0px 4px rgba(0, 0, 0, 0.4);\n}\n\n/* Placeholder styles */\n.jp-Placeholder-content .jp-PlaceholderText,\n.jp-Placeholder-content .jp-MoreHorizIcon {\n  display: none;\n}\n\n/* Disable default cell collapsing behavior */\n.jp-InputCollapser,\n.jp-OutputCollapser,\n.jp-Placeholder {\n  cursor: auto !important;\n  pointer-events: none !important;\n}\n\n/* Toggle button styles */\n.jp-Cell .ct-toggleBtn {\n  background: #f0f0f0;\n}\n\n.jp-Cell .ct-toggleBtn:hover {\n  background-color: #ccc;\n}\n\n.jp-Cell .ct-toggleBtn:active {\n  background-color: #999;\n}\n\n/* Code cell styles */\n.jp-CodeCell {\n  display: flex !important;\n  flex-direction: column;\n}\n\n.jp-CodeCell .jp-CellFooter {\n  height: auto;\n  order: 2;\n}\n\n.jp-Cell .jp-Cell-inputWrapper {\n  margin-top: 5px;\n}\n\n.jp-CodeCell .jp-Cell-outputWrapper {\n  order: 4;\n}\n\n/* Styling for explanatory cells */\n.ct-explanatory-cell {\n  font-family: 'Segoe UI', Tahoma, Geneva, sans-serif;\n  background-color: #fdf2e9;\n  border: 2px solid #e67e22;\n  border-radius: 10px;\n  padding: 20px;\n  margin: 20px 0;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n  display: none; /* Default hidden state */\n}\n\n.ct-explanatory-cell h2 {\n  color: #d35400;\n  text-align: center;\n  font-size: 26px;\n  margin-bottom: 20px;\n}\n\n.ct-explanatory-cell p {\n  font-size: 18px;\n  line-height: 1.8;\n  color: #2c3e50;\n}\n\n.ct-explanatory-cell ul {\n  list-style-type: none;\n  padding: 0;\n}\n\n.ct-explanatory-cell li {\n  background-color: #f39c12;\n  margin: 10px 0;\n  padding: 10px;\n  border-radius: 8px;\n  font-size: 17px;\n  color: white;\n}\n\n.ct-explanatory-cell code {\n  background-color: #ffe6cc;\n  padding: 5px;\n  border-radius: 5px;\n  color: #d35400;\n  font-weight: bold;\n}\n\n/* Hidden class for explanatory cells */\n.ct-hidden-cell {\n  display: none;\n}\n\n/* Flex container for side-by-side layout of explanatory and code cells */\n.jp-CodeCell.with-explanation {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  width: 100%;\n}\n\n/* Code cell with explanatory cell next to it */\n.jp-CodeCell.with-explanation .ct-code-cell {\n  width: 50%;\n  padding: 10px;\n}\n\n/* Explanatory cell with code cell next to it */\n.ct-explanatory-cell.visible {\n  display: block;\n  width: 50%;\n  padding: 10px;\n}\n\n/* Code cell takes full width if no explanatory cell is shown */\n.jp-CodeCell.full-width {\n  width: 100%;\n}\n\n/* Other cells (markdown, etc.) are always full width */\n.jp-Cell {\n  width: 100%;\n  margin-bottom: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
//# sourceMappingURL=lib_index_js.4008dd2508be577fb542.js.map