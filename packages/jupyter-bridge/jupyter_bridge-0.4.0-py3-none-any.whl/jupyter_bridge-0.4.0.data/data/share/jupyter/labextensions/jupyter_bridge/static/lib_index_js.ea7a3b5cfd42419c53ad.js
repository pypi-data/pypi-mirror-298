            ...
            execute: () => {
                ...
                if (activeCellIndex > 0) { // Ensure there is a preceding cell
                    ...
                    if (precedingCell.model.type === 'markdown') {
                        ...
                        console.log("Is Explanatory:", isExplanatory); // Log explanatory status
                        if (isExplanatory) {
                            const cellNode = precedingCell.node; // Ensure we get the DOM node for the cell
                            console.log("Cell DOM Node:", cellNode); // Log the actual DOM node
                            if (cellNode.classList.contains(CSS_CLASSES.HIDDEN_CELL)) {
                                cellNode.classList.remove(CSS_CLASSES.HIDDEN_CELL);
                            }
                            else {
                                cellNode.classList.add(CSS_CLASSES.HIDDEN_CELL);
                            }
                        }
                    }
                }
...
//# sourceMappingURL=lib_index_js.ea7a3b5cfd42419c53ad.js.map