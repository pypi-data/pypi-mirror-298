        ...
        function setupCellFlags(panel) {
            ...
            panel.content.widgets.forEach((cell, index) => {
                if (cell.model.type === 'markdown') {
                    ...
                    if (isExplanatory) {
                        // Add explanatory cell class to apply CSS
                        cell.addClass(CSS_CLASSES.EXPLANATORY_CELL);
                        // Toggle hidden class
                        if (!cell.hasClass(CSS_CLASSES.HIDDEN_CELL)) {
                            cell.addClass(CSS_CLASSES.HIDDEN_CELL);
                        }
                        else {
                            cell.removeClass(CSS_CLASSES.HIDDEN_CELL);
                        }
                    }
...
//# sourceMappingURL=lib_index_js.aedffb875459c9083b5c.js.map