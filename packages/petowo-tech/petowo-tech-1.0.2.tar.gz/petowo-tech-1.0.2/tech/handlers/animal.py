...
class AnimalHandler:
    ...
    def get_animals_by_user_id(self, user_id: int) -> None:
        ...
        try:
            ...
            logging.info(f'animal handler: empty output animals by user_id={user_id}')
    ...
    def delete_animal(self, user_id: int) -> None:
        ...
        try:
            ...
            logging.info(f'animal handler: delete animal: invalid input')
            return
        ...
        if existing_dto.user_id != user_id:
            logging.info(f'animal handler: user isn\'t animal\'s owner, user_id={user_id} animal.user_id={existing_dto.user_id}')
        ...
        try:
            ...
            logging.info(f'animal handler: delete animal error: wrong show_status')
    ...
    def create_animal(self, user_id: int) -> None:
        ...
        try:
            ...
            logging.info(f'animal handler: create animal: invalid input')
            return
        try:
            created = self.animal_service.create(dto.to_schema_create())
        except ValidationRepoError:
            logging.info(f'animal handler: create animal: repo validation error')
