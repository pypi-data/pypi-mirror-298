...
class ShowHandler:
    ...
    def score_animal(self, user_id: int):
        ...
        try:
            ...
            logging.info(f'show handler: user role error (not judge)')
        ...
        try:
            ...
            logging.info('show handler: invalid score input')
            return
    ...
    def create_show(self):
        ...
        try:
            ...
            logging.info('show handler: invalid create show input')
            return
        
        try:
            created = self.show_service.create(dto.to_schema_create())
        except ValidationRepoError:
            logging.info(f'show handler: create show: repo validation error')
    ...
    def start_show(self):
        ...
        try:
            ...
            logging.info('show handler: wrong start show status')
            print(self.lm.show_start_error_status)
            return
        except StartShowZeroRecordsError as e:
            if e.type == 'user':
                logging.info('show handler: zero usershow records, cannot start')
                print(self.lm.show_start_error_no_records_user)
            elif e.type == 'animal':
                logging.info('show handler: zero animalshow records, cannot start')
    ...
    def stop_show(self):
        ...
        try:
            ...
            logging.info('show handler: wrong stop show status')
            print(self.lm.show_stop_error_status)
            return
        except StopNotAllUsersScoredError:
            logging.info('show handler: not all users scored, cannot stop')
