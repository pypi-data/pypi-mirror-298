    ...
    def signin(self) -> Optional[UserConsoleInfo]:
        ...
        while True:
            ...
            try:
                ...
                logging.info('auth handler: sign in: email validation error')
            ...
            try:
                ...
                logging.info(f'auth handler: sign in: no user with email={email}')
            ...
            try:
                ...
                logging.info(f'auth handler: sign in: wrong password, email={email}')
                return None
