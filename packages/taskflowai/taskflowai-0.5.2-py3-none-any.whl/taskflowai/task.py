                            ...
                            for tool_request in tool_calls:
                                ...
                                if call_hash in previous_calls:
                                    ...
                                    if previous_calls[call_hash] == 2:
                                        ...
                                        # Fourth occurrence (third repeat), exit the loop. (verbatim repeats are a sign of coherence collapse and should exit the loop)
                                        print(f"{COLORS['WARNING']}Tool call for '{tool_name}' has been repeated verbatim three times. "
