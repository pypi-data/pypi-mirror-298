...
import os
import tempfile
from cvs2hg_lib.compat import cPickle as pickle

sys.path.insert(0, os.path.dirname(os.path.dirname(sys.argv[0])))

from cvs2hg_rcsparse import Sink
from cvs2hg_rcsparse import parse
from cvs2hg_lib.rcs_stream import RCSStream
