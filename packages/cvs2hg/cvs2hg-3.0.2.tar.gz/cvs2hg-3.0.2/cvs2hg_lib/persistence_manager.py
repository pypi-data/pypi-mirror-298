...
from cvs2hg_lib.common import SVN_INVALID_REVNUM
from cvs2hg_lib.artifact_manager import artifact_manager
from cvs2hg_lib.record_table import SignedIntegerPacker
from cvs2hg_lib.record_table import RecordTable
from cvs2hg_lib.serializer import PrimedPickleSerializer
from cvs2hg_lib.database import IndexedDatabase
from cvs2hg_lib.svn_commit import SVNRevisionCommit
from cvs2hg_lib.svn_commit import SVNInitialProjectCommit
from cvs2hg_lib.svn_commit import SVNPrimaryCommit
from cvs2hg_lib.svn_commit import SVNBranchCommit
from cvs2hg_lib.svn_commit import SVNTagCommit
from cvs2hg_lib.svn_commit import SVNPostCommit
...
class PersistenceManager:
    ...
    def put_svn_commit(self, svn_commit):
        ...
        if self.mode == DB_OPEN_READ:
            raise RuntimeError('Write operation attempted on read-only PersistenceManager')
