...
class App(cmd.Cmd):
    ...
    def parse_command(self, command: str, collect_multiline: bool = False, is_help: bool = False) -> list:
        """
    ...
    def default(self, line: str):
        ...
        if line.strip().endswith("?"):
            try:
                command_models = self.parse_command(line.strip().rstrip("?"), is_help=True)
            except FieldLooseMatchOnly as e:
                model, parameter = e.args
