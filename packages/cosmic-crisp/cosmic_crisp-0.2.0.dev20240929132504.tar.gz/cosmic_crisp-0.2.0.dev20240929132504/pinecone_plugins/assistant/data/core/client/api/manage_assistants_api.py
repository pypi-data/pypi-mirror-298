    ...
    def __init__(self, api_client=None):
        ...
        def __chat_completion_assistant(
            ...
            **kwargs
            ...
            This operation queries the completions endpoint of a Pinecone Assistant, which allows you to chat with it. \\n\\n For guidance and examples, see [Chat with an assistant](https://docs.pinecone.io/guides/assistant/chat-with-assistant).  # noqa: E501
        ...
        def __list_files(
            ...
            **kwargs
            ...
            This operation returns a list of all files in an assistant, with an option to filter files with metadata.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
