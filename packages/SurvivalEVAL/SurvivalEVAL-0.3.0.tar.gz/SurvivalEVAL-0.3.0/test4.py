...
cindex, concordant_pairs, total_pairs = eval.concordance(ties="None", predicted_time_method="Median", pair_method="Margin")
...
l1 = eval.mae(method='Margin', predicted_time_method="Mean")
