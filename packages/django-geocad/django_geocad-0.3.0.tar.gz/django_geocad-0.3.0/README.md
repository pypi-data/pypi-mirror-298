...
## Tests
Tests with unittest, 98% coverage, missing some special conditions in DXF extraction. Tested for other Django 4.2 and 5.1 and Python 3.9, 3.10, 3.11, 3.12 versions.
