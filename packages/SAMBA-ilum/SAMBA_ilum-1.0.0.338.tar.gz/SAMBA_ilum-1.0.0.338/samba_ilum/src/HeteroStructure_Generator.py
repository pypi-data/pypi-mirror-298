...
for k in range(n_Lattice):
    ...
    for i in range(len(vx)):
        for j in range(len(vx)):
            ...
            #------------------------------------------------------
            if (len(temp_area_lattice) == 0):
               temp_area_lattice.append([area_min, area_max])
            if (len(temp_area_lattice) != 0):
               cont = 1 
               for ar in range(len(temp_area_lattice)):
                   if (temp_area_lattice[ar] == [area_min, area_max]): cont = 0
               if (cont == 1): temp_area_lattice.append([area_min, area_max]) 
            #----------------------------------------------------------------
...
print("Lattice1")
print(area_lattice_1)
print("------------")
print("Lattice2")
print(area_lattice_2)
print("------------")
print("Lattices")
print(areas_lattices)
print("------------")
