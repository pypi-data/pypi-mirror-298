...
def create_bronze_table_definition(spark, dlt, table_name: str, files_path: str, file_format: str, partitions: dict, schema_exclude_columns: list, time_diff_history_cdc_timestamp: int = 30):
    @dlt.table(
