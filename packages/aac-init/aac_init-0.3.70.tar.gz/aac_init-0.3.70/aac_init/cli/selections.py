...
from aac_init.deployment.utils import (
    Thread_Tool,
    APIC_CIMC_Tool,
    ACI_Switch_Tool,
    APIC_Tool,
...
class Selections:
    ...
    def apic_nac_config(self):
        ...
        if not aac_ansible.aac_ansible("validate", playbook_dir_validate):
        ...
        if not aac_ansible.aac_ansible("deploy", playbook_dir_deploy):
        ...
        if not aac_ansible.aac_ansible("test", playbook_dir_test):
