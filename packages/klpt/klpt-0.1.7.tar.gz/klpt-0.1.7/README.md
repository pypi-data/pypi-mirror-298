...
Although KLPT is not dependent on any NLP toolkit, there is one important requirement, particularly for the `stem` module. That is [`chunspell`](https://pypi.org/project/chunspell/). This replaced [`cyhunspell`](https://pypi.org/project/cyhunspell/) in the versions > 0.1.6.
