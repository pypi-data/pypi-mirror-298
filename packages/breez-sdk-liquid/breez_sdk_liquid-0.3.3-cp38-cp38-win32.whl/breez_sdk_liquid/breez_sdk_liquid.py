...
class PreparePayOnchainRequest:
    amount: "PayOnchainAmount";fee_rate_msat_per_vbyte: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, amount: "PayOnchainAmount", fee_rate_msat_per_vbyte: "typing.Optional[int]" = _DEFAULT):
        self.amount = amount
        if fee_rate_msat_per_vbyte is _DEFAULT:
            self.fee_rate_msat_per_vbyte = None
        else:
            self.fee_rate_msat_per_vbyte = fee_rate_msat_per_vbyte

    def __str__(self):
        return "PreparePayOnchainRequest(amount={}, fee_rate_msat_per_vbyte={})".format(self.amount, self.fee_rate_msat_per_vbyte)

    def __eq__(self, other):
        if self.amount != other.amount:
            return False
        if self.fee_rate_msat_per_vbyte != other.fee_rate_msat_per_vbyte:
            return False
        return True
...
class _UniffiConverterTypePreparePayOnchainRequest(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return PreparePayOnchainRequest(
            ...
            fee_rate_msat_per_vbyte=_UniffiConverterOptionalUInt32.read(buf),
        )

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypePayOnchainAmount.write(value.amount, buf)
        _UniffiConverterOptionalUInt32.write(value.fee_rate_msat_per_vbyte, buf)
...
class PrepareRefundRequest:
    swap_address: "str";refund_address: "str";fee_rate_msat_per_vbyte: "int";

    @typing.no_type_check
    def __init__(self, swap_address: "str", refund_address: "str", fee_rate_msat_per_vbyte: "int"):
        self.swap_address = swap_address
        self.refund_address = refund_address
        self.fee_rate_msat_per_vbyte = fee_rate_msat_per_vbyte

    def __str__(self):
        return "PrepareRefundRequest(swap_address={}, refund_address={}, fee_rate_msat_per_vbyte={})".format(self.swap_address, self.refund_address, self.fee_rate_msat_per_vbyte)
...
class _UniffiConverterTypePrepareRefundRequest(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return PrepareRefundRequest(
            ...
            fee_rate_msat_per_vbyte=_UniffiConverterUInt32.read(buf),
        )
    ...
    def write(value, buf):
        ...
        _UniffiConverterUInt32.write(value.fee_rate_msat_per_vbyte, buf)
...
class RefundRequest:
    ...
    def __str__(self):
        return "RefundRequest(swap_address={}, refund_address={}, fee_rate_msat_per_vbyte={})".format(self.swap_address, self.refund_address, self.fee_rate_msat_per_vbyte)
