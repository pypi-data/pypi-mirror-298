...
class OWBaseWidget(QDialog, OWComponent, Report, ProgressBarMixin,
    ...
    def __new__(cls, *args, captionTitle=None, **kwargs):
        ...
        self.__help_action = QAction(
            __("btn.help"), self, objectName="action-help", toolTip=__("tooltip.help_tip"),
            enabled=False, shortcut=QKeySequence(Qt.Key_F1)
        )
        self.__report_action = QAction(
            __("btn.report"), self, objectName="action-report",
            toolTip=__("tooltip.create_report"),
        ...
        self.__save_image_action = QAction(
            __("btn.save_image"), self, objectName="action-save-image",
        ...
        self.__reset_action = QAction(
            __("btn.reset"), self, objectName="action-reset-settings",
            toolTip=__("tooltip.reset_to_default"),
            enabled=False, visible=False,
        )
        ...
        self.__visual_settings_action = QAction(
            __("tooltip.show_view.options"), self, objectName="action-visual-settings",
            toolTip=__("tooltip.show_view.options"),
            enabled=False, visible=False,
        )
        ...
        self.__copy_action = QAction(
            __("btn.copy_to_clipboard"), self, objectName="action-copy-to-clipboard",
            shortcut=QKeySequence.Copy, toolTip=__("btn.copy_to_clipboard"),
            enabled=False, visible=False
        )
        ...
        if not nativemb:
            ...
            self.__menubar_action = QAction(
                __("btn.show_menu_bar"),  self, objectName="action-show-menu-bar",
                checkable=True,
        ...
        fileaction = mb.addMenu(_Menu(__("btn.file"), mb, objectName="menu-file"))
        ...
        editaction = mb.addMenu(_Menu(__("btn.edit"), mb, objectName="menu-edit"))
        ...
        viewaction = mb.addMenu(_Menu(__("btn.view"), mb, objectName="menu-view"))
        viewaction.setVisible(False)
        viewaction.menu().addAction(self.__visual_settings_action)
        windowaction = mb.addMenu(_Menu(__("btn.widow"), mb, objectName="menu-window"))
        ...
        helpaction = mb.addMenu(_Menu(__("btn.help_menu"), mb, objectName="help-menu"))
        ...
        self.__quick_help_action = QAction(
            __("tooltip.quick_help_tip"), self, objectName="action-quick-help-tip",
    ...
    def statusBar(self):
        ...
        if statusbar is None:
            ...
            self.__statusbar_action = statusbar_action = QAction(
                ...
                toolTip=__("tooltip.show_status_bar_tip"), checkable=True,
                enabled=False, visible=False,
