...
def save_collection_pandas(df: pd.DataFrame, operation_id: str, scheme: Optional[Dict[str, Any]], *, coll_id: Optional[str] = None) -> str:
...
def save_collection_json(data: str, operation_id: str, scheme: Optional[Dict[str, Any]], *, coll_id: Optional[str] = None) -> str:
...
def save_df(df: pd.DataFrame, path: str, *args, **kwargs):
