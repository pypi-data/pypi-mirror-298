...
class JuliusApp:
    ...
    async def init_all(self) -> bool:
        try:
            ...
            self.logs_buffer.write(f"init failed: {traceback.format_exc()}\n")
            return False
    ...
    async def init_all_first(self) -> bool:
        try:
            ...
            self.logs_buffer.write(f"start init failed: {traceback.format_exc()}\n")
            return False
    ...
    async def __input(self, *args, **kwargs):
        try:
            ...
            self.logs_buffer.write(f"{traceback.format_exc()}\n")
    ...
    async def run(self, *args, **kwargs) -> Tuple[bool, Any]:
        ...
        out = sys.stdout
        sys.stdout = self.logs_buffer # FIXME uncomment
        res = await run_fun(*args, **kwargs)
        sys.stdout = out              # FIXME uncomment
