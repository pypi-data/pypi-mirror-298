...
class AppEntity(BaseModel):
    ...
    conditions: Optional[Union[Dict[str, bool], List[Dict[str, bool]]]]         # condition bindId to it result
    loopArguments: Optional[Dict[str, AlternativeArgument]] = None              # other calls, problems
    loopConditions: Optional[Union[Dict[str, bool], List[Dict[str, bool]]]]     # condition bindId to it result for loop
