def create_vectorstore(provider: str, tag: str='vectorstore', delete_existing: bool=False, **kwargs):
    if provider == 'chromadb':
        ...
        if "index" not in kwargs:
            ...
            distance_strategy = kwargs.get("distance_strategy", DistanceStrategy.MAX_INNER_PRODUCT)
