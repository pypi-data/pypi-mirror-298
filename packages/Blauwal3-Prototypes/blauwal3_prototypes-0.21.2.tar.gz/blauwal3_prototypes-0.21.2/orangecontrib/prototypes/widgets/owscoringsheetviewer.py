...
from orangecontrib.prototypes.modeling.scoringsheet import ScoringSheetModel

from orangecontrib.prototypes.modeling.fasterrisk.utils import get_support_indices, get_all_product_booleans
...
def __(key):
    return i18n.t('prototypes.owscoringsheetviewer.' + key)
...
class ScoringSheetTable(QTableWidget):
    def __init__(self, main_widget, parent=None):
        ...
        self.setHorizontalHeaderLabels(
            [__("attribute_name"), __("points"), __("selected")]
        )
...
class RiskSlider(QWidget):
    ...
    def setup_labels(self):
        ...
        self.points_label = QLabel(__("total"))
        ...
        self.probability_label = QLabel(__("probabilities"))
...
class OWScoringSheetViewer(OWWidget):
    ...
    class Error(OWWidget.Error):
        invalid_classifier = Msg(__("invalid_classifier"))

    class Information(OWWidget.Information):
        multiple_instances = Msg(__("multiple_instances"))
    ...
    def _setup_gui(self):
        ...
        combo_box_layout.layout().addWidget(QLabel(__("target_class")))
