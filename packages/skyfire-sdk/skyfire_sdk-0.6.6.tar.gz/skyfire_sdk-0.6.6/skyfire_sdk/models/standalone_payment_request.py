...
class StandalonePaymentRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["receiverUsername", "amount", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandalonePaymentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandalonePaymentRequest from a dict"""
        if obj is None:
            return None
