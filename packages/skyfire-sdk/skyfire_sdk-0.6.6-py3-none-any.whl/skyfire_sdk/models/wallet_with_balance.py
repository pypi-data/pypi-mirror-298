...
class WalletWithBalance(BaseModel):
    ...
    wallet: Wallet
    balance: Web7Balance
    __properties: ClassVar[List[str]] = ["wallet", "balance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WalletWithBalance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WalletWithBalance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "balance": Web7Balance.from_dict(obj["balance"]) if obj.get("balance") is not None else None
        })
        return _obj
