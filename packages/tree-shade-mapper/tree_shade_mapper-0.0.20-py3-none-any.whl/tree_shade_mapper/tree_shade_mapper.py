...
def calc_transmittance_v2(base_dir, models=["tcm"], calc_type=None, kernel_size=3, binary_type="brightness"):
...
def get_tree_shade(base_dir, time_start, time_end, interval, time_zone, latitude, longitude, models=['tcm'], calc_type=None, vmin=0, vmax=1000, resolution=14):
    calc_transmittance_v2(base_dir, models=models, calc_type=calc_type)
