...
#    "id": "7f710a32-7f85-54f2-8f42-dfbbe48840d6",
#    "taker_address": "0xb20094DFede30AbEe3a8d549BbA828b6fd771106",
#    "maker_address": "0x451F52446EBD4376d4a05f4267eF1a03Acf1aAf4",
#    "src_asset_address": "0xaf88d065e77c8cC2239327C5EDb3A432268e5831",
#    "dst_asset_address": "0xD24C2Ad096400B6FBcd2ad8B24E7acBc21A1da64",
#    "src_chain": "arbitrum",
#    "dst_chain": "avalanche",
#    "src_amount": 72974,
#    "dst_amount": 73824154846277120,
#    "created_at": "2024-09-24T03:01:57",
#    "filled_at": "2024-09-24T03:03:03",
#    "expires_at": "2024-09-24T03:16:51",
#    "completed": true,
#    "place_tx": "0xd730805de5e4f7d130f8614205e339384343f9f6070c06af517224b44a789a2f",
#    "fill_tx": "0xf2c2725db428f4334d74fcb789263e23475dd7c2c252140a5af7ec2eec72165c",
#    "eta": 0
...
class MachClient:
    ...
    # TODO: Annotate return type with generics in Python 3.12.6+
    def _handle_response(
        self,
        response: Response,
        on_success: Callable[[Response], Any] = lambda r: r.json(),
    ) -> Any:
    ...
    def get_orders(self, wallet: ChecksumAddress) -> list[Order]:
        data = {
            "wallet": wallet,
        }
