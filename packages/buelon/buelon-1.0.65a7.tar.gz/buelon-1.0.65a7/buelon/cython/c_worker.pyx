...
transactions = MyQueue(os.path.join('.bue', 'worker_queue.queue'))  # persistqueue.Queue(os.path.join('.bue', 'worker_queue.queue'))  # persistqueue.SQLiteQueue(os.path.join('.bue', 'worker_queue.db'), auto_commit=True)  #
queue.Queue()
