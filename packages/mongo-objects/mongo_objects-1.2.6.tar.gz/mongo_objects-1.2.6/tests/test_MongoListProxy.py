...
class TestSetItem_A1:
    def test_setitem_A1(self, getPopulatedMMUDClasses, getSampleProxyA1):
        ...
        assert (
            doc["proxyA"][proxy.parent.seq]["proxyA1"][proxy.seq]["newKey"]
            == "this is a new value"
        )
...
class TestBasics:
    ...
    def test_data_A1(self, getSampleProxyA1):
        ...
        assert id(proxy.data()) == id(
            proxy.ultimate_parent["proxyA"][proxy.parent.seq]["proxyA1"][proxy.seq]
        )
    ...
    def test_get_proxy(self, getPopulatedMMUDClasses, getSampleParent):
        ...
        keyA1 = parent[classes["A"].container_name][0][classes["A1"].container_name][0][
            classes["A"].subdoc_key_name
        ]
        ...
        assert id(proxyA1.data()) == id(
            parent[classes["A"].container_name][0][classes["A1"].container_name][0]
        )
    ...
    def test_get_subdoc(self, getPopulatedMMUDClasses, getSampleProxyA):
        ...
        assert id(proxyA.get_subdoc()) == id(
            proxyA.parent[classes["A"].container_name][proxyA.seq]
        )
    ...
    def test_get_subdoc_A1(self, getPopulatedMMUDClasses, getSampleProxyA1):
        ...
        assert id(proxyA1.get_subdoc()) == id(
            proxyA1.ultimate_parent[classes["A"].container_name][proxyA1.parent.seq][
                classes["A1"].container_name
            ][proxyA1.seq]
        )
    ...
    def test_iter(self, getSampleProxyA):
        ...
        assert set([key for key in proxy]) == set(
            proxy.parent["proxyA"][proxy.seq].keys()
        )
    ...
    def test_iter_A1(self, getSampleProxyA1):
        ...
        # compare the keys
        assert set([key for key in proxy]) == set(
            proxy.parent["proxyA1"][proxy.seq].keys()
        )
    ...
    def test_keys(self, getPopulatedMMUDClasses, getSampleProxyA):
        ...
        assert (
            proxy.keys() == proxy.parent[classes["A"].container_name][proxy.seq].keys()
        )
    ...
    def test_keys_A1(self, getPopulatedMMUDClasses, getSampleProxyA1):
        ...
        assert (
            proxyA1.keys()
            == proxyA1.ultimate_parent[classes["A"].container_name][proxyA.seq][
                classes["A1"].container_name
            ][proxyA1.seq].keys()
        )
    ...
    def test_values(self, getPopulatedMMUDClasses, getSampleProxyA):
        ...
        assert list(proxy.values()) == list(
            proxy.parent[classes["A"].container_name][proxy.seq].values()
        )
