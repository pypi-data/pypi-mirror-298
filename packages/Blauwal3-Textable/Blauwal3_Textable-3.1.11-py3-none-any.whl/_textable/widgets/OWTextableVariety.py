...
def __(key):
    return i18n.t("textable.owtextablevariety." + key)
...
class OWTextableVariety(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.measurePerCategoryCheckbox = gui.checkBox(
            ...
            label=__(u'measure_per_category'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.checkBox(
            ...
            label=__(u'dynamically_adjust_subsample_size'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        self.numSubsampleSpin = gui.spin(
            ...
            step=1,
            orientation='horizontal',
            label=__(u'number_of_subsamples'),
            labelWidth=160,
            callback=self.sendButton.settingsChanged,
            keyboardTracking=False,
            tooltip=(
