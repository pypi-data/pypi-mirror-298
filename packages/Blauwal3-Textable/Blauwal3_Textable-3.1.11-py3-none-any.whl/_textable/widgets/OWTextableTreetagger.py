...
def __(key):
    return i18n.t("textable.owtextabletreetagger." + key)
class Treetagger(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.noLanguageParameterWarning = __(u'msg.no_language_parameter_warning')
        self.noTreetaggerPathWarning = __(u'msg.no_treetagger_path_warning')
        self.TreetaggerPath = (
        ...
        gui.checkBox(
            ...
            label=__(u'output_token_in_place_of_unknown_lemmas'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
