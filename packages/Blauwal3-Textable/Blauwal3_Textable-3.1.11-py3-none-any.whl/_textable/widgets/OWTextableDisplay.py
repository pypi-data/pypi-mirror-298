...
def __(key):
    return i18n.t("textable.owtextabledisplay." + key)
...
class OWTextableDisplay(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        gui.checkBox(
            ...
            label=__(u'limit_number_of_displayed_segments'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.checkBox(
            ...
            label=__(u'apply_custom_formatting'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.lineEdit(
            ...
            master=self,
            value='customFormat',
            label=__(u'format_segmentation'),
            labelWidth=131,
            orientation='horizontal',
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.checkBox(
            ...
            label=__(u'display_segmentation_in_rich_text_format_html'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
                u"TODO."
            ),
