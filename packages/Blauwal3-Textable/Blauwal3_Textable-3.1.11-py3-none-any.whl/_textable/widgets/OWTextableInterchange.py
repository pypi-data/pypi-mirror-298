...
def __(key):
    return i18n.t("textable.owtextableinterchange." + key)
...
class OWTextableInterchange(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.toSegmentationOptionsBox = gui.widgetBox(
            widget=self.controlArea,
            box=__(u'conversion_to_segmentation'),
            orientation='vertical',
            addSpace=False,
        )
        ...
        self.segmentContentCombo = gui.comboBox(
            ...
            label=__(u'use_this_as_segment_content'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
