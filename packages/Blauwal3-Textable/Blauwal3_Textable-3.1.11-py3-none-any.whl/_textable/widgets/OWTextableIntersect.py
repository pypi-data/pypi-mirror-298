...
def __(key):
    return i18n.t("textable.owtextableintersect." + key)
...
class OWTextableIntersect(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sourceCombo = gui.comboBox(
            ...
            value='source',
            orientation='horizontal',
            label=__(u'source_segmentation'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        self.sourceAnnotationCombo = gui.comboBox(
            ...
            emptyString=u'(none)',
            orientation='horizontal',
            label=__(u'source_annotation_key'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        self.filteringCombo = gui.comboBox(
            ...
            value='filtering',
            orientation='horizontal',
            label=__(u'filtering_segmentation'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        self.filteringAnnotationCombo = gui.comboBox(
            ...
            emptyString=u'(none)',
            orientation='horizontal',
            label=__(u'filter_annotation_key'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
