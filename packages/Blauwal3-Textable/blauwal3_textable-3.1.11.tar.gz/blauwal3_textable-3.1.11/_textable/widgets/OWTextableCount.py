...
def __(key):
    return i18n.t("textable.owtextablecount." + key)
...
class OWTextableCount(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.leftContextSizeSpin = gui.spin(
            ...
            step=1,
            orientation='horizontal',
            label=__(u'left_context_size'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            keyboardTracking=False,
            tooltip=(__(u'msg.left_context_size_info')),
        )
        gui.separator(widget=self.leftRightNeighborhoodBox, height=3)
        self.rightContextSizeSpin = gui.spin(
            ...
            step=1,
            orientation='horizontal',
            label=__(u'right_context_size'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            keyboardTracking=False,
            tooltip=(__(u'msg.right_context_size_info')),
        )
        gui.separator(widget=self.leftRightNeighborhoodBox, height=3)
        self.unitPosMarkerLineEdit = gui.lineEdit(
            ...
            value='unitPosMarker',
            orientation='horizontal',
            label=__(u'unit_position_marker'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
