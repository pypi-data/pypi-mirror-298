...
def __(key):
    return i18n.t("textable.owtextableextractxml." + key)
...
class OWTextableExtractXML(OWTextableBaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        gui.checkBox(
            ...
            master=self,
            value='importElement',
            label=__(u'import_element_with_key'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.checkBox(
            ...
            label=__(u'prioritize_shallow_attributes'),
            callback=self.sendButton.settingsChanged,
            tooltip=(
        ...
        gui.checkBox(
            ...
            master=self,
            value='autoNumber',
            label=__(u'auto_number_with_key'),
            labelWidth=180,
            callback=self.sendButton.settingsChanged,
            tooltip=(
