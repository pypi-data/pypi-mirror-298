...
class ManifiestoInfo (EcuInfo):
	...
	#------------------------------------------------------------------
	def extractVehiculoInfo (self, type, remolque=None):
		...
		try:
			...
			print (f"+++ DEBUG: keys:", keys ["placaPais"])
			print (f"+++ DEBUG: self.fields '", self.fields [keys ["placaPais"]])
			print (f"+++ DEBUG: placaPaisText '{ placaPaisText}'")
