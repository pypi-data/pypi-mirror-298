...
class SsmPs(o7lib.aws.base.Base):
    ...
    def display_parameter(self):
        ...
        print(f'LastModifiedDate: {self.parameter_value.get("LastModifiedDate",datetime.datetime.fromtimestamp(0)).isoformat()}')
        print('')
    ...
    def menu_parameter(self, index):
        ...
        obj = o7m.Menu( exit_option = 'b', title='Parameter Details', title_extra=self.session_info(), compact=False)

        obj.add_option(o7m.Option(key='r', name='Display Raw Data',callback=lambda: pprint.pprint(self.parameter_value)))
        obj.add_option(o7m.Option(key='e', name='Edit current value', callback=self.edit_parameter))
    ...
    def menu_parameters(self):
        ...
        obj = o7m.Menu(exit_option = 'b', title='Parameter Store', title_extra=self.session_info(), compact=False)
