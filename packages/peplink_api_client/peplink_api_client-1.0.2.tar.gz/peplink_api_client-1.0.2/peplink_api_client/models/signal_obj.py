...
class SignalObj(BaseModel):
    ...
    ecio: Optional[Union[StrictFloat, StrictInt]] = None
    rsrp: Optional[StrictInt] = None
    rsrq: Optional[Union[StrictFloat, StrictInt]] = None
    strength: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["rssi", "sinr", "snr", "ecio", "rsrp", "rsrq", "strength"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignalObj from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignalObj from a dict"""
        if obj is None:
            return None
