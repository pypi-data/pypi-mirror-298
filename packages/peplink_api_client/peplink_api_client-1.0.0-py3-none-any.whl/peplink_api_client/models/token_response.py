...
class TokenResponse(BaseModel):
    ...
    authorization_type: StrictInt = Field(alias="authorizationType")
    scope: StrictStr
    expires_in: StrictInt = Field(alias="expiresIn")
    __properties: ClassVar[List[str]] = ["accessToken", "authorizationType", "scope", "expiresIn"]
    ...
    def scope_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['api', 'api.readonly']):
            raise ValueError("must be one of enum values ('api', 'api.readonly')")
        return value
