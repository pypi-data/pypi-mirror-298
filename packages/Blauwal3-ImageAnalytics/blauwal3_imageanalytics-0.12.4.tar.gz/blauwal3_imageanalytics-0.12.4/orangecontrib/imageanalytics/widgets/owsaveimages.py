...
class OWSaveImages(OWWidget, ConcurrentWidgetMixin):
    ...
    class Error(widget.OWWidget.Error):
        ...
        no_image_attribute = widget.Msg(__("msg_data_no_image_attr"))
    ...
    def __init__(self):
        ...
        # buttons
        self.bt_save = gui.button(self.buttonsArea, self, __("btn_save"), callback=self.save_file)
        gui.button(self.buttonsArea, self, __("btn_save_as"), callback=self.save_file_as)
