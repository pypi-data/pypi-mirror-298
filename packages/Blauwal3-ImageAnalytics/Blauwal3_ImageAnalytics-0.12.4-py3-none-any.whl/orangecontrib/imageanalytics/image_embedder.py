...
def __(key):
    return i18n.t('imganlytic.image_embedder.' + key)
MODELS = {
    "inception-v3": {
        "name": __("gbox.inception_v3"),
        "description": __("gbox.inception_v3_desc"),
    ...
    "painters": {
        "name": __("gbox.painter"),
        "description": __("gbox.painter_desc"),
    ...
    "deeploc": {
        "name": __("gbox.deeploc"),
        "description": __("gbox.deeploc_desc"),
    ...
    "vgg16": {
        "name": __("gbox.vgg_16"),
        "description": __("gbox.vgg_16_desc"),
    ...
    "vgg19": {
        "name": __("gbox.vgg_19"),
        "description": __("gbox.vgg_19_desc"),
        "target_image_size": (224, 224),
        "layers": ["penultimate"],
        "order": 3,
        "batch_size": 500,
    ...
    "openface": {
        "name": __("gbox.openface"),
        "description": __("gbox.openface_desc"),
        "target_image_size": (256, 256),
        "layers": ["penultimate"],
        "order": 6,
        "batch_size": 500,
    ...
    "squeezenet": {
        "name": __("gbox.squeezenet"),
        "description": __("gbox.squeezenet_desc"),
