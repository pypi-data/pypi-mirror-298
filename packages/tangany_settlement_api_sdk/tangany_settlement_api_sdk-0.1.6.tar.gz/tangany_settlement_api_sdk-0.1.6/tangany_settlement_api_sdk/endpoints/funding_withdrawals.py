...
@define
class FundingWithdrawalPostEntry:
    _id: str
    ...
    def __init__(self, id: str, from_account_id: str, value: str, asset_id: str, fiat_currency: str, fiat_value: str, tx_hash: str, reference: str = None, value_date: str = None):
        self._id = id
...
class FundingWithdrawals:
    ...
    def create(self, ledger_id: str, transaction_id: str, from_account_id: str, value: str, asset_id: str, fiat_currency: str, fiat_value: str,  tx_hash: str,
               value_date: str = None, reference: str = None) -> str: 
        url = f"{self._base_url}/{ledger_id}/funding/withdrawals"
        deposit = FundingWithdrawalPostEntry(id=transaction_id, from_account_id=from_account_id, value=value, asset_id=asset_id, fiat_currency=fiat_currency, fiat_value=fiat_value, 
    ...
    def create_batch(self, ledger_id: str, transactions: List[FundingWithdrawalPostEntry]) -> str: 
        url = f"{self._base_url}/{ledger_id}/funding/withdrawals"
