...
__all__ = ["IRuntimeObject", "ITask", "IEMyrrhOs", "IMHandle"]
__all__ += [
    "IStream",
    "IInStream",
    "IOutStream",
...
class IEMyrrhOs(IESystem, IEWarehouseService):
    @property
    @abc.abstractmethod
    def curdir(self) -> str: ...
    ...
    @property
    @abc.abstractmethod
    def executables(self) -> dict[bytes, bytes]: ...
