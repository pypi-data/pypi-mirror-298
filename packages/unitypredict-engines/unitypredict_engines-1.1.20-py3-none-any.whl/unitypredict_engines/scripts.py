...
def main():
    ...
    parser.add_argument("--run", action="store_true", help="""unitypredict --engine --run <EngineName>""")
    parser.add_argument("--deploy", action="store_true", help="""unitypredict --engine --deploy <EngineName>""")
    parser.add_argument("--delete", action="store_true", help="""unitypredict --engine --delete <EngineName>""")
