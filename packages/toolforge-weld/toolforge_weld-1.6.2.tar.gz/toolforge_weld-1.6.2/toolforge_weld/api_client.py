...
class ToolforgeClient:
    ...
    def get(self, url, display_messages: bool = False, **kwargs) -> dict[str, Any]:
        """GET request."""
        response = self._make_request("GET", url, **kwargs).json()
        display_messages and self._display_messages(response)
        return response

    def post(self, url, display_messages: bool = False, **kwargs) -> dict[str, Any]:
        """POST request."""
        response = self._make_request("POST", url, **kwargs).json()
        display_messages and self._display_messages(response)
        return response

    def put(self, url, display_messages: bool = False, **kwargs) -> dict[str, Any]:
        """PUT request."""
        response = self._make_request("PUT", url, **kwargs).json()
        display_messages and self._display_messages(response)
        return response

    def patch(self, url, display_messages: bool = False, **kwargs) -> dict[str, Any]:
        """PATCH request."""
        response = self._make_request("PATCH", url, **kwargs).json()
        display_messages and self._display_messages(response)
        return response

    def delete(self, url, display_messages: bool = False, **kwargs) -> dict[str, Any]:
        """DELETE request."""
