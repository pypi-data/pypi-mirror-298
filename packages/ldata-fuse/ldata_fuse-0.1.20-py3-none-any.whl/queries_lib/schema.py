...
class OrgPackageInfosOrderBy(Enum):
    """
    Methods to use when ordering `OrgPackageInfo`.
    """
    natural = "NATURAL"
    id_asc = "ID_ASC"
    id_desc = "ID_DESC"
...
class OrgInfosOrderBy(Enum):
    ...
    org_package_infos_by_org_id__count_asc = "ORG_PACKAGE_INFOS_BY_ORG_ID__COUNT_ASC"
    org_package_infos_by_org_id__count_desc = "ORG_PACKAGE_INFOS_BY_ORG_ID__COUNT_DESC"
