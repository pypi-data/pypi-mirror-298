    ...
    if os.path.isdir(os.path.dirname(uploaddir)):
        if fileitem.filename != "":
            if rename == "":
                ...
                fname = '{}{}'.format(rename, os.path.basename(fileitem.filename))
            try:
                
                with open(os.path.join(uploaddir, fname), 'wb') as result:
            ...
            try:
                ...
                with open(os.path.join(uploaddir, rename), 'wb') as result:
