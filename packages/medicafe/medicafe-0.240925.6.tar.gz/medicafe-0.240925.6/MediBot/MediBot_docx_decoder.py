...
def parse_docx(filepath, surgery_dates):  # Accept surgery_dates as a parameter
    ...
    if date_of_service.strftime("%m-%d-%Y") not in surgery_dates:
        MediLink_ConfigLoader.log("Date of Service {} not found in provided surgery dates. Skipping document.".format(date_of_service), level="INFO")
