...
class InteractApi(object):
    ...
    @auto_fill
    @validate_arguments
    def read_contract(self, id : Annotated[StrictStr, Field(..., description="Contract id")], read_contract_state_by_id_request : Annotated[ReadContractStateByIDRequest, Field(..., description="Read contract state by executing a read ABI function.")], **kwargs) -> ReadContractState:  # noqa: E501
    ...
    def read_contract_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Contract id")], read_contract_state_by_id_request : Annotated[ReadContractStateByIDRequest, Field(..., description="Read contract state by executing a read ABI function.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        warnings.warn("POST /v1/w3s/contracts/{id}/read is deprecated.", DeprecationWarning)
