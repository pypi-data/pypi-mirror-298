...
class ProductiveClientAPI:
    ...
    def __request(self, method, endpoint, params=None, json=None):
        ...
        data = []
        included = []
        if self.include_param is not None and method.lower() == 'get':
            if params is None:
    ...
    def execute(self):
        response =  self.__request(self.method, self.endpoint, self.params, self.json)
        ...
        json = {
            "data": {
                ...
                "attributes": {
                    ...
                    "holiday_calendar_id": salary["holiday_calendar_id"],
                },
                "relationships": {
                    "person": {
                        "data": {
