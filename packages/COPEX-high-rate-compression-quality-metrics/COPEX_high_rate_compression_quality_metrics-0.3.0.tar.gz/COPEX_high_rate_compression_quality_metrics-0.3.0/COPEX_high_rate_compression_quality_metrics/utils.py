...
Optional[str]:
    ...
    try:
        ...
        if verbose : print("--- get_algorithm_results_folders --- list of matching folders = ", list_matching_folders(root_dir=root_dir, search_str=nnvvpp_algoname, bracket_num=0))
        return result
    except:
...
def list_matching_folders(root_dir: str, search_str: str, bracket_num: int, verbose = False) -> List[str]:
    ...
    """
    if verbose : print("list_matching_folders --> matching folders from ",root_dir,"...")
    matching_folders = []
    ...
    if verbose : print("list_matching_folders --> matching folders : ",matching_folders,".")
