...
def load_multispectral_images(directory, valid_bands, resample_bands, resample_factor, band_prefix, resampling_method = Resampling.bilinear):
    """
