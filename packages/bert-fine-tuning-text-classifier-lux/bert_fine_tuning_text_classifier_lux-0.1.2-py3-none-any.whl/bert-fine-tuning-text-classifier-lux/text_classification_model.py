...
# This will ensure that the system uses the correct GPU (if available)
os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # Default to GPU0
...
class TextClassificationModel:
    ...
    def __init__(self, model_name='bert-base-uncased', cache_dir=None):
        ...
        self.encoder = OneHotEncoder(sparse=False)  # For encoding categorical data
