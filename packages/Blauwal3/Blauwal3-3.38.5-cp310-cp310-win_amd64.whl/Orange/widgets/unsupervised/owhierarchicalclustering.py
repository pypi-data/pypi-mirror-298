...
class OWHierarchicalClustering(widget.OWWidget):
    ...
    class Error(widget.OWWidget.Error):
        ...
        not_finite_distances = Msg(__("box_distance_metric"))
    ...
    def __init__(self):
        ...
        grid = QGridLayout()
        gui.widgetBox(self.controlArea, __("box.annotation"), orientation=grid)
        ...
        cb = gui.checkBox(
            None, self, "label_only_subset", __("label_only_subset"),
            disabled=True,
        ...
        cb = gui.comboBox(
            ...
            sizePolicy=QSizePolicy(QSizePolicy.MinimumExpanding,
                                   QSizePolicy.Fixed))
        self.color_by_label = QLabel(__("color_by"))
        ...
        self.zoom_slider = gui.hSlider(
            self.controlArea, self, "zoom_factor", box=__("box.zoom"),
    ...
    def send_report(self):
        ...
        self.report_items((
            (__('report.linkage'), LINKAGE[self.linkage]),
