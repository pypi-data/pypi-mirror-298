...
class OWSelectRows(widget.OWWidget):
    ...
    Operators = {
        ...
        StringVariable: [
            ...
            (FilterString.NotContain, "does not contain"),
            (FilterString.StartsWith, __("filter.begins_with")),
            (FilterString.NotStartsWith, "does not begin with"),
            (FilterString.EndsWith, __("filter.ends_with")),
            (FilterString.NotEndsWith, "does not end with"),
            (FilterString.IsDefined, __("filter.defined")),
            (FilterString.NotIsDefined, "is not defined"),
        ]
    }
    ...
    for _all_name, _all_type, _all_ops in (
            ...
            (__("row.numeric_variables"), 2,
             [(v, t) for v, t in Operators[ContinuousVariable]]),
            (__("row.string_variables"), 3,
             [(v, t) for v, t in Operators[StringVariable]])):
