...
class FeatureSelectEditor(BaseEditor):
    ...
    def __init__(self, parent=None):
        ...
        self.__uni_fs.setItems(
            [{"text": __("editor.information_gain"), "tooltip": ""},
             {"text": __("editor.gain_ratio")},
             {"text": __("editor.gini_index")},
             {"text": i18n.t("common.algorithm.reliefF")},
             {"text": __("editor.fast_correlation_filter")},
             {"text": i18n.t("common.general.ANOVA")},
             {"text": __("editor.chi_two")},
             {"text": __("editor.rrelieff")},
             {"text": __("editor.univariate_linear_regression")}
             ]
        )
