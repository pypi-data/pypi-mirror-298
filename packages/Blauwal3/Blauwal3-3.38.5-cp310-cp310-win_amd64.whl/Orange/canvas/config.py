...
OFFICIAL_ADDON_LIST = "https://bw.dashenglab.com/addons/blauwal3"
...
class Config(config.Config):
    ...
    def widgets_entry_points():
        ...
        all_eps = sorted(
            ...
            key=lambda ep:
            0 if ep.dist.name.lower() == "Blauwal3" else 1
        )
        return iter(all_eps)
    ...
    def addon_defaults_list(session=None):
        ...
        # import json
        # with open("/packages", "r", encoding="utf-8") as e:
        #     data = e.read()
    ...
    def examples_entry_points():
        ...
        default_ep = EntryPoint(
            "Blauwal3", "Orange.canvas.workflows", "orange.widgets.tutorials",
        )
