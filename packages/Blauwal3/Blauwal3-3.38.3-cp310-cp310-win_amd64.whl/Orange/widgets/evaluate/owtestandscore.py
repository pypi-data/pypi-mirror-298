...
from Orange.widgets.utils.concurrents import ThreadExecutor, TaskState
...
class OWTestAndScore(OWWidget):
    ...
    class Inputs:
        ...
        , label=i18n.t("common.general.learner"))
    ...
    def __init__(self):
        ...
        self.class_selection_combo = gui.comboBox(
            ...
            label= __("box.evaluation_results_for_target"), orientation=Qt.Horizontal,
        ...
        cbox = gui.comboBox(
            box, self, "comparison_criterion", label=__("compare_model"),
            sizeAdjustPolicy=QComboBox.AdjustToMinimumContentsLengthWithIcon,
            sizePolicy=(QSizePolicy.MinimumExpanding, QSizePolicy.Fixed),
            orientation=Qt.Horizontal, callback=self.update_comparison_table).box

        gui.separator(cbox, 8)
        gui.checkBox(cbox, self, "use_rope", __("checkbox_negligible_difference"),
