...
class VimIndicator(QWidget):
    def __init__(self, parent):
        ...
        self.indicator_text = __("tooltip.normal")
...
class OWPythonScript(OWWidget):
    ...
    class Inputs:
        data = MultiInput("Data", Table, replaces=["in_data"],
                     default=True, multiple=True, label=i18n.t("widget.data.data.common.data"))
        learner = MultiInput("Learner", Learner, replaces=["in_learner"],
                        default=True, multiple=True, label=i18n.t("common.general.learner"))
        classifier = MultiInput("Classifier", Model, replaces=["in_classifier"],
                           default=True, multiple=True, label=i18n.t("common.general.classifier"))
        object = MultiInput("Object", object, replaces=["in_object"],
    ...
    class Outputs:
        ...
        object = Output("Object", object, replaces=["out_object"] , auto_summary=False,label=i18n.t("widget.data.data.common.object"))
    ...
    def __init__(self):
        ...
        self.editorBox = gui.vBox(self, box=__("box.editor"), spacing=4)
        ...
        self.editor_controls = gui.vBox(self.controlArea, box=__("box.preferences"))
        ...
        gui.checkBox(
            self.vim_box, self, 'vimModeEnabled', __("checkbox.vim_mode"),
            tooltip=__("checkbox.vim_mode_tip"),
        ...
        self.run_action = QAction(__("btn.run_script"), self, triggered=self.commit,
    ...
    def onAddScript(self, *_):
        self.libraryList.append(Script(__("file.name"), self.text.toPlainText(), 0))
