...
REG_SCORES = [
    ScoreMeta(__("checkbox.univar_reg"), __("label.univar_reg"),
...
class OWRank(OWWidget, ConcurrentWidgetMixin):
    ...
    class Inputs:
        ...
        scorer = MultiInput("Scorer", score.Scorer, filter_none=True, label=i18n.t("widget.data.data.common.scorer"))
