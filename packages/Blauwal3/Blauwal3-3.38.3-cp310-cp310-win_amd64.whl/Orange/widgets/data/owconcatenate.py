...
class OWConcatenate(widget.OWWidget):
    ...
    class Inputs:
        ...
        additional_data = MultiInput("Additional Data",
                                Orange.data.Table,
                                default=True,
    ...
    source_attr_name = settings.Setting(__("source_id"))
    ...
    def __init__(self):
        ...
        gui.widgetLabel(
            self.mergebox, self.tr(__("label_domain")))
        ...
        box = gui.vBox(self.controlArea, __("variable_matching"))
        gui.checkBox(
        ...
        gui.checkBox(
            ...
            self.tr(__("ignore_compute_value")),
