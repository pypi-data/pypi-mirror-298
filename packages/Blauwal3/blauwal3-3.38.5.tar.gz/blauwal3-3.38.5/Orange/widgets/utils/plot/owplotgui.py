...
class OWPlotGUI:
    ...
    _buttons = {
        Zoom: (__("btn.zoom"), 'state', ZOOMING, None, 'Dlg_zoom'),
        ZoomReset: (__("btn.zoom_reset"), None, None, None, 'Dlg_zoom_reset'),
        Pan: (__("btn.pan"), 'state', PANNING, None, 'Dlg_pan_hand'),
        SimpleSelect: (__("btn.simple_select"), 'state', SELECT, None, 'Dlg_arrow'),
        Select: (__("btn.select"), 'state', SELECT, None, 'Dlg_arrow'),
        SelectionAdd: (__("btn.selection_add"), 'selection_behavior', SELECTION_ADD, None, 'Dlg_select_add'),
        SelectionRemove: (__("btn.selection_remove"), 'selection_behavior', SELECTION_REMOVE, None, 'Dlg_select_remove'),
        SelectionToggle: (__("btn.selection_toggle"), 'selection_behavior', SELECTION_TOGGLE, None, 'Dlg_select_toggle'),
        SelectionOne: (__("btn.selection_one"), 'selection_behavior', SELECTION_REPLACE, None, 'Dlg_arrow'),
        SendSelection: (__("btn.send_selection"), None, None, 'send_selection', 'Dlg_send'),
        ClearSelection: (__("btn.clear_selection"), None, None, 'clear_selection', 'Dlg_clear'),
        ShufflePoints: (__("btn.shuffle_points"), None, None, 'shuffle_points', 'Dlg_sort')
    }

    _check_boxes = {
        AnimatePlot: (__("checkbox.animate_plot"), 'animate_plot', 'update_animations'),
        AnimatePoints: (__("checkbox.animate_points"), 'animate_points', 'update_animations'),
        AntialiasPlot: (__("checkbox.antialias_plot"), 'antialias_plot', 'update_antialiasing'),
        AntialiasPoints: (__("checkbox.antialias_points"), 'antialias_points', 'update_antialiasing'),
        AntialiasLines: (__("checkbox.antialias_lines"), 'antialias_lines', 'update_antialiasing'),
        AutoAdjustPerformance: (__("checkbox.auto_adjust_performance"), 'auto_adjust_performance', 'update_performance')
    }
