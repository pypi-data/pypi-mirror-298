...
DiscreteOptions: Dict[int, MethodDesc] = {
    ...
    for method in (
        MethodDesc(
            Continuize.Default, __("use_preset"), __("use_preset"),
            __("treat_variable_as_defined")),
        MethodDesc(
            Continuize.Leave, __("keep_categorical"), __("keep_categorical"),
            __("keep_variable_discrete")),
        MethodDesc(
            Continuize.FirstAsBase, __("first_value_as_base"), __("first_value_as_base"),
            __("one_indicator_variable_except_first")),
        MethodDesc(
            Continuize.FrequentAsBase, __("most_frequent_as_base"), __("most_frequent_as_base"),
            __("one_indicator_variable_except_most_frequent"),
            False),
        MethodDesc(
            Continuize.Indicators, __("one_hot_encoding"), __("one_hot_encoding"),
            __("one_indicator_variable_each_value"),
            False),
        MethodDesc(
            Continuize.RemoveMultinomial, __("remove_if_more_than_2_values"), __("remove_if_more_than_2_values"),
            __("remove_variables_more_than_two_values")),
        MethodDesc(
            Continuize.Remove, __("remove"),  __("remove"),
            __("remove_variable")),
        MethodDesc(
            Continuize.AsOrdinal, __("treat_as_ordinal"), __("treat_as_ordinal"),
            __("each_value_gets_consecutive_number")),
        MethodDesc(
            Continuize.AsNormalizedOrdinal, __("treat_as_normalized_ordinal"), __("treat_as_normalized_ordinal"),
            __("scaled_to_0_1"))
    )}
...
ContinuousOptions: Dict[int, MethodDesc] = {
    ...
    for method in (
        MethodDesc(
            Normalize.Default, __("use_preset"), __("use_preset"),
            __("treat_variable_as_defined_default")),
        MethodDesc(
            Normalize.Leave, __("keep_as_it_is"),__("keep_as_it_is"),
            __("keep_variable_as_is")),
        MethodDesc(
            Normalize.Standardize, __("standardize_to_0_1"), __("standardize_to_0_1"),
            __("subtract_mean_divide_std"),
            False),
        MethodDesc(
            Normalize.Center, __("center_to_0"), __("center_to_0"),
            __("subtract_mean"),
            False),
        MethodDesc(
            Normalize.Scale, __("scale_to_1"), __("scale_to_1"),
            __("divide_by_std")),
        MethodDesc(
            Normalize.Normalize11, __("normalize_to_interval_1_1"),__("normalize_to_interval_1_1"),
            __("linear_transformation_interval_1_1"),
            False),
        MethodDesc(
            Normalize.Normalize01, __("normalize_to_interval_0_1"), __("normalize_to_interval_0_1"),
            __("linear_transformation_interval_0_1"),
            False),
    )}
...
class DefaultContModel(QAbstractListModel):
    ...
    def data(self, _, role=Qt.DisplayRole):
        if role == Qt.DisplayRole:
            ...
            return f"{__('preset')}: {self.method}"
...
class OWContinuize(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.disc_box, self.disc_view, self.disc_radios, self.disc_group = \
            create(__("categorical_variables"), DiscreteVariable, DiscreteOptions)
        ...
        self.cont_box, self.cont_view, self.cont_radios, self.cont_group = \
            create(__("numeric_variables"), ContinuousVariable, ContinuousOptions)
        ...
        gui.button(
            box, self, __("reset_all"), callback=self._on_reset_hints,
            autoDefault=False)
        gui.rubber(box)
