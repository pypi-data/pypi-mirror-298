...
class DefaultDiscModel(QAbstractListModel):
    ...
    def data(self, _, role=Qt.DisplayRole):
        if role == Qt.DisplayRole:
            return __("default_setting") + format_desc(self.hint)
        elif role == Qt.DecorationRole:
            return DefaultDiscModel.icon
        elif role == Qt.ToolTipRole:
            return __("default_setting")
        return None
...
class OWDiscretize(widget.OWWidget):
    ...
    class Inputs:
        data = Input("Data", Table, label=i18n.t("widget.data.data.common.data"), doc=i18n.t("widget.data.data.common.input_data_table"))

    class Outputs:
        data = Output("Data", Table, label=i18n.t("widget.data.data.common.data"), doc=i18n.t("widget.data.data.common.discretized_table"))
