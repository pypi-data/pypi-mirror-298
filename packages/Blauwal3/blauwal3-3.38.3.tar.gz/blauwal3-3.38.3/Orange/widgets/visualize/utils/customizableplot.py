...
class Updater:
    ...
    LINE_STYLES = {__("line.solid_line"): Qt.SolidLine,
                   __("line.dash_line"): Qt.DashLine,
                   __("line.dot_line"): Qt.DotLine,
                   __("line.dash_dot_line"): Qt.DashDotLine,
                   __("line.dash_dot_dot_line"): Qt.DashDotDotLine}
    DEFAULT_LINE_STYLE = __("line.solid_line")
