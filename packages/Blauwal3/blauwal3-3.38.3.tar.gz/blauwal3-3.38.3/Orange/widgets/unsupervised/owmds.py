...
class OWMDS(OWDataProjectionWidget, ConcurrentWidgetMixin):
    ...
    def _add_controls_optimization(self):
        ...
        box = gui.vBox(self.controlArea, box=i18n.t("common.general.optimize"), spacing=0)
        ...
        self.run_button = gui.button(None, self, __("row_refresh"), self._toggle_run)
        ...
        grid.addWidget(QLabel(__("row_refresh")), 1, 0)
        grid.addWidget(
            gui.comboBox(
            ...
            1, 1)
        self.stress_label = QLabel(__("row_kruskal"))
