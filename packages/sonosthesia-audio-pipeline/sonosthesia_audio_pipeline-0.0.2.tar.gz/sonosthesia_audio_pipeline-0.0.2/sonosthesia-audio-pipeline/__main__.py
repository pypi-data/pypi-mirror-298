...
from sonosthesia-audio-pipeline.analysis import configure_analysis_parser, ANALYSIS_DESCRIPTION
from sonosthesia-audio-pipeline.separation import configure_separation_parser, SEPARATION_DESCRIPTION
from sonosthesia-audio-pipeline.pipeline import configure_pipeline_parser, PIPELINE_DESCRIPTION
from sonosthesia-audio-pipeline.inspection import configure_inspection_parser, INSPECTION_DESCRIPTION
from sonosthesia-audio-pipeline.conversion import configure_conversion_parser, CONVERSION_DESCRIPTION
