...
class SearchTransform(_Middleware):
    ...
    def buffer(
        ...
        Args:
            ...
            distance_field (str): field in the properties of the feature that contains the distance to buffer the
                geometry
    ...
    def calculate_field(
        ...
        Args:
            ...
            fill_value: value to fill the new field with if the expression is not calculated. Defaults to None
