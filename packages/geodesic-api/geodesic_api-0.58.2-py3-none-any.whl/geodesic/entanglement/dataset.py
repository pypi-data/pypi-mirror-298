...
def new_union_dataset(
    ...
    **kwargs: dict,
    ...
    for dataset in datasets:
        if dataset.hash == "":
            raise ValueError(
                f"dataset {dataset.name} has no hash - please save before including in a view, union or join"
            )
...
class Dataset(Object):
    ...
    def view(
        ...
        **kwargs,
        ...
        if self.hash == "":
            raise ValueError(
                f"dataset {self.name} has no hash - please save before including in a view, union or join"
            )
