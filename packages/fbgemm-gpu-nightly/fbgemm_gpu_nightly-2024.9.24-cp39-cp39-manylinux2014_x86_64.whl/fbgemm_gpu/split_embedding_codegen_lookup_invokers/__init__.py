...
try:
    # Import is placed under a try-except bc the op is experimental and can be 
    # removed/updated in the future
    import fbgemm_gpu.split_embedding_codegen_lookup_invokers.lookup_ensemble_rowwise_adagrad as lookup_ensemble_rowwise_adagrad  # noqa: F401
except:
    warnings.warn(
        f"""\033[93m
        Failed to import: fbgemm_gpu.split_embedding_codegen_lookup_invokers.lookup_ensemble_rowwise_adagrad
        \033[0m""",
        DeprecationWarning,
    )
