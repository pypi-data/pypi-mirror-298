...
class PlayerDataSystem:
    ...
    def save_player_data(self, username: str, player_instance: Any, encryption: bool, attributes: Optional[List[str]] = None) -> None:
    ...
    def load_player_data(self, username: str, player_instance: Any, encryption: bool) -> None:
        global loaded_data
        try:
            path: str = f"players/{username}.json"
            if is_online():
...
class DataSystem:
    ...
    def save_data(self, key: str, value: Any, encryption: bool = False) -> None:
        ...
        try:
            ...
            if is_online():
                response_code = self.db.write_data(path, data.decode('utf-8'), message=f"Saved {key}")
    ...
    def save_offline_data(self, key: str, value: Any, encryption: bool) -> None:
