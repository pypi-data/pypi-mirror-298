...
class spaMint:
    ...
    spaMint is a python package for deciphering more accurate cell-cell interactions by modeling cells and their interactions
    ...
    def __init__(self, save_path = None, st_adata = None, weight = None, 
        ...
        - st_tp: Spatial transcriptomics type (default is 'st').
        """
