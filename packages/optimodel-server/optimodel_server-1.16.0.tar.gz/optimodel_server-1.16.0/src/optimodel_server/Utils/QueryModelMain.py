...
from optimodel_types import ModelMessage, QueryBody
            ...
            try:
                ...
                if response:
                    ...
                    queryResponse: MakeQueryResponse = {
                        ...
                        "cost": cost,
                        "provider": providerName,
                        "guardErrors": guardErrors if guardErrors else [],
                    }
                    ...
                    if postQueryGuards:
                        ...
                        if guardErrors:
                            queryResponse["guardErrors"].append(guardErrors)
