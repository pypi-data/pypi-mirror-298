...
'''G-E interaction analysis via neural network for scaler data input'''

pd.set_option('mode.chained_assignment', None)
def scaler_ge(data, ytype, dim_G, dim_E, haveGE, num_hidden_layers, nodes_hidden_layer,
    ...
    ScalerMCP_L2trainRes = scaler_mcp_l2train(x_train, clinical_train, interaction_train, y_train,
