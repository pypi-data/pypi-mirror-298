...
def select_model_capa():
    ...
    while True:
        screenshot_path = take_screenshot()
        field = find_target_position(screenshot_path, "077", 0, 140, 3)
...
def click_downloads():
    pyautogui.click(901, 344)
    time.sleep(2)
    pyautogui.click(1489, 451, clicks=2)
    time.sleep(2)

def search_xml(nfe):
    pyautogui.click(1534, 345)
    time.sleep(3)
    pyautogui.write(nfe)
    time.sleep(2)
    pyautogui.hotkey("enter")
    time.sleep(3)
    pyautogui.click(907, 497, clicks=2)
    time.sleep(3)
