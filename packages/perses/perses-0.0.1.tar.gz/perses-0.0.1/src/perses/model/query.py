...
class ArgusTimeSeriesQuerySpec(BaseModel):
    query: str
    datasource: Optional[DatasourceRef] = None
    user_func: Optional[str] = None


class ArgusTimeSeriesQuery(BaseModel):
    kind: Literal["ArgusTimeSeriesQuery"] = "ArgusTimeSeriesQuery"
    spec: ArgusTimeSeriesQuerySpec
...
TimeSeriesQueryPlugin = Annotated[Union[ArgusTimeSeriesQuery, PrometheusTimeSeriesQuery], Field(discriminator="kind")]
