...
def get_historical_data(symbol, start_date_str, end_date_str):
...
if __name__ == "__main__":
    ...
    # Convert datetime to string for API call
    start_date_str = start_date.strftime('%Y-%m-%d')
    end_date_str = end_date.strftime('%Y-%m-%d')
    
    print("\nHistorical Data:")
    historical_data = get_historical_data(symbol, start_date_str, end_date_str)
