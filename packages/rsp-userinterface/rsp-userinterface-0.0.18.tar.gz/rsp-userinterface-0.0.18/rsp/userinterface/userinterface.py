...
if __name__ == '__main__':
    import rsproduction.styling as styling
    import rsproduction.styling.color
else:
...
class UIElement():
    ...
    def __draw__(self, img):
        ...
        if self.__focusable__ and self.__is_focused__:
            img = cv.rectangle(img, (self.__px__ - self.__margin_inner__, self.__py__ - self.__margin_inner__), (self.__px__ + self.__w__ + self.__margin_inner__, self.__py__ + self.__h__ + self.__margin_inner__), color=styling.color.FOCUSED, thickness=1)

        # mouse over border
        if self.__focusable__ and self.__is_mouse_over__:
            img = cv.rectangle(img, (self.__px__ - self.__margin_outer__, self.__py__ - self.__margin_outer__), (self.__px__ + self.__w__ + self.__margin_outer__, self.__py__ + self.__h__ + self.__margin_outer__), color=styling.color.CORNFLOWER_BLUE, thickness=1)
...
class TextBox(UIElement):
    ...
    def __draw__(self, img):
        super().__draw__(img)
        img = cv.rectangle(img, (self.__px__, self.__py__), (self.__px__ + self.__w__, self.__py__ + self.__h__), color=styling.color.LIGHT_GRAY, thickness=1)
        ...
        if not self.__is_valid__:
            img = cv.rectangle(img, (self.__px__ - self.__margin_outer__, self.__py__ - self.__margin_outer__), (self.__px__ + self.__w__ + self.__margin_outer__, self.__py__ + self.__h__ + self.__margin_outer__), color=styling.color.DARKRED, thickness=1)
...
class ToggleSwitch(UIElement):
    ...
    def __draw__(self, img):
        ...
        # background
        img = cv.rectangle(img, (self.__px__ + self.__h__ // 2, self.__py__ + 4), (self.__px__ + self.__w__ - self.__h__ // 2, self.__py__ + self.__h__ - 4), color=styling.color.LIGHT_GRAY, thickness=-1)
        img = cv.circle(img, (self.__px__ + self.__h__ // 2, self.__py__ + self.__h__ // 2), radius=self.__h__ // 2 - 3, color=styling.color.LIGHT_GRAY, thickness=-1)
        img = cv.circle(img, (self.__px__ + self.__w__ - self.__h__ // 2, self.__py__ + self.__h__ // 2), radius=self.__h__ // 2 - 3, color=styling.color.LIGHT_GRAY, thickness=-1)

        # foreground
        if self.is_checked:
            img = cv.circle(img, (self.__px__ + self.__w__ - self.__h__ // 2, self.__py__ + self.__h__ // 2), radius=self.__h__ // 2, color=styling.color.CORNFLOWER_BLUE, thickness=-1)
        else:
            img = cv.circle(img, (self.__px__ + self.__h__ // 2, self.__py__ + self.__h__ // 2), radius=self.__h__ // 2, color=styling.color.DARK_GRAY, thickness=-1)
...
class Button(UIElement):
    ...
    def __draw__(self, img):
        ...
        img = cv.rectangle(img, (self.__px__, self.__py__), (self.__px__ + self.__w__, self.__py__ + self.__h__), styling.color.LIGHT_GRAY, thickness=-1)
        if self.is_checked:
            img = cv.rectangle(img, (self.__px__, self.__py__), (self.__px__ + self.__w__, self.__py__ + self.__h__), styling.color.LIGHT_GRAY, thickness=-1)
        
        img = cv.putText(img, self.label, (self.__px__ + self.__w__ // 2 - self.__fw__ // 2, self.__py__ + (self.__h__ - self.__fh__) // 2 + self.__fh__),\
                         cv.FONT_HERSHEY_SIMPLEX, fontScale=self.__fontScale__, color=styling.color.FOREGROUND if self.__is_enabled__ else styling.color.FOREGROUND_DISABLED)
        return img
