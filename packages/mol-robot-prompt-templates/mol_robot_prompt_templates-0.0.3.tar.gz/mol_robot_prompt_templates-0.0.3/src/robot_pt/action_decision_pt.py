...
def action_decision_pt(state_chunks: str) -> str:
    ...
    instruction_template = textwrap.dedent('''
        ...
        Output the character of the optimal action the robot should take among the following list of valid actions. Do not explain the reason for choosing the action's character. Only output the action's character.
