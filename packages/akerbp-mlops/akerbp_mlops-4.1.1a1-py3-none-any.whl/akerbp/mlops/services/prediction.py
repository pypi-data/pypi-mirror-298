...
try:
    ...
    raise Exception(
        f"Something failed when trying to import your model's code with your defined settings: Settings: {c.__dict__} CWD: {Path.cwd()}, Directory contents: {Path.cwd().rglob('*')}"
    ) from e
