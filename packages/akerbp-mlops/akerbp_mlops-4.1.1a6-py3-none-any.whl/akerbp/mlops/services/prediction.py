...
try:
    ...
    raise Exception(
        f"Something failed when trying to import your model's code with your defined settings: Settings: {settings_dataclass}, CWD: {Path.cwd()}, Directory contents: {list(Path.cwd().rglob('*'))}"
    ) from e
