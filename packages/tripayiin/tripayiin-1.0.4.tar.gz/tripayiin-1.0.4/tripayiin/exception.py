...
class MerchantCodeError(Exception):
    def __init__(self, message: str = ""):
        super().__init__(f"Merchant Code is required for this operation {message}")


class SandboxModeError(Exception):
    def __init__(self):
        super().__init__("You can't use this method in sandbox mode")
