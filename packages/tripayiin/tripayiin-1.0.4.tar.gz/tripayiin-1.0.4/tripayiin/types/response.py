...
class Response:
    def __init__(self, **kwargs):
        ...
        self.pagination: Union[Union[dict, list], None] = kwargs.get("pagination", None)

    def __repr__(self):
        return f"Response(success={self.success}, message={self.message}, data={self.data}, pagination={self.pagination})"
