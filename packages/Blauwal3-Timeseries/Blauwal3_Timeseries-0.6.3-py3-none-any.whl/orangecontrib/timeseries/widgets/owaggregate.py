...
#
#     agg_interval = settings.Setting(i18n.t('timeseries.adddesc.day'))
#     autocommit = settings.Setting(False)
#
#     AGG_TIME = OrderedDict((
#         (i18n.t('timeseries.adddesc.second'), lambda date: date.replace(microsecond=0)),
#         (i18n.t('timeseries.adddesc.minute'), lambda date: date.replace(second=0, microsecond=0)),
#         (i18n.t('timeseries.adddesc.hour'), lambda date: date.replace(minute=0, second=0, microsecond=0)),
#         (i18n.t('timeseries.adddesc.day'), lambda date: date.replace(hour=0, minute=0, second=0, microsecond=0)),
#         (i18n.t('timeseries.adddesc.week'), lambda date: date.strptime(date.strftime('%Y-W%W-0'), '%Y-W%W-%w')),
#         # Doesn't work for years before 1000
#         (i18n.t('timeseries.adddesc.month'), lambda date: date.replace(day=1, hour=0, minute=0, second=0, microsecond=0)),
#         (i18n.t('timeseries.adddesc.year'), lambda date: date.replace(month=1, day=1, hour=0, minute=0, second=0, microsecond=0)),
#     ))
#
