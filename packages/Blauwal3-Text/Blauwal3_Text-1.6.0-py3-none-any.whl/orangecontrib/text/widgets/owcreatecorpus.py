...
def __(key):
    return i18n.t('text.owcreatecorpus.' + key)
...
class DocumentEditor(QGroupBox):
    ...
    def __init__(self, title, text, parent=None):
        ...
        self.title_le.setPlaceholderText(__("box.document_title"))
        ...
        self.text_area.setPlaceholderText(__("box.document_text"))
...
class OWCreateCorpus(OWWidget):
    ...
    def __init__(self):
        ...
        add_btn = gui.button(
            self.buttonsArea, self, __("box.add_document"), self._add_new_editor
        )
