...
STATISTICS = [
    (__("gbox.word_count"), words_count, None, (Sources.DOCUMENTS,)),
    (__("gbox.character_count"), characters_count, None, (Sources.DOCUMENTS,)),
    (__("gbox.n_gram_count"), n_gram_count, None, (Sources.DOCUMENTS,)),
    (__("gbox.average_word_length"), average_word_len, None, (Sources.DOCUMENTS,)),
    (__("gbox.punctuation_count"), punctuation_count, None, (Sources.DOCUMENTS,)),
    (__("gbox.capital_count"), capital_count, None, (Sources.DOCUMENTS,)),
    (__("gbox.vowel_count"), vowel_count, "a,e,i,o,u", (Sources.DOCUMENTS,)),
    (__("gbox.consonant_count"), consonant_count, "b,c,d,f,g,h,j,k,l,m,n,p,q,r,s,t,v,w,x,y,z", (Sources.DOCUMENTS,)),
    (__("gbox.per_cent_unique_word"), per_cent_unique_words, None, (Sources.TOKENS,)),
    (__("gbox.start_with"), starts_with, "", (Sources.TOKENS,)),
    (__("gbox.end_with"), ends_with, "", (Sources.TOKENS,)),
    (__("gbox.contain"), contains, "", (Sources.DOCUMENTS, Sources.TOKENS)),
    (__("gbox.regex"), regex, "", (Sources.DOCUMENTS, Sources.TOKENS)),
    (__("gbox.pos_tag"), pos_tags, "NN,VV,JJ", (Sources.TOKENS,)),
    (__("gbox.yule"), yule, None, (Sources.TOKENS,)),
    (__("gbox.lix"), lix, None, (Sources.TOKENS,)),
]
...
class OWStatistics(OWWidget, ConcurrentWidgetMixin):
    ...
    def _init_controls(self) -> None:
        ...
        gui.button(self.buttonsArea, self,  __("btn_apply"), callback=self.apply)
    ...
    def _init_statistics_box(self) -> None:
        ...
        grid.addWidget(QLabel(__("row_feature")), 0, 1)
        grid.addWidget(QLabel(__("row_pattern")), 0, 2)
        grid.addWidget(QLabel(__("compute_for")), 0, 3)
