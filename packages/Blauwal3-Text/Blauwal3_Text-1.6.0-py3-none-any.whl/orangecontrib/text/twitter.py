...
METAS = [
    ...
    (partial(DiscreteVariable, __("language")), lambda doc, _, __: doc.lang),
    (partial(DiscreteVariable, __("location")), country_code),
    (
        partial(ContinuousVariable, __("likes"), number_of_decimals=0),
        lambda doc, _, __: doc.public_metrics["like_count"],
    ),
    (
        partial(ContinuousVariable, __("retweets"), number_of_decimals=0),
        lambda doc, _, __: doc.public_metrics["retweet_count"],
    ),
    (
        partial(DiscreteVariable, __("reply_to")),
        lambda doc, users, _: "@" + users[doc.in_reply_to_user_id].username
        if doc.in_reply_to_user_id and doc.in_reply_to_user_id in users
        else "",
    ),
    (
        partial(DiscreteVariable, __("author.name")),
        lambda doc, users, __: users[doc.author_id].name,
    ),
    (
        partial(StringVariable, __("author.description")),
        lambda doc, users, _: users[doc.author_id].description,
    ),
    (
        partial(ContinuousVariable, __("author.tweet_count"), number_of_decimals=0),
        lambda doc, users, _: users[doc.author_id].public_metrics["tweet_count"],
    ),
    (
        partial(ContinuousVariable, __("author.following_count"), number_of_decimals=0),
        lambda doc, users, _: users[doc.author_id].public_metrics["following_count"],
    ),
    (
        partial(ContinuousVariable, __("author.followers_count"), number_of_decimals=0),
        lambda doc, users, _: users[doc.author_id].public_metrics["followers_count"],
    ),
    (
        partial(ContinuousVariable, __("author.listed_count"), number_of_decimals=0),
        lambda doc, users, _: users[doc.author_id].public_metrics["listed_count"],
    ),
    (
        partial(DiscreteVariable, __("author.verified")),
        lambda doc, users, _: str(users[doc.author_id].verified),
    ),
    (partial(ContinuousVariable, __("longitude")), partial(coordinates, dim=0)),
    (partial(ContinuousVariable, __("latitude")), partial(coordinates, dim=1)),
]
