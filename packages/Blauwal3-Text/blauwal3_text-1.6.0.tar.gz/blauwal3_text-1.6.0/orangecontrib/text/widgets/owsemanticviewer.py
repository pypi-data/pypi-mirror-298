...
def __(key):
    return i18n.t('text.owsemanticviewer.' + key)
...
class DisplayDocument:
    ...
    ITEMS = [__("document"), __("section"), __("sentence")]
...
class OWSemanticViewer(OWWidget, ConcurrentWidgetMixin):
    ...
    def _setup_gui(self):
        # Control area
        box = gui.hBox(self.controlArea, __("filtering"))
        ...
        box = gui.hBox(self.controlArea, __("display"))
    ...
    def _list_documents(self):
        ...
        model.setHorizontalHeaderLabels([__("match"), __("score"), __("socument")])
