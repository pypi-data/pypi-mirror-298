...
class TheGuardianAPI:
    ...
    metas = [
        (partial(StringVariable,__('headline')), lambda doc: doc["fields"]["headline"]),
        (partial(StringVariable,__('content')), lambda doc: doc["fields"]["bodyText"]),
        (partial(StringVariable,__('trail_text')), lambda doc: doc["fields"]["trailText"]),
        (partial(StringVariable,__('html')), lambda doc: doc["fields"]["body"]),
        (
            partial(TimeVariable, __("publication_date"), have_time=1, have_date=1),
            lambda doc: isoparse(doc["webPublicationDate"]).timestamp(),
        ),
        (partial(DiscreteVariable,__('type')), lambda doc: doc["type"]),
        (partial(DiscreteVariable,__('language')), lambda doc: doc["fields"]["lang"]),
        (
            partial(StringVariable,__('tags')),
    ...
    text_features = [__('headline'), __('content')]  #
