...
`).map(function(i,o){return t.jsx("div",{children:i},Math.random())});return e}return typeof e=="object"&&e.type?t.jsx(x,{data:e}):typeof e=="object"&&Array.isArray(e)?e.length==0?"-":typeof e[0]=="object"&&e[0].type!=null?t.jsx(t.Fragment,{children:e.map(function(i){return t.jsx(x,{data:i},Math.random())})}):t.jsx("ul",{style:{padding:0,marginLeft:17},children:e.map(function(i){return t.jsx("li",{children:i},Math.random())})}):typeof e=="object"&&JSON.stringify(Object.keys(e))==JSON.stringify(["id","text"])?e.text:JSON.stringify(e)}function ce(){document.querySelector(".layer")==null&&P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(Oe,{}))}function we(e,n){se(),ce(),window.reloader=n;for(var a=document.getElementsByTagName("dialog"),r=0;r<a.length;r++)a[r].style.display="none";P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(_e,{url:O(e)}))}function Ae(e){se(),ce(),P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(Fe,{url:O(e)}))}function J(e){e!=null&&showMessage(e);for(var n=document.getElementsByTagName("dialog"),a=0;a<n.length;a++)if(a==n.length-1){var r=n[a];r.close(),r.classList.remove("opened"),r.remove(),a==0?(document.querySelector(".layer").style.display="none",window.reloader&&window.reloader()):n[a-1].style.display="block"}}function Re(e){se(),ce(),P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(We,{actions:e}))}function Oe(e){const n={backgroundColor:"black",bottom:0,left:0,position:"fixed",right:0,top:0,opacity:.7,display:"none"};return t.jsx("div",{className:"layer",onClick:function(){J()},style:n})}function _e(e){const[n,a]=N.useState(null),[r,i]=N.useState(0);N.useEffect(()=>{o(O(e.url)),document.querySelector(".layer").style.display="block"},[]);function o(s){B("GET",O(s),function(u){a(u),i(r+1)})}function d(){const s={maxWidth:800},u={textAlign:"right",cursor:"pointer",marginTop:-15};if(n)return t.jsxs("div",{style:s,children:[t.jsx("div",{style:u,children:t.jsx(E,{icon:"x",onClick:()=>J()})}),t.jsx(x,{data:n})]})}const c={minWidth:window.innerWidth<800?"calc(100% - 60px)":800,display:n?"block":"none",maxWidth:800,top:window.scrollY+40,border:0};return t.jsx("dialog",{style:c,children:d()},r)}function Fe(e){var n=Math.random();N.useEffect(()=>{document.querySelector(".layer").style.display="block";var r=document.getElementById(n);r.style.top=document.documentElement.scrollTop+100},[]);function a(){const r={minWidth:window.innerWidth<800?"calc(100% - 60px)":800,display:"block",maxWidth:800,top:window.scrollY+40,border:0},i={float:"right",cursor:"pointer",marginTop:-20};return t.jsxs("dialog",{style:r,id:n,children:[t.jsx("div",{style:i,children:t.jsx(E,{icon:"x",onClick:()=>J()})}),t.jsx("iframe",{src:O(e.url),width:"100%",height:500,style:{border:0}})]})}return a()}function We(e){const n=Math.random();N.useEffect(()=>{document.querySelector(".layer").style.display="block"},[]);function a(){const o={width:"100%",borderBottom:"solid 1px #DDDD",padding:20};return t.jsx("div",{align:"center",style:{},children:e.actions.map(function(d){return t.jsx("div",{style:o,onClick:r,children:t.jsx(W,{data:d,strech:!0})},Math.random())})})}function r(){const o=document.getElementById(n);o.close(),o.classList.remove("opened"),o.remove(),document.querySelector(".layer").style.display="none"}const i={width:"auto",display:"block",position:"fixed",bottom:0,border:0,padding:0};return t.jsx("dialog",{id:n,style:i,children:a()})}function I(e){return e!=null&&(e=e.toString().replace("-","").normalize("NFD").replace("_","").toLowerCase()),e}const xe={};function A(e){let n="",a=window.document.styleSheets[0];e.split("}").forEach(r=>{let i=(r+"}").replace(/\r?\n|\r/g,"");n=n===""?i:n+i,n.split("{").length===n.split("}").length&&xe[n]==null&&(a.insertRule(n,a.cssRules.length),n="",xe[n]=!0)})}function W(e){const n=e.id||Math.random(),[a,r]=N.useState(e.data.name);function i(c){c.preventDefault();var s=e.data.url;e.data.urlfunc&&(s=e.data.urlfunc()),e.onClick?(a&&r("Aguarde...."),e.onClick(c)):e.data.modal==!1?window.load(V(s)):we(s)}function o(){return e.strech?e.data.name:e.data.icon?e.compact||!e.data.name||window.innerWidth<800?t.jsx(E,{icon:e.data.icon}):t.jsxs(t.Fragment,{children:[t.jsx(E,{icon:e.data.icon,style:{paddingRight:10}}),e.data.name||""]}):e.data.name}function d(){A(`
  ...
  `);function i(){return t.jsx(ke,{data:a})}function o(){const u={backgroundColor:"white",padding:15,marginBottom:15};return t.jsx("div",{style:u,children:d()})}function d(){return Array.isArray(a.data)?a.data.length==0?t.jsx("div",{children:"Nenhum registro encontrado."}):a.data.map(function(u){return Array.isArray(u)?t.jsx(Y,{width:300,children:u.map(l=>t.jsx(Q,{data:l,width:100/u.length},Math.random()))},Math.random()):t.jsx("div",{children:t.jsx(Q,{data:u,width:100})},Math.random())}):t.jsx(x,{data:a.data})}function c(u){B("GET",u,function(l){r(l)})}function s(){return e.data.url?(window[n]=()=>c(e.data.url),t.jsxs("div",{className:e.data.url?"reloadable object-fieldset":"object-fieldset",id:n,children:[i(),o()]})):t.jsxs("div",{className:"object-fieldset",children:[i(),o()]})}return s()}function Ye(e){const n=Math.random(),[a,r]=N.useState(e.data.actions);function i(){const c=e.data.url.indexOf("?")<0?"?":"&";return e.data.url+c+"only=actions"}function o(){B("GET",i(),function(c){r(c)})}function d(){return window[n]=()=>o(),t.jsx("div",{className:"reloadable",id:n,children:a.map(function(c){return t.jsx(W,{data:c,default:!0},Math.random())})})}return d()}function Ve(e){function n(){A(`
    ...
    `);function n(){return t.jsxs("div",{className:"fieldset-title",children:[e.data.title&&t.jsx("h2",{"data-label":I(e.data.title),children:e.data.title}),e.data.actions&&e.data.actions.length>0&&t.jsx("div",{children:e.data.actions.map(function(a){return t.jsx(W,{data:a,default:!0},Math.random())})})]})}return n()}function Xe(e){function n(){return t.jsx(Ve,{data:e.data})}function a(){return e.data.data.map(function(i,o){return t.jsx(x,{data:i},Math.random())})}function r(){return t.jsxs("div",{className:"object-viewer",children:[n(),a()]})}return r()}function $e(e){function n(){return t.jsx(ke,{data:e.data})}function a(){const i={backgroundColor:"white"};return e.data.data.map(function(o,d){return t.jsx("div",{style:i,children:t.jsx(x,{data:o},Math.random())},Math.random())})}function r(){return t.jsxs(t.Fragment,{children:[n(),a()]})}return r()}function Je(e){A(`
  ...
  `);const[n,a]=N.useState(0);function r(){return t.jsx("div",{className:"noscroll",style:{display:"inline-block",textAlign:"center",width:"100%",margin:"auto",marginBottom:20,overflowX:"auto"},children:e.data.map(function(i,o){return t.jsx(F,{href:i.url,style:{padding:5,fontWeight:n==o?"bold":"normal",borderBottom:n==o?"solid 3px #2670e8":"solid 3px inherite",textDecoration:"none",color:"#0c326f",margin:15},onClick:function(d){d.preventDefault(),a(o),e.loadContent(i.url)},dataLabel:I(i.title),children:i.title},Math.random())})})}return r()}function Qe(e){var n=Math.random();const[a,r]=N.useState(e.data.data[0]);function i(){return e.data.title!="Top"&&t.jsx("h2",{"data-label":I(e.data.title),children:e.data.title})}function o(){return t.jsx(ie,{data:e.data.actions})}function d(){return t.jsx(Je,{data:e.data.data,loadContent:u})}function c(){var m={...a};m.title=null;const f={padding:0};return t.jsx("div",{style:f,children:t.jsx(x,{data:m},Math.random())})}function s(){const m={width:"50%",margin:"auto",border:"solid 0.5px #DDD",marginTop:30,marginBottom:30};return t.jsx("div",{style:m})}function u(m){B("GET",m,function(f){r(f)})}function l(){return window[n]=()=>u(a.url),e.data.data.length>0&&t.jsxs("div",{className:"reloadable",id:n,children:[i(),o(),d(),c(),s()]})}return l()}function Ze(){document.querySelectorAll(".reloadable").forEach(function(e){window[e.id]()})}function _({id:e,onClick:n,icon:a,label:r,display:i,primary:o,compact:d,spin:c}){function s(){return a?d||!r?t.jsx(E,{icon:a}):t.jsxs(t.Fragment,{children:[t.jsx(De,{style:{marginRight:10,display:"none"}}),t.jsx(E,{icon:a,style:{marginRight:10}}),r||""]}):r}function u(){A(`
      .button{
        padding: 12px;
        text-decoration: none;
        white-space: nowrap;
