...
urlpatterns += i18n_patterns(
    ...
    path("", include("apps.accounts.urls")),            # UI Kits Html files
    path("", include("apps.account_settings.urls")),            # UI Kits Html files
    path("", include("apps.invites.urls")),            # UI Kits Html files
    path("", include("apps.tenant.urls")),            # UI Kits Html files
    path("", include("apps.tenant_settings.urls")),            # UI Kits Html files
