...
def __(key):
    return i18n.t('explain.explainer.' + key)

RGB_LOW = [0, 137, 229]
RGB_HIGH = [255, 0, 66]

SIMILARITY_ORDER = __("order_instances_by_similarity")
ORIGINAL_ORDER = __("original_instance_ordering")
OUTPUT_ORDER = __("order_instances_by_output_value")
