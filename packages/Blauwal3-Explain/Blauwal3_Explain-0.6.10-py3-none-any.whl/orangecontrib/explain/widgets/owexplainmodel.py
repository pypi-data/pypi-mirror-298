...
def __(key):
    return i18n.t('explain.owexplainmodel.' + key)
...
class OWExplainModel(OWExplainFeatureBase):
    ...
    def _add_controls(self):
        ...
        super()._add_controls()
        gui.checkBox(self.display_box, self, "show_legend", __("show_legend"),
    ...
    def update_scene(self):
        ...
        if self.results is not None:
            ...
            indices = np.argsort(scores_x)[::-1].astype(int)  # 确保 indices 是整数类型
