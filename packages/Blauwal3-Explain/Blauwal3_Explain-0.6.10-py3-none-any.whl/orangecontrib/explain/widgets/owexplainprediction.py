...
def __(key):
    return i18n.t('explain.owexplainprediction.' + key)
...
class OWExplainPrediction(OWWidget, ConcurrentWidgetMixin):
    ...
    def _add_controls(self):
        ...
        box = gui.hBox(self.controlArea, __("zoom"))
        ...
        box = gui.vBox(self.buttonsArea, __("prediction_info"))
        gui.label(box, self, "%(mo_info)s")
        bv_label = gui.label(box, self, "%(bv_info)s")  # type: QLabel
        bv_label.setToolTip(__("average_prediction"))
