...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in yandex/cloud/priv/iam/v1/transitional/policy_service_pb2_grpc.py depends on'
...
def add_PolicyServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('yandex.cloud.priv.iam.v1.transitional.PolicyService', rpc_method_handlers)
