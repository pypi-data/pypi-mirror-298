...
class RPCClient:
    ...
    def rpc_call(self, method=method,params=None,jsonrpc=None,id=None,headers=None,get_post="POST",endpoint=None, status_code=False, raw_response=False, response_result=None, load_nested_json=True):
        """
