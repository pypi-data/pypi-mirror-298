...
class OWPolynomialRegression(OWBaseLearner):
    ...
    class Outputs(OWBaseLearner.Outputs):
        coefficients = Output("Coefficients", Table, explicit=True, label=i18n.t("educational.common.coefficient"))
        data = Output("Data", Table, explicit=True,label=i18n.t("educational.common.data"))
