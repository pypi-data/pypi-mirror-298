...
class OrganizationMemberServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListOrganizationMembersByOrganizationId = channel.unary_unary(
                '/com.terraquantum.organization.v1.organization.OrganizationMemberService/ListOrganizationMembersByOrganizationId',
...
class OrganizationMemberServiceServicer(object):
    ...
    def ListOrganizationMembersByOrganizationId(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_OrganizationMemberServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListOrganizationMembersByOrganizationId': grpc.unary_unary_rpc_method_handler(
                    servicer.ListOrganizationMembersByOrganizationId,
...
class OrganizationMemberService(object):
    ...
    @staticmethod
    def ListOrganizationMembersByOrganizationId(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/ListOrganizationMembersByOrganizationId',
