...
.. image:: https://img.shields.io/gitlab/pipeline-status/jsonrpc/jsonrpc-py?branch=development&logo=gitlab&style=flat-square
  :target: https://gitlab.com/jsonrpc/jsonrpc-py
  :alt: pipeline status

.. image:: https://img.shields.io/gitlab/pipeline-coverage/jsonrpc/jsonrpc-py?branch=development&logo=gitlab&style=flat-square
  :target: https://gitlab.com/jsonrpc/jsonrpc-py
  :alt: coverage report
