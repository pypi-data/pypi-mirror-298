...
def handle_base64_input(base64_data, output_folder):
    try:
        ...
        extract_embedded_files(temp_pdf_path, output_folder)

    except Exception as e:
        print(f"Error handling Base64 input: {e}")

def handle_base64_file(base64_file_path, output_folder):
    try:
        with open(base64_file_path, 'r') as file:
            ...
            handle_base64_input(base64_data, output_folder)
...
def main():
    ...
    parser.add_argument("--output_folder", help="Folder to save the extracted XML files and normal PDF.", required=True)
    ...
    if args.pdf_path:
        ...
        handle_base64_input(args.base64, args.output_folder)
    elif args.base64_file:
        handle_base64_file(args.base64_file, args.output_folder)
    else:
