...
# jmod.translate
tasks = [""]
features = ['Login','calc','agecalc','gettime','getdate','getday','createfile','appendfile','writefile','deletefile','readfile','dbsearch','dbedit','rps','createtodolist','addtask','checkofftask','deletetask','opentodolist','fileconvert','translate']
###########################################help###
def help():
