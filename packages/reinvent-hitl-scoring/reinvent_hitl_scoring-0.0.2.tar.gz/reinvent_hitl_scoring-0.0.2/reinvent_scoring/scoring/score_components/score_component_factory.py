...
from reinvent_scoring.scoring.score_components import TanimotoSimilarity, \
    ...
    GroupCount, BuildingBlockAvailabilityComponent, TorchQSARComponent, EnsembleHumanComponent
from reinvent_scoring.scoring.score_components.console_invoked import Icolos, Chemaxon, MMP
...
class ScoreComponentFactory:
    ...
    def _deafult_scoring_component_registry(self) -> dict:
        ...
        component_map = {
            enum.ENSEMBLE_HUMAN: EnsembleHumanComponent,
            enum.TORCH_QSAR: TorchQSARComponent,
