...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, tls_validation=None, name=None, max_retries=None, hidden_fields=None, url=None, proxy_url=None, pulp_last_updated=None, ca_cert=None, pulp_href=None, headers=None, sock_read_timeout=None, rate_limit=None, sock_connect_timeout=None, connect_timeout=None, pulp_created=None, total_timeout=None, pulp_labels=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
