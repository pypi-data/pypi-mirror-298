...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, client_key=None, tls_validation=None, username=None, name=None, max_retries=None, password=None, url=None, proxy_url=None, ca_cert=None, headers=None, sock_read_timeout=None, proxy_username=None, rate_limit=None, sock_connect_timeout=None, connect_timeout=None, total_timeout=None, proxy_password=None, pulp_labels=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
