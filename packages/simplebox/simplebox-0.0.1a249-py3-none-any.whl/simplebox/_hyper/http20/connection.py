...
"""
from ..._h2 import connection, settings
from ..._h2 import events as h2_events
...
class HTTP20Connection(object):
    ...
    def __init_state(self):
        ...
        objects themselves.
        """
        self._conn = _LockedObject(connection.H2Connection())
    ...
    def _connect_upgrade(self, sock):
        ...
        with self._conn as conn:
            ...
            conn.update_settings(
                {settings.ENABLE_PUSH: int(self._enable_push)}
            )
        self._send_outstanding_data()
