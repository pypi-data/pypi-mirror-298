...
def overlay_image(base_image_path, overlay_image_path, overlay_area_percentage, margin_top_percentage, margin_right_percentage, output_subdir):
    ...
    # Calculate the top and right margins (percentage of the base image size)
    margin_right = int(base_width * (margin_right_percentage / 100))
    margin_top = int(base_height * (margin_top_percentage / 100))
    ...
    overlay_y = margin_top  # Set position based on margin_top for the top offset
...
def process_images(input_dir, overlay_image_path, overlay_area_percentage, margin_top_percentage, margin_right_percentage, output_dir):
    ...
    for filename in file_list:
        ...
        try:
            ...
            overlay_image(image_path, overlay_image_path, overlay_area_percentage, margin_top_percentage, margin_right_percentage, output_subdir)
...
def main():
    ...
    while True:
        try:
            margin_top_percentage = float(input("Enter the top margin size as a percentage of the base image height (0-100): "))
            if 0 <= margin_top_percentage <= 100:
                break
            else:
                print("Please enter a number between 0 and 100.")
        except ValueError:
    ...
    while True:
        try:
            margin_right_percentage = float(input("Enter the right margin size as a percentage of the base image width (0-100): "))
            if 0 <= margin_right_percentage <= 100:
                break
            else:
                print("Please enter a number between 0 and 100.")
        except ValueError:
    ...
    process_images(input_dir, overlay_image_path, overlay_area_percentage, margin_top_percentage, margin_right_percentage, output_dir)
