...
def item_name(index):  # type: (QModelIndex) -> str
    value = index.data(257)
    if value is None:
        return ""
    else:
...
class WidgetToolBox(ToolBox):
    ...
    def __init__(self, parent=None):
        ...
        self.__filterEdit = QLineEdit(
            ...
            toolTip=self.tr(__("placeholder.filter_tip")),
        ...
        open_all = QAction(self.tr(__("edit.open_all")), self)
        open_all.triggered.connect(self.openAllTabs)
        close_all = QAction(self.tr(__("edit.close_all")), self)
