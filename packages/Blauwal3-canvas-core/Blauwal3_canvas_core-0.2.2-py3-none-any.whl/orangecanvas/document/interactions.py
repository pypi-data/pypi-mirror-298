...
class NewLinkAction(UserInteraction):
    ...
    def mousePressEvent(self, event):
        ...
        if anchor_item is not None and event.button() == Qt.LeftButton:
            ...
            event.accept()
            self.postQuickTip(
                self.tr(__("tip.create_link")+__("tip.create_link_detail")
...
class NewArrowAnnotation(UserInteraction):
    ...
    def start(self):
        ...
        self.postQuickTip(
            self.tr(__("tip.new_arrow")+__('tip.new_arrow_annotation')
...
class NewTextAnnotation(UserInteraction):
    ...
    def start(self):
        ...
        self.document.view().setCursor(Qt.CrossCursor)
        self.postQuickTip(
            self.tr(__("tip.text_annotation")+__("tip.text_annotation_way")
