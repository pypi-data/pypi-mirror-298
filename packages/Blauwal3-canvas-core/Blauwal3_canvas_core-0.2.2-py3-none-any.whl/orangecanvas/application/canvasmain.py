...
from ..registry import WidgetRegistry, WidgetDescription, CategoryDescription, set_global_registry, set_style_sheet
...
class CanvasMainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__document_title = _("noun.untitled")
    ...
    def setup_actions(self):
        ...
        self.save_as_svg_action = QAction(
            self.tr(_("file.save_as_svg")), self,
            objectName="action-save-to-svg.",
            toolTip=self.tr(_("file.save_as_svg")),
    ...
    def setup_menu(self):
        ...
        self.window_menu = QMenu(
            self.tr(_("menu.window")), menu_bar, objectName="window-menu"
        )
    ...
    def __update_window_title(self):
        ...
        if path:
            ...
            self.setWindowTitle(self.tr(_("noun.untitled"))+"[*]")
        ...
        if requires:
            ...
            mb = QMessageBox(
                ...
                standardButtons=QMessageBox.Ok | QMessageBox.Abort |
                                QMessageBox.Ignore,
                informativeText=(_("msg.install_informativeText")),
            )
            ...
            bignore.setText(_("tip.bignore"))
            abort_btn = mb.button(QMessageBox.Abort)
            abort_btn.setText(_("tip.abort"))
            mb.setWindowModality(Qt.WindowModal)
    ...
    def save_scheme_as(self):
        ...
        dialog = QFileDialog(
            self,
            windowTitle=self.tr(_("workflow.save_file")),
            directory=start_dir,
...
def scheme_requires(
    ...
    for name in data:
        if name.startswith('Orange3'):
            names.append(name.replace('Orange3', 'Blauwal3'))
        else:
            names.append(name)
    return names
