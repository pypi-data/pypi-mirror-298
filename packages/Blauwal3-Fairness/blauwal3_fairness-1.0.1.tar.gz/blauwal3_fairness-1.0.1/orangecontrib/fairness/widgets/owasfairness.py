...
def __(key):
    return i18n.t('fairness.owasfairness.' + key)
...
class OWAsFairness(OWWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        box = gui.vBox(self.controlArea, __("favorable_class_value"), margin=0)
        gui.comboBox(
            box,
            self,
        ...
        box = gui.vBox(self.controlArea, __("protected_attribute"), margin=0)
        gui.comboBox(
            box,
            self,
            "protected_attribute",
        ...
        box = gui.vBox(
            self.controlArea, __("privileged_pa_values"), margin=0
        )
