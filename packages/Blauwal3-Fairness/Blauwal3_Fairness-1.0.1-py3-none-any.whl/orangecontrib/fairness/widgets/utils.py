...
def __(key):
    return i18n.t('utils.' + key)

MISSING_FAIRNESS_ATTRIBUTES: str = __(
    "missing_fairness_attributes"
)

MISSING_VALUES: str = __(
    "missing_values"
)

MISSING_CLASS_VARIABLE: str = __(
    "missing_class_variable"
)

NUMERICAL_CLASS_VARIABLE: str = __(
    "numerical_class_variable"
)


NO_CATEGORICAL_ATTRIBUTES: str = __(
    "no_categorical_attributes"
)

REWEIGHING_PREPROCESSOR: str = __(
    "reweighing_preprocessor"
)


REWEIGHTED_DATA: str = __(
    "reweighted_data"
)

TENSORFLOW_NOT_INSTALLED: str = __(
