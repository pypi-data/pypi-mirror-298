...
class SensorManager:
    ...
    def compile_sensors_for_auto_collection(self, current_time):
        ...
        sensor_queue = [
            ...
            if (details['collection_mode'] != "Manual") and (current_time >= (details['last_collection_time'] + (details['interval'] * 60) - 2)) # Minus 2 seconds to provide leeway for if script starts slightly quicker
        ]
        return sensor_queue
