from PyQt5.QtCore import Qt, QUrl, QPoint, QRectF, QLineF, QPointF, QObject, QPropertyAnimation, QSizeF
from PyQt5.QtPrintSupport import QPrinter, QPrintEngine
from PyQt5.QtWidgets import QDialog, QVBoxLayout, QLabel, QGridLayout, QPushButton, QSpacerItem, QSizePolicy, QApplication, QMessageBox
...
from PyQt5.QtGui import QIcon, QPixmap, QDesktopServices, QFont, QColor, QPainter, QPen, QBrush, QPainterPath, QPolygonF
...
# def render_editor_to_image(widget, file_path):
#     # 创建一个QPrinter对象
#     printer = QPrinter(QPrinter.ScreenResolution)
#
#     # 设置打印范围为整个文档
#     printer.setPaperSize(QSizeF(widget.viewport().size()), QPrinter.DevicePixel)
#     printer.setFullPage(True)
#
#     # 创建一个QPainter对象
#     painter = QPainter(printer)
#
#     # 将QTextEdit的内容偏移到正确的位置
#     # 因为QPrinter的原点在左上角，而QTextEdit的原点可能不是
#     painter.translate(-widget.contentOffsets())
#
#     # 渲染整个文档
#     widget.document().print_(painter)
#
#     # 结束绘制
#     painter.end()
#
...
#     printer.printEngine().print(printer, "Rendering QTextEdit to Image")
