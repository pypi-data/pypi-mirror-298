...
def scan(
    ...
    summary_statistics["Total Time (seconds)"] = perf_counter()
    ...
    summary_statistics["Total Files"] = len(files.values())
    summary_statistics["Ignored Files"] = files.get_total_ignored_files_count()
    summary_statistics["Duplicate Files"] = files.get_duplicate_files_count()
    summary_statistics["Duplicate Groups"] = files.get_duplicate_groups()
    summary_statistics["Total Size (duplicates)"] = naturalsize(files.get_total_duplicate_file_size())
    summary_statistics["Total Size (all files)"] = naturalsize(files.get_total_file_size())
