...
from duple.library import get_available_hashes, gen_test_files, get_hash
...
def scan(
    ...
    if chunksize < 2:
        click.secho("chunksize too low, setting to default of 2")
        chunksize = 2
...
def make_test_files(test_path: Path, numdirs: int, numfiles: int, max_file_size: int):
    ...
    """
    gen_test_files(test_path=test_path, numdirs=numdirs, numfiles=numfiles, max_file_size=max_file_size)
