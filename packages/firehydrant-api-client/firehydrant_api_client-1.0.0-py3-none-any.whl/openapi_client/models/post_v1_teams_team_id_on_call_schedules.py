...
class PostV1TeamsTeamIdOnCallSchedules(BaseModel):
    """
    Create a Signals on-call schedule for a team.
    """ # noqa: E501
    name: StrictStr = Field(description="The on-call schedule's name.")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the on-call schedule.")
    time_zone: StrictStr = Field(description="The time zone in which the on-call schedule operates. This value must be a valid IANA time zone name.")
    ...
    strategy: PostV1TeamsTeamIdOnCallSchedulesStrategy
    ...
    start_time: Optional[StrictStr] = Field(default=None, description="An ISO8601 time string specifying when the schedule's first shift should start. This value is only used if the schedule's strategy is \"custom\".")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "time_zone", "member_ids", "slack_user_group_id", "strategy", "restrictions", "start_time", "color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1TeamsTeamIdOnCallSchedules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1TeamsTeamIdOnCallSchedules from a dict"""
        if obj is None:
            return None
