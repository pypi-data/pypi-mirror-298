...
class PostMortemsQuestionEntity(BaseModel):
    """
    ...
    question_type_id: Optional[StrictStr] = None
    is_required: Optional[StrictBool] = None
    available_options: Optional[List[StrictStr]] = None
    conversations: Optional[List[ConversationsAPIEntitiesReference]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "body", "tooltip", "kind", "question_type_id", "is_required", "available_options", "conversations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMortemsQuestionEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMortemsQuestionEntity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind"),
            "question_type_id": obj.get("question_type_id"),
            "is_required": obj.get("is_required"),
            "available_options": obj.get("available_options"),
