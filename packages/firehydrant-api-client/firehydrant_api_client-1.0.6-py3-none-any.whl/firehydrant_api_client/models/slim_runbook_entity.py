...
class SlimRunbookEntity(BaseModel):
    """
    SlimRunbookEntity
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "summary", "description", "type", "created_at", "updated_at", "attachment_rule", "owner", "categories"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlimRunbookEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlimRunbookEntity from a dict"""
        if obj is None:
            return None
...
SlimRunbookEntity.model_rebuild(raise_errors=False)
