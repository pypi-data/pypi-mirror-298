...
class PatchV1ScheduledMaintenancesScheduledMaintenanceId(BaseModel):
    """
    ...
    starts_at: Optional[datetime] = Field(default=None, description="ISO8601 timestamp for the start time of the scheduled maintenance")
    ends_at: Optional[datetime] = Field(default=None, description="ISO8601 timestamp for the end time of the scheduled maintenance")
    ...
    __properties: ClassVar[List[str]] = ["name", "summary", "starts_at", "ends_at", "description", "labels", "status_pages", "impacts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1ScheduledMaintenancesScheduledMaintenanceId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1ScheduledMaintenancesScheduledMaintenanceId from a dict"""
        if obj is None:
            return None
