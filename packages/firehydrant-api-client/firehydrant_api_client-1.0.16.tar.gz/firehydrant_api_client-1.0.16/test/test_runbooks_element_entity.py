...
class TestRunbooksElementEntity(unittest.TestCase):
    """RunbooksElementEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunbooksElementEntity:
        """Test RunbooksElementEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunbooksElementEntity`
        """
        model = RunbooksElementEntity()
        if include_optional:
            return RunbooksElementEntity(
                id = '',
                type = '',
    ...
    def testRunbooksElementEntity(self):
        """Test RunbooksElementEntity"""
