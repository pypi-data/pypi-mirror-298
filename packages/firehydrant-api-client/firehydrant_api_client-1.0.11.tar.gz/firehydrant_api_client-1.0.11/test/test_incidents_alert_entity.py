...
class TestIncidentsAlertEntity(unittest.TestCase):
    """IncidentsAlertEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentsAlertEntity:
        """Test IncidentsAlertEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentsAlertEntity`
        """
        model = IncidentsAlertEntity()
        if include_optional:
            return IncidentsAlertEntity(
                id = '',
    ...
    def testIncidentsAlertEntity(self):
        """Test IncidentsAlertEntity"""
