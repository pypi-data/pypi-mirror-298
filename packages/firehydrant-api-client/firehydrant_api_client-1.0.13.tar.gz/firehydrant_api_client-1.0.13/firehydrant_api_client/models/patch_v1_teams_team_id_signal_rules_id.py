...
class PatchV1TeamsTeamIdSignalRulesId(BaseModel):
    """
    Update a Signals rule by ID
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The rule's name.")
    expression: Optional[StrictStr] = Field(default=None, description="The CEL expression that defines the rule.")
    target_type: Optional[StrictStr] = Field(default=None, description="The type of target that the rule will notify when matched.")
    target_id: Optional[StrictStr] = Field(default=None, description="The ID of the target that the rule will notify when matched.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1TeamsTeamIdSignalRulesId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1TeamsTeamIdSignalRulesId from a dict"""
        if obj is None:
            return None
