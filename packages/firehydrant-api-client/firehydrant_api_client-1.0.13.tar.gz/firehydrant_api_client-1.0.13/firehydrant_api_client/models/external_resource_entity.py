...
class ExternalResourceEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connection_type", "connection_name", "connection_id", "remote_id", "remote_url", "created_at", "updated_at", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalResourceEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalResourceEntity from a dict"""
        if obj is None:
            return None
