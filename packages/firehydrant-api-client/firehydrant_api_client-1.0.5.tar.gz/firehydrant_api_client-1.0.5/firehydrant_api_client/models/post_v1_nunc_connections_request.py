...
class PostV1NuncConnectionsRequest(BaseModel):
    """
    PostV1NuncConnectionsRequest
    """ # noqa: E501
    domain: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1NuncConnectionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1NuncConnectionsRequest from a dict"""
        if obj is None:
            return None
