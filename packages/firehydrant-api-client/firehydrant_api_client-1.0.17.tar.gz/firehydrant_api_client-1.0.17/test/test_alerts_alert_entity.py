...
class TestAlertsAlertEntity(unittest.TestCase):
    """AlertsAlertEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertsAlertEntity:
        """Test AlertsAlertEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertsAlertEntity`
        """
        model = AlertsAlertEntity()
        if include_optional:
            return AlertsAlertEntity(
                id = '',
                summary = '',
                description = '',
                priority = '',
    ...
    def testAlertsAlertEntity(self):
        """Test AlertsAlertEntity"""
