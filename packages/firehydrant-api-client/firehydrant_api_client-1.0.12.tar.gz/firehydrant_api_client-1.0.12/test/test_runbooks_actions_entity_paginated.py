...
class TestRunbooksActionsEntityPaginated(unittest.TestCase):
    """RunbooksActionsEntityPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunbooksActionsEntityPaginated:
        """Test RunbooksActionsEntityPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunbooksActionsEntityPaginated`
        """
        model = RunbooksActionsEntityPaginated()
        if include_optional:
            return RunbooksActionsEntityPaginated(
                data = [
                    firehydrant_api_client.models.runbooks_actions_entity.Runbooks_ActionsEntity(
                        id = '', 
                        name = '', 
                        slug = '', 
                        description = '', 
    ...
    def testRunbooksActionsEntityPaginated(self):
        """Test RunbooksActionsEntityPaginated"""
