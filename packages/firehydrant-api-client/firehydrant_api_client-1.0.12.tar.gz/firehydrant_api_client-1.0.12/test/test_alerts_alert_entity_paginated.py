...
class TestAlertsAlertEntityPaginated(unittest.TestCase):
    """AlertsAlertEntityPaginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertsAlertEntityPaginated:
        """Test AlertsAlertEntityPaginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertsAlertEntityPaginated`
        """
        model = AlertsAlertEntityPaginated()
        if include_optional:
            return AlertsAlertEntityPaginated(
                data = [
                    firehydrant_api_client.models.alerts_alert_entity.Alerts_AlertEntity(
                        id = '', 
                        summary = '', 
                        description = '', 
                        priority = '', 
    ...
    def testAlertsAlertEntityPaginated(self):
        """Test AlertsAlertEntityPaginated"""
