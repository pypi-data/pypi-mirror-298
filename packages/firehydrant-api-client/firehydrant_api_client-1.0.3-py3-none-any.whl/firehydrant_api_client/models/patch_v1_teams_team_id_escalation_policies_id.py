...
class PatchV1TeamsTeamIdEscalationPoliciesId(BaseModel):
    """
    Update a Signals escalation policy by ID
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The escalation policy's name.")
    ...
    steps: Optional[List[PatchV1TeamsTeamIdEscalationPoliciesIdStepsInner]] = Field(default=None, description="A list of steps that define how an alert should escalate through the policy.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV1TeamsTeamIdEscalationPoliciesId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV1TeamsTeamIdEscalationPoliciesId from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "steps": [PatchV1TeamsTeamIdEscalationPoliciesIdStepsInner.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
