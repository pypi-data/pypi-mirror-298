...
class TaskEntity(BaseModel):
    ...
    assignee: Optional[AuthorEntity] = None
    created_by: Optional[AuthorEntity] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    due_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "title", "description", "state", "assignee", "created_by", "created_at", "updated_at", "due_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "assignee": AuthorEntity.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
