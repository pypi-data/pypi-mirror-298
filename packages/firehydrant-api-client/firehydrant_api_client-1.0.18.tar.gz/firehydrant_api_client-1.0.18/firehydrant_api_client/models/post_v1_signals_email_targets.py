...
class PostV1SignalsEmailTargets(BaseModel):
    """
    Create a Signals email target for a team.
    """ # noqa: E501
    name: StrictStr = Field(description="The email target's name.")
    ...
    __properties: ClassVar[List[str]] = ["name", "slug", "description", "target", "allowed_senders", "rules", "rule_matching_strategy", "status_cel", "level_cel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1SignalsEmailTargets from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1SignalsEmailTargets from a dict"""
        if obj is None:
            return None
