...
SteganoencryptParser.add_argument('-k', '--key', help = 'Specifies key to use for xor operation.')
...
def imageInformation(filePath: str) -> tuple:
    ...
    return (True, filePath, iname, ipath)
