...
class LstarMdApi(MdApi):
    ...
    def __init__(self, gateway: LstarGateway) -> None:
        ...
        self.gateway: LstarGateway = gateway
...
class LstarTdApi(TdApi):
    ...
    def onRspOrderInsert(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        order: OrderData = OrderData(
            ...
            exchange=contract.exchange,
            orderid=orderid,
            direction=DIRECTION_LSTAR2VT[data["Direction"]],
            offset=OFFSET_LSTAR2VT.get(data["CombOffsetFlag"], Offset.NONE),
        ...
        if contract:
            ...
            if not position:
                position = PositionData(
                    ...
                    exchange=contract.exchange,
                    direction=DIRECTION_LSTAR2VT[data["PosiDirection"]],
                    gateway_name=self.gateway_name
                )
    ...
    def onRspQryInstrument(self, data: dict, error: dict, reqid: int, last: bool) -> None:
        ...
        if product:
            contract: ContractData = ContractData(
                symbol=data["InstrumentID"],
                exchange=EXCHANGE_LSTAR2VT[data["ExchangeID"]],
            ...
            if contract.product == Product.OPTION:
                ...
                contract.option_type = OPTIONTYPE_LSTAR2VT.get(data["OptionsType"], None)
    ...
    def onRtnOrder(self, data: dict) -> None:
        ...
        order: OrderData = OrderData(
            ...
            exchange=contract.exchange,
            orderid=orderid,
            type=ORDERTYPE_LSTAR2VT[tp],
            direction=DIRECTION_LSTAR2VT[data["Direction"]],
            offset=OFFSET_LSTAR2VT[data["CombOffsetFlag"]],
            price=data["LimitPrice"],
            volume=data["VolumeTotalOriginal"],
            traded=data["VolumeTraded"],
            status=STATUS_LSTAR2VT[data["OrderStatus"]],
            datetime=dt,
            gateway_name=self.gateway_name
        )
        self.gateway.on_order(order)
    ...
    def onRtnTrade(self, data: dict) -> None:
        ...
        trade: TradeData = TradeData(
            ...
            direction=DIRECTION_LSTAR2VT[data["Direction"]],
            offset=OFFSET_LSTAR2VT[data["OffsetFlag"]],
            price=data["Price"],
            volume=data["Volume"],
            datetime=dt,
            gateway_name=self.gateway_name
    ...
    def send_order(self, req: OrderRequest) -> str:
        """委托下单"""
        if req.offset not in OFFSET_VT2LSTAR:
            self.gateway.write_log("请选择开平方向")
            return ""

        if req.type not in ORDERTYPE_VT2LSTAR:
        ...
        lstar_req: dict = {
            ...
            "Direction": DIRECTION_VT2LSTAR.get(req.direction, ""),
            "CombOffsetFlag": OFFSET_VT2LSTAR.get(req.offset, ""),
    ...
    def cancel_order(self, req: CancelRequest) -> None:
        ...
        self.reqid += 1
        self.reqOrderAction(lstar_req, self.reqid)
