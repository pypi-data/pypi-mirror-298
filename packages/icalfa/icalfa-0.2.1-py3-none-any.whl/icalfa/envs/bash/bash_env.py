    ...
    def get_reward(self, prompt, trajectory) -> Tuple[float, Dict]:
        ...
        try:
            completion = client.chat.completions.create(
                ...
                messages=[
                {"role": "system", "content": "Your job is to determine the functional equivalence of two Bash commands. You will be given a task, two Bash commands, and the output of executing the two Bash commands. The first command is a ground truth command that accomplishes the task. If the second command also accomplishes the task, return true. Otherwise, return false. Only output 'true' or 'false'."},
