    ...
    def _translate(self, lang="fr"):
        for i, chord in enumerate(self._accords):
            ...
            for j, part in enumerate(parts):
                ...
                Chord(part).translate(lang)
                parts[j] = str(Chord(part).translate(lang))
            self._accords[i] = "/".join(parts)
...
class Chord:
    ...
    def __eq__(self, other):
        return self.translate("en")._str == other.translate("en")._str

    def _check(self):
        work_chord = self.translate("en")
    ...
    def _relative_major(self):
        if self._is_major:
            return self.translate("en")._to_sharp
        else:
            work_chord = self.translate("en")._to_sharp
    ...
    def translate(self, lang):
        ...
        for i, chord in enumerate(from_chords):
            ...
            translation = re.sub(
                r"%s(.*)" % chord, r"%s\1" % base_translation, self._str, re.IGNORECASE
            )
