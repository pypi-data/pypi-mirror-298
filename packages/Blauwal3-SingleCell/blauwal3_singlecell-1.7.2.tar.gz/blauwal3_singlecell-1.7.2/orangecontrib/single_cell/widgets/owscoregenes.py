...
# Default scores.
CLS_SCORES = [
    ScoreMeta(__("btn.info_gain"), __("lable.info_gain"), score.InfoGain, ProblemType.CLASSIFICATION, False),
]
REG_SCORES = [
    ScoreMeta(__("btn.univar_reg"), __("lable.univar_reg"), score.UnivariateLinearRegression, ProblemType.REGRESSION,
              True),
]
UNSUP_SCORES = [
...
class OWRank(OWWidget):
    ...
    class Information(OWWidget.Information):
        ...
        missings_imputed = Msg(__('msg.missing_imputed'))
