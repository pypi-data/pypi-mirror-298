...
def __(key):
    return i18n.t('single_cell.owdropout.' + key)
...
class DropoutGraph(pg.PlotWidget):
    ...
    def __init__(self, parent):
        ...
        self.setLabel("bottom", __("label.bottom"))
        self.setLabel("left", __("label.left"))
...
class OWDropout(OWWidget):
    ...
    class Warning(OWWidget.Warning):
        less_selected = Msg(__("msg.less_selected"))
        missing_entrez_id = Msg(__("msg.missing_entrez_id"))
    ...
    def _add_controls(self):
        ...
        filter_box = gui.radioButtons(
            self.controlArea, self, "filter_type", box=__("box.filter"),
        ...
        genes_layout.addWidget(gui.appendRadioButton(
            filter_box, __("btn.number_genes"), addToLayout=False))
        ...
        formula_layout.addWidget(gui.appendRadioButton(
            filter_box, __("btn.apply_exp"), addToLayout=False))
        ...
        gui.auto_commit(self.controlArea, self, "auto_commit",
                        __("btn.send_selection"), __("btn.send_automatically"))
    ...
    def send_report(self):
        ...
        self.report_caption(report.render_items_vert((
            (__("report.number_genes"), self.n_genes),
